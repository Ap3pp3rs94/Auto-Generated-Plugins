...
PROFILE_BUILDERS: Dict[str, tuple[str, Callable[[PluginSpec, Optional[str], str, str], str]]] = {
    ...
    "ai_evidence_gap_prioritizer": ("evidence_gap_prioritizer_profile", _grounded_answer_planner),
    "ai_source_trust_ranker": ("source_trust_ranker_profile", _grounded_answer_planner),
    "ai_context_relevance_ranker": ("context_relevance_ranker_profile", _context_optimizer),
    "ai_memory_conflict_resolver": ("memory_conflict_resolver_profile", _memory_compression),
    "ai_agent_role_boundary_mapper": ("agent_role_boundary_mapper_profile", _handoff),
    "ai_parallel_work_detector": ("parallel_work_detector_profile", _task_planner),
    "ai_tool_permission_gate": ("tool_permission_gate_profile", _automation_safety),
    "ai_tool_argument_sanitizer": ("tool_argument_sanitizer_profile", _prompt_injection_scanner),
    "ai_eval_failure_classifier": ("eval_failure_classifier_profile", _output_quality),
    "ai_response_actionability_scorer": ("response_actionability_scorer_profile", _output_quality),
    "ai_user_clarification_question_builder": ("user_clarification_question_builder_profile", _prompt_refinement),
    "ai_assumption_tracker": ("assumption_tracker_profile", _requirement_gap_analyzer),
    "ai_change_impact_summarizer": ("change_impact_summarizer_profile", _artifact_release_notes),
    "ai_verification_plan_builder": ("verification_plan_builder_profile", _prompt_test_cases),
    "ai_red_team_prompt_probe_builder": ("red_team_prompt_probe_builder_profile", _prompt_injection_scanner),
