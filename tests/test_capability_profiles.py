...
PROFILE_PAYLOADS = {
    ...
    "ai_plugin_spec_architect": {
        "task": "Create a capability that designs capability specs",
        "objective": "avoid random duplicate generated capabilities",
    ...
    "ai_plugin_quality_gate_designer": {
        "task": "Design quality gates for generated capability bodies",
