...
Capability: AI Sales Ops Source Quality Ranker 000148
...
_PLUGIN_NAME: str = 'AI Sales Ops Source Quality Ranker 000148'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Source Quality Ranker 000148'
