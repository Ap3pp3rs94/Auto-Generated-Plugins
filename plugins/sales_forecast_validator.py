...
# Title      : Sales Forecast Validator
# File       : sales_forecast_validator.py
# Description: Validate sales forecasts against historical data to identify potential errors and provide actionable insights.
# Goal       : Validate sales forecasts against historical data to identify potential errors and provide actionable insights.
# Category   : analysis
...
_PLUGIN_NAME: str = 'Sales Forecast Validator'
_PLUGIN_GOAL: str = 'Validate sales forecasts against historical data to identify potential errors and provide actionable insights.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['forecast', 'validation']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_forecast_validator'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
