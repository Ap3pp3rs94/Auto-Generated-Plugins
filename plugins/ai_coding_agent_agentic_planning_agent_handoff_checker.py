...
Plugin: AI Coding Agent Agentic Planning Agent Handoff Checker
Slug: ai_coding_agent_agentic_planning_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_agent_handoff_checker'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI coding agents and repository work for agentic planning agent handoffs for missing context, ownership overlap, and unsafe next steps.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'handoff', 'coordination', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'system_automation'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning agent handoff quality and coordination'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Agent Handoff Checker'
        goal = 'Check AI coding agents and repository work for agentic planning agent handoffs for missing context, ownership overlap, and unsafe next steps.'
        domain = 'AI coding agents and repository work for agentic planning agent handoff quality and coordination'
