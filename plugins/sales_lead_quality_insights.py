...
# Title      : Sales Lead Quality Insights
# File       : sales_lead_quality_insights.py
# Description: Provides actionable insights on lead quality to inform sales strategies and optimize prospect engagement.
# Goal       : Provides actionable insights on lead quality to inform sales strategies and optimize prospect engagement.
# Category   : analysis | sales
# Tags       : lead, quality, prospect
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Lead Quality Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights on lead quality to inform sales strategies and optimize prospect engagement.'
_PLUGIN_CATEGORY: str = 'analysis | sales'
_PLUGIN_TAGS = ['lead', 'quality', 'prospect']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_lead_quality_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
