...
Plugin: AI Customer Support Evidence Gap Detector
Slug: ai_customer_support_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_customer_support_evidence_gap_detector'
...
_PLUGIN_TAGS = ['support', 'service', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Evidence Gap Detector'
