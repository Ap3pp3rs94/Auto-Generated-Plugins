...
Capability: AI Instruction Hierarchy Checker 003887
Slug: ai_instruction_hierarchy_checker_003887
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 003887'
        goal = 'Check AI operations monitoring and incident response for customer-facing interaction instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI operations monitoring and incident response for customer-facing interaction instruction hierarchy and conflict safety'
