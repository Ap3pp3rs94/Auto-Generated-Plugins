...
Capability: AI Verification Checklist Builder 007718
Slug: ai_verification_checklist_builder_007718
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 007718'
        goal = 'Build verification checklists for AI operations monitoring and incident response for live monitoring AI artifacts before release or handoff.'
        domain = 'AI operations monitoring and incident response for live monitoring verification planning and acceptance checks'
