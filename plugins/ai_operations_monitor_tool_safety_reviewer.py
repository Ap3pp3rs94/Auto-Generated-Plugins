...
Plugin: AI Operations Monitor Tool Safety Reviewer
Slug: ai_operations_monitor_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_operations_monitor_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Tool Safety Reviewer'
