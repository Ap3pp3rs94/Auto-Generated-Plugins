...
Plugin: AI Customer Support Agentic Planning Output Completeness Grader 000515
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
