...
Capability: AI DevOps Release Trace Failure Router 000283
...
_PLUGIN_NAME: str = 'AI DevOps Release Trace Failure Router 000283'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Trace Failure Router 000283'
