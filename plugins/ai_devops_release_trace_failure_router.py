...
Plugin: AI DevOps Release Trace Failure Router
Slug: ai_devops_release_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_devops_release_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Trace Failure Router'
