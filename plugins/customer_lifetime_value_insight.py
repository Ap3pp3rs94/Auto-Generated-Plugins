...
# File       : customer_lifetime_value_insight.py
# Description: Automate customer lifetime value analysis to inform business decisions and improve forecasting accuracy.
# Goal       : Automate customer lifetime value analysis to inform business decisions and improve forecasting accuracy.
# Category   : analysis
# Tags       : lifetime, value, forecasting
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Customer Lifetime Value Insights'
_PLUGIN_GOAL: str = 'Automate customer lifetime value analysis to inform business decisions and improve forecasting accuracy.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['lifetime', 'value', 'forecasting']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_lifetime_value_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
