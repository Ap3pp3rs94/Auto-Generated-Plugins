...
# File       : deal_performance_explorer.py
# Description: Provides a comprehensive view of deal performance by analyzing various metrics and KPIs.
# Goal       : Provides a comprehensive view of deal performance by analyzing various metrics and KPIs.
...
_PLUGIN_GOAL: str = 'Provides a comprehensive view of deal performance by analyzing various metrics and KPIs.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['deals', 'performance']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_explorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
