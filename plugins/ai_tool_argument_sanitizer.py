...
Plugin: AI Tool Argument Sanitizer
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Argument Sanitizer'
        goal = 'Inspect proposed tool arguments for unsafe paths, missing constraints, and prompt-injection contamination.'
        domain = 'AI tool argument safety and input sanitization'
        capability_type = 'scoring'
        logic_profile_id = 'tool_argument_sanitizer_profile'
