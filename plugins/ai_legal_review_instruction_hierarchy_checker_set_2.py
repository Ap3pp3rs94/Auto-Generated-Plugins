...
Plugin: AI Legal Review Instruction Hierarchy Checker Set 2
Slug: ai_legal_review_instruction_hierarchy_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Instruction Hierarchy Checker Set 2'
_PLUGIN_SLUG: str = 'ai_legal_review_instruction_hierarchy_checker_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Instruction Hierarchy Checker Set 2'
