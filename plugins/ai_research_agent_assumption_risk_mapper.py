...
Capability: AI Research Agent Assumption Risk Mapper 000109
...
_PLUGIN_NAME: str = 'AI Research Agent Assumption Risk Mapper 000109'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Assumption Risk Mapper 000109'
