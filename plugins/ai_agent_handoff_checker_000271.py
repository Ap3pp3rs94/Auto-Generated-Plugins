...
Capability: AI Agent Handoff Checker 000271
Slug: ai_agent_handoff_checker_000271
"""
...
_PLUGIN_NAME: str = 'AI Agent Handoff Checker 000271'
_PLUGIN_SLUG: str = 'ai_agent_handoff_checker_000271'
...
_PLUGIN_TAGS = ['devops', 'release', 'agents', 'handoff', 'coordination', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Agent Handoff Checker 000271'
