...
Capability: AI Sales Ops Prompt Contract Designer 000145
...
_PLUGIN_NAME: str = 'AI Sales Ops Prompt Contract Designer 000145'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Contract Designer 000145'
