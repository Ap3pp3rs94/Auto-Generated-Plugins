...
Plugin: AI DevOps Release Prompt Contract Designer Set 3
Slug: ai_devops_release_prompt_contract_designer_set_3
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Prompt Contract Designer Set 3'
_PLUGIN_SLUG: str = 'ai_devops_release_prompt_contract_designer_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Prompt Contract Designer Set 3'
