...
Plugin: AI Data Analysis Agentic Planning Memory Update Recommender 000678
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
