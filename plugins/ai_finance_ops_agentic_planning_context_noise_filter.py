...
Capability: AI Finance Ops Agentic Planning Context Noise Filter 000605
...
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
