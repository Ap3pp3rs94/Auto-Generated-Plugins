...
Capability: AI Citation Priority Scorer 008877
Slug: ai_citation_priority_scorer_008877
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 008877'
        goal = 'Score which AI operations monitoring and incident response for AI tool use for detecting signals claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for AI tool use for detecting signals citation priority and factual-risk scoring'
