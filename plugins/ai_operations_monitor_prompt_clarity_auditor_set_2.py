...
Plugin: AI Operations Monitor Prompt Clarity Auditor Set 2
Slug: ai_operations_monitor_prompt_clarity_auditor_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Prompt Clarity Auditor Set 2'
        goal = 'Audit prompts for AI operations monitoring and incident response and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI operations monitoring and incident response prompt clarity and ambiguity reduction'
