...
Plugin: AI Coding Agent Agentic Planning Model Fit Triage 000478
Slug: ai_coding_agent_agentic_planning_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Model Fit Triage 000478'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_model_fit_triage'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Triage which model tier or workflow style fits AI coding agents and repository work for agentic planning tasks based on risk and complexity.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'models', 'routing', 'triage', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning model selection and capability fit'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Model Fit Triage 000478'
        goal = 'Triage which model tier or workflow style fits AI coding agents and repository work for agentic planning tasks based on risk and complexity.'
        domain = 'AI coding agents and repository work for agentic planning model selection and capability fit'
