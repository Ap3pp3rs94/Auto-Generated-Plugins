...
Capability: AI DevOps Release Prompt Contract Designer 000265
...
_PLUGIN_NAME: str = 'AI DevOps Release Prompt Contract Designer 000265'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Prompt Contract Designer 000265'
