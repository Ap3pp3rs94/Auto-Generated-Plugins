...
Capability: AI Sales Ops Agentic Planning Tool Argument Checker 000538
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
