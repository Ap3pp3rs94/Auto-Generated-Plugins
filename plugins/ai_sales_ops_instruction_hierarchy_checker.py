...
Capability: AI Sales Ops Instruction Hierarchy Checker 000167
...
_PLUGIN_NAME: str = 'AI Sales Ops Instruction Hierarchy Checker 000167'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Instruction Hierarchy Checker 000167'
