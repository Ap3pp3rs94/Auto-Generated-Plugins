...
Capability: AI Clinical Admin Agentic Planning Prompt Contract Designer 000553
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
