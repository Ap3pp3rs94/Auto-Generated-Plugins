...
Plugin: AI Data Analysis Prompt Contract Designer
Slug: ai_data_analysis_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_data_analysis_prompt_contract_designer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Prompt Contract Designer'
