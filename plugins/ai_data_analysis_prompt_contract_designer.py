...
Capability: AI Data Analysis Prompt Contract Designer 000289
...
_PLUGIN_NAME: str = 'AI Data Analysis Prompt Contract Designer 000289'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Prompt Contract Designer 000289'
