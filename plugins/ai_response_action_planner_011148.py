...
Capability: AI Response Action Planner 011148
Slug: ai_response_action_planner_011148
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 011148'
_PLUGIN_SLUG: str = 'ai_response_action_planner_011148'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 011148'
        goal = 'Convert AI finance operations and risk review for workflow orchestration AI responses into concrete next actions with owners, checks, and risks.'
