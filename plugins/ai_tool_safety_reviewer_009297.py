...
Capability: AI Tool Safety Reviewer 009297
Slug: ai_tool_safety_reviewer_009297
"""
...
_PLUGIN_NAME: str = 'AI Tool Safety Reviewer 009297'
_PLUGIN_SLUG: str = 'ai_tool_safety_reviewer_009297'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Review proposed tool use for AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback for side effects, permissions, and rollback needs.'
_PLUGIN_TAGS = ['cybersecurity', 'incidents', 'threat-intel', 'evaluation', 'feedback', 'tools', 'safety', 'permissions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback AI tool safety and approval control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 009297'
        goal = 'Review proposed tool use for AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback for side effects, permissions, and rollback needs.'
        domain = 'AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback AI tool safety and approval control'
