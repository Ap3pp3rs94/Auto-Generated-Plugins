...
Capability: AI Citation Priority Scorer 006381
Slug: ai_citation_priority_scorer_006381
"""
...
_PLUGIN_NAME: str = 'AI Citation Priority Scorer 006381'
_PLUGIN_SLUG: str = 'ai_citation_priority_scorer_006381'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI finance operations and risk review for task decomposition claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['finance', 'risk', 'tasks', 'decomposition', 'citations', 'claims', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review for task decomposition citation priority and factual-risk scoring'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Finance Ops Task Decomposition.', 'Rank claims by citation need.', 'Flag high-stakes factual statements.', 'Recommend safer wording for unsupported claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Citation Priority Scorer 006381', 'slug': 'ai_citation_priority_scorer_006381', 'goal': 'Score which AI finance operations and risk review for task decomposition claims most urgently need citations or uncertainty language.', 'category': 'ai_evaluation', 'tags': ['finance', 'risk', 'tasks', 'decomposition', 'citations', 'claims', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI finance operations and risk review for task decomposition citation priority and factual-risk scoring', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Finance Ops Task Decomposition.', 'Rank claims by citation need.', 'Flag high-stakes factual statements.', 'Recommend safer wording for unsupported claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 006381'
        goal = 'Score which AI finance operations and risk review for task decomposition claims most urgently need citations or uncertainty language.'
        domain = 'AI finance operations and risk review for task decomposition citation priority and factual-risk scoring'
