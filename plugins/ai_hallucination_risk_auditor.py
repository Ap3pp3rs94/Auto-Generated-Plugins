...
_PLUGIN_MANIFEST = {'name': 'AI Hallucination Risk Auditor 000007', 'slug': 'ai_hallucination_risk_auditor', 'goal': 'Inspect AI-generated claims and flag unsupported, risky, or source-sensitive statements.', 'category': 'ai_evaluation', 'tags': ['ai', 'hallucination', 'risk', 'verification', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI reliability, hallucination detection, and factual risk', 'owner_id': 'francis-factory', 'use_cases': ['Identify claims that need citations or external verification.', 'Classify risk by domain such as legal, medical, financial, or technical.', 'Suggest safer rewrites for uncertain claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
