...
Plugin: AI Finance Ops Citation Priority Scorer
Slug: ai_finance_ops_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_finance_ops_citation_priority_scorer'
...
_PLUGIN_TAGS = ['finance', 'risk', 'citations', 'claims', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Citation Priority Scorer'
