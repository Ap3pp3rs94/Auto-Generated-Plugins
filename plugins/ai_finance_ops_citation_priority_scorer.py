...
Capability: AI Finance Ops Citation Priority Scorer 000237
...
_PLUGIN_NAME: str = 'AI Finance Ops Citation Priority Scorer 000237'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Citation Priority Scorer 000237'
