...
Capability: AI Response Action Planner 000516
Slug: ai_response_action_planner_000516
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000516'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000516'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000516'
        goal = 'Convert AI customer support and service workflows for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
