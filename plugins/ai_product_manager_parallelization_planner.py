...
Plugin: AI Product Manager Parallelization Planner
Slug: ai_product_manager_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Parallelization Planner'
_PLUGIN_SLUG: str = 'ai_product_manager_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Parallelization Planner'
