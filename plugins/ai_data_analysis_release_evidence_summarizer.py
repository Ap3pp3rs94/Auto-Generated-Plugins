...
Plugin: AI Data Analysis Release Evidence Summarizer
Slug: ai_data_analysis_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_data_analysis_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Release Evidence Summarizer'
