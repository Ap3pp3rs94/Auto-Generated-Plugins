...
Capability: AI Data Analysis Release Evidence Summarizer 000306
...
_PLUGIN_NAME: str = 'AI Data Analysis Release Evidence Summarizer 000306'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Release Evidence Summarizer 000306'
