...
Capability: AI Customer Support Agentic Planning Parallelization Planner 000512
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
