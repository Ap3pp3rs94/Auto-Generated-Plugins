...
Plugin: AI Clinical Admin Tool Safety Reviewer Set 3
Slug: ai_clinical_admin_tool_safety_reviewer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Tool Safety Reviewer Set 3'
_PLUGIN_SLUG: str = 'ai_clinical_admin_tool_safety_reviewer_set_3'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Review proposed tool use for AI clinical administration and healthcare operations for side effects, permissions, and rollback needs.'
_PLUGIN_TAGS = ['healthcare', 'clinical', 'tools', 'safety', 'permissions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI clinical administration and healthcare operations AI tool safety and approval control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Tool Safety Reviewer Set 3'
        goal = 'Review proposed tool use for AI clinical administration and healthcare operations for side effects, permissions, and rollback needs.'
        domain = 'AI clinical administration and healthcare operations AI tool safety and approval control'
