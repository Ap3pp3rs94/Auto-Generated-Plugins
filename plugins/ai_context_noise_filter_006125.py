...
Capability: AI Context Noise Filter 006125
Slug: ai_context_noise_filter_006125
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 006125'
        goal = 'Filter noisy or redundant context before model calls for AI content strategy and editorial workflows for capability operations.'
        domain = 'AI content strategy and editorial workflows for capability operations context filtering and token-budget control'
