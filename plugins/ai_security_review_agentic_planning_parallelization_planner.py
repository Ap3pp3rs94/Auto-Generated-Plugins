...
Capability: AI Security Review Agentic Planning Parallelization Planner 000704
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
