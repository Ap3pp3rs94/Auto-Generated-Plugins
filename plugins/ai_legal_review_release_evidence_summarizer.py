...
Capability: AI Legal Review Release Evidence Summarizer 000210
...
_PLUGIN_NAME: str = 'AI Legal Review Release Evidence Summarizer 000210'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Release Evidence Summarizer 000210'
