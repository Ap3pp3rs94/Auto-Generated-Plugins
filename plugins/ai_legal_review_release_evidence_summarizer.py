...
Plugin: AI Legal Review Release Evidence Summarizer
Slug: ai_legal_review_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_legal_review_release_evidence_summarizer'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'release', 'evidence', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Release Evidence Summarizer'
