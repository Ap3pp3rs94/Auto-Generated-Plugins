...
Plugin: AI Product Manager Agent Handoff Checker
Slug: ai_product_manager_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_product_manager_agent_handoff_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Agent Handoff Checker'
