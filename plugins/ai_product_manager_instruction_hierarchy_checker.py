...
Capability: AI Product Manager Instruction Hierarchy Checker 000359
...
_PLUGIN_NAME: str = 'AI Product Manager Instruction Hierarchy Checker 000359'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Instruction Hierarchy Checker 000359'
