...
Plugin: AI Product Manager Instruction Hierarchy Checker
Slug: ai_product_manager_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_product_manager_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Instruction Hierarchy Checker'
