...
Capability: AI Capability Factory Tool Safety Reviewer 000441
...
_PLUGIN_NAME: str = 'AI Capability Factory Tool Safety Reviewer 000441'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Tool Safety Reviewer 000441'
