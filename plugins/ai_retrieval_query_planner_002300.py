...
Capability: AI Retrieval Query Planner 002300
Slug: ai_retrieval_query_planner_002300
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002300'
        goal = 'Plan focused retrieval queries for AI content strategy and editorial workflows for evaluation feedback when evidence is missing or stale.'
        domain = 'AI content strategy and editorial workflows for evaluation feedback retrieval query planning and grounding'
