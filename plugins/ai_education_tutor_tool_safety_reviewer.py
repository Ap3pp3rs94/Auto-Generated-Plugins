...
Capability: AI Education Tutor Tool Safety Reviewer 000249
...
_PLUGIN_NAME: str = 'AI Education Tutor Tool Safety Reviewer 000249'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Tool Safety Reviewer 000249'
