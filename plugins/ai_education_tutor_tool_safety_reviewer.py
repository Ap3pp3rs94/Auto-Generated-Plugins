...
Plugin: AI Education Tutor Tool Safety Reviewer
Slug: ai_education_tutor_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_education_tutor_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Tool Safety Reviewer'
