...
Plugin: AI Data Analysis Evidence Gap Detector Set 2
Slug: ai_data_analysis_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI data analysis and analytics workflows.'
        domain = 'AI data analysis and analytics workflows evidence gaps and retrieval readiness'
