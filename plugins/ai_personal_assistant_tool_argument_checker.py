...
Plugin: AI Personal Assistant Tool Argument Checker
Slug: ai_personal_assistant_tool_argument_checker
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Tool Argument Checker'
_PLUGIN_SLUG: str = 'ai_personal_assistant_tool_argument_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Tool Argument Checker'
