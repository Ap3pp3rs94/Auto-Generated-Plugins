...
Plugin: AI Capability Factory Agentic Planning Prompt Contract Designer 000817
Slug: ai_plugin_factory_agentic_planning_prompt_contract_designer
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Agentic Planning Prompt Contract Designer 000817'
        goal = 'Design prompt contracts for AI capability factory and generated module operations for agentic planning with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI capability factory and generated module operations for agentic planning prompt contracts and structured instruction design'
