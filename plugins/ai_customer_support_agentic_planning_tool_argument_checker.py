...
Capability: AI Customer Support Agentic Planning Tool Argument Checker 000514
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
