...
# File       : deal_performance_insights.py
# Description: Provides actionable insights on deal performance to inform sales strategies and optimize pipeline health.
# Goal       : Provides actionable insights on deal performance to inform sales strategies and optimize pipeline health.
# Category   : sales | analysis
# Tags       : insight, pipeline
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable insights on deal performance to inform sales strategies and optimize pipeline health.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['insight', 'pipeline']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
