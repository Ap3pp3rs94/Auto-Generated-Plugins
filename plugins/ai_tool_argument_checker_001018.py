...
Capability: AI Tool Argument Checker 001018
Slug: ai_tool_argument_checker_001018
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Argument Checker 001018'
        goal = 'Inspect tool arguments for AI education, tutoring, and learning workflows for AI tool use for unsafe scope, missing bounds, or injected instructions.'
        domain = 'AI education, tutoring, and learning workflows for AI tool use tool argument safety and sanitization'
