...
Capability: AI Release Evidence Summarizer 002010
Slug: ai_release_evidence_summarizer_002010
"""
...
_PLUGIN_NAME: str = 'AI Release Evidence Summarizer 002010'
_PLUGIN_SLUG: str = 'ai_release_evidence_summarizer_002010'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Summarize validation and release evidence for AI coding agents and repository work for evaluation feedback AI capability artifacts.'
_PLUGIN_TAGS = ['coding', 'agents', 'evaluation', 'feedback', 'release', 'evidence', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for evaluation feedback release evidence and publishing readiness'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Coding Agent Evaluation Feedback.', 'Summarize what passed and what remains risky.', 'Package validation evidence for GitHub visibility.', 'Recommend publish, hold, or repair.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Release Evidence Summarizer 002010', 'slug': 'ai_release_evidence_summarizer_002010', 'goal': 'Summarize validation and release evidence for AI coding agents and repository work for evaluation feedback AI capability artifacts.', 'category': 'ai_plugin_factory', 'tags': ['coding', 'agents', 'evaluation', 'feedback', 'release', 'evidence', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI coding agents and repository work for evaluation feedback release evidence and publishing readiness', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Coding Agent Evaluation Feedback.', 'Summarize what passed and what remains risky.', 'Package validation evidence for GitHub visibility.', 'Recommend publish, hold, or repair.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 002010'
        goal = 'Summarize validation and release evidence for AI coding agents and repository work for evaluation feedback AI capability artifacts.'
        domain = 'AI coding agents and repository work for evaluation feedback release evidence and publishing readiness'
