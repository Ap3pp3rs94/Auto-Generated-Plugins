...
Capability: AI Release Evidence Summarizer 000162
Slug: ai_release_evidence_summarizer_000162
"""
...
_PLUGIN_NAME: str = 'AI Release Evidence Summarizer 000162'
_PLUGIN_SLUG: str = 'ai_release_evidence_summarizer_000162'
...
_PLUGIN_TAGS = ['sales', 'business', 'release', 'evidence', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 000162'
