...
Plugin: AI Product Manager Agentic Planning Retrieval Query Planner 000740
Slug: ai_product_manager_agentic_planning_retrieval_query_planner
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Agentic Planning Retrieval Query Planner 000740'
_PLUGIN_SLUG: str = 'ai_product_manager_agentic_planning_retrieval_query_planner'
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Agentic Planning Retrieval Query Planner 000740'
