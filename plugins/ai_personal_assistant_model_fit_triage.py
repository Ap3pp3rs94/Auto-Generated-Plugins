...
Capability: AI Personal Assistant Model Fit Triage 000406
...
_PLUGIN_NAME: str = 'AI Personal Assistant Model Fit Triage 000406'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'models', 'routing', 'triage', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_MANIFEST = {'name': 'AI Personal Assistant Model Fit Triage 000406', 'slug': 'ai_personal_assistant_model_fit_triage', 'goal': 'Triage which model tier or workflow style fits AI personal productivity and scheduling workflows tasks based on risk and complexity.', 'category': 'ai_agents', 'tags': ['productivity', 'assistant', 'models', 'routing', 'triage', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI personal productivity and scheduling workflows model selection and capability fit', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Personal Assistant.', 'Score whether a task needs fast, cheap, reasoning-heavy, or tool-using flow.', 'Flag tasks that need stronger verification.', 'Recommend the lowest sufficient capability tier.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Model Fit Triage 000406'
