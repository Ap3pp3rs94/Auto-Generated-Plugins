...
Capability: AI Parallelization Planner 000416
Slug: ai_parallelization_planner_000416
"""
...
_PLUGIN_NAME: str = 'AI Parallelization Planner 000416'
_PLUGIN_SLUG: str = 'ai_parallelization_planner_000416'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Parallelization Planner 000416'
