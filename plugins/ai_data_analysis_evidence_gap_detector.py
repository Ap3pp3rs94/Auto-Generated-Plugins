...
Capability: AI Data Analysis Evidence Gap Detector 000291
...
_PLUGIN_NAME: str = 'AI Data Analysis Evidence Gap Detector 000291'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Evidence Gap Detector 000291'
