...
Capability: AI Prompt Clarity Auditor 004298
Slug: ai_prompt_clarity_auditor_004298
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Clarity Auditor 004298'
        goal = 'Audit prompts for AI coding agents and repository work for documentation and knowledge capture and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI coding agents and repository work for documentation and knowledge capture prompt clarity and ambiguity reduction'
