...
# Title      : Deal Performance Visualizer
# File       : deal_performance_visualization.py
# Description: Provides a visual representation of deal performance, highlighting key metrics and trends for data-driven decision making.
# Goal       : Provides a visual representation of deal performance, highlighting key metrics and trends for data-driven decision making.
# Category   : sales | marketing
# Tags       : deal, performance, visualization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Performance Visualizer'
_PLUGIN_GOAL: str = 'Provides a visual representation of deal performance, highlighting key metrics and trends for data-driven decision making.'
_PLUGIN_CATEGORY: str = 'sales | marketing'
_PLUGIN_TAGS = ['deal', 'performance', 'visualization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_visualization'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
