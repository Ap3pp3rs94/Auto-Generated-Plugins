...
Capability: AI Verification Checklist Builder 000806
Slug: ai_verification_checklist_builder_000806
"""
...
_PLUGIN_NAME: str = 'AI Verification Checklist Builder 000806'
_PLUGIN_SLUG: str = 'ai_verification_checklist_builder_000806'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 000806'
