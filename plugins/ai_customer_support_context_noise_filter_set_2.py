...
Plugin: AI Customer Support Context Noise Filter Set 2
Slug: ai_customer_support_context_noise_filter_set_2
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Context Noise Filter Set 2'
_PLUGIN_SLUG: str = 'ai_customer_support_context_noise_filter_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Context Noise Filter Set 2'
