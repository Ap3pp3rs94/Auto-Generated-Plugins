...
Plugin: AI Finance Ops Response Action Planner Set 3
Slug: ai_finance_ops_response_action_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Response Action Planner Set 3'
_PLUGIN_SLUG: str = 'ai_finance_ops_response_action_planner_set_3'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI finance operations and risk review AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['finance', 'risk', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Response Action Planner Set 3'
        goal = 'Convert AI finance operations and risk review AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI finance operations and risk review response actionability and next-step planning'
