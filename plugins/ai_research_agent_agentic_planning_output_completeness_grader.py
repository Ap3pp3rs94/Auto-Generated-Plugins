...
Plugin: AI Research Agent Agentic Planning Output Completeness Grader 000491
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
