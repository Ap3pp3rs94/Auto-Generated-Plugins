...
Plugin: AI DevOps Release Parallelization Planner Set 2
Slug: ai_devops_release_parallelization_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Parallelization Planner Set 2'
_PLUGIN_SLUG: str = 'ai_devops_release_parallelization_planner_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Parallelization Planner Set 2'
