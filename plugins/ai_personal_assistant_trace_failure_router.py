...
Plugin: AI Personal Assistant Trace Failure Router
Slug: ai_personal_assistant_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_personal_assistant_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Trace Failure Router'
