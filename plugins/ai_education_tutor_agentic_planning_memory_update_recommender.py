...
Capability: AI Education Tutor Agentic Planning Memory Update Recommender 000630
Slug: ai_education_tutor_agentic_planning_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Agentic Planning Memory Update Recommender 000630'
_PLUGIN_SLUG: str = 'ai_education_tutor_agentic_planning_memory_update_recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Agentic Planning Memory Update Recommender 000630'
