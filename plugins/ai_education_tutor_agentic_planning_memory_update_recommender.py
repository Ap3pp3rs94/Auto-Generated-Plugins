...
Plugin: AI Education Tutor Agentic Planning Memory Update Recommender 000630
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
