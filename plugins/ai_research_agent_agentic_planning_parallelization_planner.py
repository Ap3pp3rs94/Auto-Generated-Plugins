...
Capability: AI Research Agent Agentic Planning Parallelization Planner 000488
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
