...
Plugin: AI Personal Assistant Release Evidence Summarizer
Slug: ai_personal_assistant_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_personal_assistant_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Release Evidence Summarizer'
