...
Plugin: AI Clinical Admin Memory Update Recommender
Slug: ai_clinical_admin_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Memory Update Recommender'
_PLUGIN_SLUG: str = 'ai_clinical_admin_memory_update_recommender'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Recommend durable memory updates from AI clinical administration and healthcare operations sessions without saving transient chatter.'
_PLUGIN_TAGS = ['healthcare', 'clinical', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI clinical administration and healthcare operations durable memory and preference extraction'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Memory Update Recommender'
        goal = 'Recommend durable memory updates from AI clinical administration and healthcare operations sessions without saving transient chatter.'
        domain = 'AI clinical administration and healthcare operations durable memory and preference extraction'
