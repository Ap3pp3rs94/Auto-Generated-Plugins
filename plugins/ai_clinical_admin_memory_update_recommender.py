...
Capability: AI Clinical Admin Memory Update Recommender 000174
...
_PLUGIN_NAME: str = 'AI Clinical Admin Memory Update Recommender 000174'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Memory Update Recommender 000174'
