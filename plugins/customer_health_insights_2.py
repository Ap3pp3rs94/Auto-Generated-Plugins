...
# File       : customer_health_insights_2.py
# Description: Provides actionable insights to improve customer health and retention.
# Goal       : Provides actionable insights to improve customer health and retention.
# Category   : sales | marketing | support | analysis
# Tags       : customer, health, retention
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Customer Health Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights to improve customer health and retention.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support | analysis'
_PLUGIN_TAGS = ['customer', 'health', 'retention']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_health_insights_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
