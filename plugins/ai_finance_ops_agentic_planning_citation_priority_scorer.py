...
Capability: AI Finance Ops Agentic Planning Citation Priority Scorer 000621
Slug: ai_finance_ops_agentic_planning_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Agentic Planning Citation Priority Scorer 000621'
_PLUGIN_SLUG: str = 'ai_finance_ops_agentic_planning_citation_priority_scorer'
...
_PLUGIN_MANIFEST = {'name': 'AI Finance Ops Agentic Planning Citation Priority Scorer 000621', 'slug': 'ai_finance_ops_agentic_planning_citation_priority_scorer', 'goal': 'Score which AI finance operations and risk review for agentic planning claims most urgently need citations or uncertainty language.', 'category': 'ai_evaluation', 'tags': ['finance', 'risk', 'agentic', 'planning', 'citations', 'claims', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI finance operations and risk review for agentic planning citation priority and factual-risk scoring', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Finance Ops Agentic Planning.', 'Rank claims by citation need.', 'Flag high-stakes factual statements.', 'Recommend safer wording for unsupported claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Agentic Planning Citation Priority Scorer 000621'
