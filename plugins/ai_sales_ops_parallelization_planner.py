...
Capability: AI Sales Ops Parallelization Planner 000152
...
_PLUGIN_NAME: str = 'AI Sales Ops Parallelization Planner 000152'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Parallelization Planner 000152'
