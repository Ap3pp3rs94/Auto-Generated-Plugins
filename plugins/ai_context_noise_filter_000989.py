...
Capability: AI Context Noise Filter 000989
Slug: ai_context_noise_filter_000989
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 000989'
        goal = 'Filter noisy or redundant context before model calls for AI finance operations and risk review for AI tool use.'
        domain = 'AI finance operations and risk review for AI tool use context filtering and token-budget control'
