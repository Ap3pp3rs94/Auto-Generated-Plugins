...
Capability: AI Finance Ops Agentic Planning Tool Argument Checker 000610
...
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
