...
Capability: AI Citation Priority Scorer 007341
Slug: ai_citation_priority_scorer_007341
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 007341'
        goal = 'Score which AI operations monitoring and incident response for knowledge graph work claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for knowledge graph work citation priority and factual-risk scoring'
