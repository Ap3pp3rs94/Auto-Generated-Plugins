...
Plugin: AI Legal Review Agentic Planning Retrieval Query Planner 000596
...
_PLUGIN_TAGS = ['legal', 'compliance', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
