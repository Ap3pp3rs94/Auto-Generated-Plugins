...
Plugin: AI Capability Overlap Checker 000833
Slug: ai_capability_overlap_checker_000833
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Overlap Checker 000833'
        goal = 'Check whether proposed AI capability factory and generated module operations for agentic planning capabilities overlap existing modules or deserve a new canonical slot.'
        domain = 'AI capability factory and generated module operations for agentic planning capability uniqueness and roadmap hygiene'
        ...
        use_cases = ['Apply this capability to the distinct use case: Capability Factory Agentic Planning.', 'Compare proposed capability behavior against existing modules.', 'Recommend merge, reject, or generate-new decisions.', 'Explain uniqueness using capability boundaries.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.']
