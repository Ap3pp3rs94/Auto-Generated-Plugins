...
Capability: AI Legal Review Instruction Hierarchy Checker 000215
...
_PLUGIN_NAME: str = 'AI Legal Review Instruction Hierarchy Checker 000215'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Instruction Hierarchy Checker 000215'
