...
Plugin: AI Legal Review Instruction Hierarchy Checker
Slug: ai_legal_review_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_legal_review_instruction_hierarchy_checker'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Instruction Hierarchy Checker'
