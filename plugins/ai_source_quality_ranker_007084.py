...
Capability: AI Source Quality Ranker 007084
Slug: ai_source_quality_ranker_007084
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 007084'
        goal = 'Rank provided sources for AI clinical administration and healthcare operations for knowledge graph work by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI clinical administration and healthcare operations for knowledge graph work source quality and grounded answer preparation'
