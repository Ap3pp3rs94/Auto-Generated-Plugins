...
Capability: AI Evidence Gap Detector 000795
Slug: ai_evidence_gap_detector_000795
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Detector 000795'
_PLUGIN_SLUG: str = 'ai_evidence_gap_detector_000795'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'agentic', 'planning', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 000795'
