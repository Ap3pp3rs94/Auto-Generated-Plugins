...
Plugin: AI Operations Monitor Agentic Planning Evidence Gap Detector 000795
Slug: ai_operations_monitor_agentic_planning_evidence_gap_detector
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Agentic Planning Evidence Gap Detector 000795'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response for agentic planning.'
        domain = 'AI operations monitoring and incident response for agentic planning evidence gaps and retrieval readiness'
