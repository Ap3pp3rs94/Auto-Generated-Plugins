...
Capability: AI Citation Priority Scorer 004653
Slug: ai_citation_priority_scorer_004653
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 004653'
        goal = 'Score which AI operations monitoring and incident response for documentation and knowledge capture claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for documentation and knowledge capture citation priority and factual-risk scoring'
