...
Plugin: AI Instruction Hierarchy Checker 000863
Slug: ai_instruction_hierarchy_checker_000863
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 000863'
        goal = 'Check AI coding agents and repository work for AI tool use instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI coding agents and repository work for AI tool use instruction hierarchy and conflict safety'
