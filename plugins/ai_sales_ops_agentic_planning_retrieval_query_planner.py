...
Plugin: AI Sales Ops Agentic Planning Retrieval Query Planner 000548
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
