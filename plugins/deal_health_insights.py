...
# File       : deal_health_insights.py
# Description: Provides detailed insights into the performance of deals to inform strategic decision-making
# Goal       : Provides detailed insights into the performance of deals to inform strategic decision-making
# Category   : sales | analysis
# Tags       : deal, performance, insight
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides detailed insights into the performance of deals to inform strategic decision-making'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['deal', 'performance', 'insight']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_health_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
