...
Plugin: AI Operations Monitor Anomaly Watch Builder
...
_PLUGIN_NAME: str = 'AI Operations Monitor Anomaly Watch Builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Anomaly Watch Builder'
