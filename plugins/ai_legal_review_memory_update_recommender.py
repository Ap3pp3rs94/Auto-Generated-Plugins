...
Capability: AI Legal Review Memory Update Recommender 000198
...
_PLUGIN_NAME: str = 'AI Legal Review Memory Update Recommender 000198'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Memory Update Recommender 000198'
