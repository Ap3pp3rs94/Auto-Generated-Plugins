...
Capability: AI Research Agent Trace Failure Router 000115
...
_PLUGIN_NAME: str = 'AI Research Agent Trace Failure Router 000115'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Trace Failure Router 000115'
