...
Plugin: AI Coding Agent Agentic Planning Response Action Planner
Slug: ai_coding_agent_agentic_planning_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Response Action Planner'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_response_action_planner'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI coding agents and repository work for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'evaluation', 'actions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Response Action Planner'
        goal = 'Convert AI coding agents and repository work for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI coding agents and repository work for agentic planning response actionability and next-step planning'
