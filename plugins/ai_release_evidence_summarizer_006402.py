...
Capability: AI Release Evidence Summarizer 006402
Slug: ai_release_evidence_summarizer_006402
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 006402'
        goal = 'Summarize validation and release evidence for AI education, tutoring, and learning workflows for task decomposition AI capability artifacts.'
        domain = 'AI education, tutoring, and learning workflows for task decomposition release evidence and publishing readiness'
