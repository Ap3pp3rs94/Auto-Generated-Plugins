...
Capability: AI Prompt Contract Designer 001201
Slug: ai_prompt_contract_designer_001201
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Contract Designer 001201'
        goal = 'Design prompt contracts for AI capability factory and generated module operations for AI tool use with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI capability factory and generated module operations for AI tool use prompt contracts and structured instruction design'
