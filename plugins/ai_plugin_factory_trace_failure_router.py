...
Plugin: AI Capability Factory Trace Failure Router
Slug: ai_plugin_factory_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_plugin_factory_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Trace Failure Router'
