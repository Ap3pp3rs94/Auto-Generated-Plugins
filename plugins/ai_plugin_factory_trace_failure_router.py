...
Capability: AI Capability Factory Trace Failure Router 000451
...
_PLUGIN_NAME: str = 'AI Capability Factory Trace Failure Router 000451'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Trace Failure Router 000451'
