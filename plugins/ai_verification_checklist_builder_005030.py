...
Capability: AI Verification Checklist Builder 005030
Slug: ai_verification_checklist_builder_005030
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 005030'
        goal = 'Build verification checklists for AI operations monitoring and incident response for compliance review AI artifacts before release or handoff.'
        domain = 'AI operations monitoring and incident response for compliance review verification planning and acceptance checks'
