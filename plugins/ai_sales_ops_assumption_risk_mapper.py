...
Capability: AI Sales Ops Assumption Risk Mapper 000157
...
_PLUGIN_NAME: str = 'AI Sales Ops Assumption Risk Mapper 000157'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Assumption Risk Mapper 000157'
