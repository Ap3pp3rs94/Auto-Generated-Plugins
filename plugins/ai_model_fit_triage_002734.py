...
Capability: AI Model Fit Triage 002734
Slug: ai_model_fit_triage_002734
"""
...
_PLUGIN_NAME: str = 'AI Model Fit Triage 002734'
_PLUGIN_SLUG: str = 'ai_model_fit_triage_002734'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Fit Triage 002734'
