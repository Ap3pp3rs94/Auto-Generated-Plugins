...
Plugin: AI Clinical Admin Agentic Planning Anomaly Watch Builder 000568
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
