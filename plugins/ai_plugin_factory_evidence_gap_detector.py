...
Plugin: AI Capability Factory Evidence Gap Detector
Slug: ai_plugin_factory_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_plugin_factory_evidence_gap_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Evidence Gap Detector'
