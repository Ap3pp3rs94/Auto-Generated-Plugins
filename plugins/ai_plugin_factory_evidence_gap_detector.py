...
Capability: AI Capability Factory Evidence Gap Detector 000435
...
_PLUGIN_NAME: str = 'AI Capability Factory Evidence Gap Detector 000435'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Evidence Gap Detector 000435'
