...
Capability: AI Research Agent Response Action Planner 000108
...
_PLUGIN_NAME: str = 'AI Research Agent Response Action Planner 000108'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Response Action Planner 000108'
