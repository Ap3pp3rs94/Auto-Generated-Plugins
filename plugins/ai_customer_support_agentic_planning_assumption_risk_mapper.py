...
Capability: AI Customer Support Agentic Planning Assumption Risk Mapper 000517
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'assumptions', 'risk', 'readiness', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
