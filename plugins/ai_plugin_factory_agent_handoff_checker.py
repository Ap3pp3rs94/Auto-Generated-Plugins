...
Plugin: AI Capability Factory Agent Handoff Checker
Slug: ai_plugin_factory_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_plugin_factory_agent_handoff_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Agent Handoff Checker'
