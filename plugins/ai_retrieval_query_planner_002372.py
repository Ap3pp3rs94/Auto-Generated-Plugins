...
Capability: AI Retrieval Query Planner 002372
Slug: ai_retrieval_query_planner_002372
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002372'
        goal = 'Plan focused retrieval queries for AI capability factory and generated module operations for evaluation feedback when evidence is missing or stale.'
        domain = 'AI capability factory and generated module operations for evaluation feedback retrieval query planning and grounding'
