...
Capability: AI Customer Support Agentic Planning Context Noise Filter 000509
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
