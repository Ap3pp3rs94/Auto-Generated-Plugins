...
Capability: AI Legal Review Agentic Planning Trace Failure Router 000595
Slug: ai_legal_review_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Agentic Planning Trace Failure Router 000595'
_PLUGIN_SLUG: str = 'ai_legal_review_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Agentic Planning Trace Failure Router 000595'
