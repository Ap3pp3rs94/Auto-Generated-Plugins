...
Plugin: AI Personal Assistant Prompt Contract Designer
Slug: ai_personal_assistant_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_personal_assistant_prompt_contract_designer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Prompt Contract Designer'
