...
# Title      : Sales Opportunity Profiler
# File       : sales_opportunity_profiler.py
# Description: Identify and profile sales opportunities by analyzing customer behavior and purchase history to prioritize follow-ups.
# Goal       : Identify and profile sales opportunities by analyzing customer behavior and purchase history to prioritize follow-ups.
# Category   : sales
# Tags       : opportunity, profiling
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Opportunity Profiler'
_PLUGIN_GOAL: str = 'Identify and profile sales opportunities by analyzing customer behavior and purchase history to prioritize follow-ups.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['opportunity', 'profiling']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_profiler'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
