...
Capability: AI Retrieval Query Planner 002660
Slug: ai_retrieval_query_planner_002660
"""
...
_PLUGIN_NAME: str = 'AI Retrieval Query Planner 002660'
_PLUGIN_SLUG: str = 'ai_retrieval_query_planner_002660'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002660'
