...
Capability: AI Finance Ops Context Noise Filter 000221
...
_PLUGIN_NAME: str = 'AI Finance Ops Context Noise Filter 000221'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Context Noise Filter 000221'
