...
Plugin: AI Finance Ops Context Noise Filter
Slug: ai_finance_ops_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Context Noise Filter'
_PLUGIN_SLUG: str = 'ai_finance_ops_context_noise_filter'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI finance operations and risk review.'
_PLUGIN_TAGS = ['finance', 'risk', 'context', 'tokens', 'noise', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Context Noise Filter'
        goal = 'Filter noisy or redundant context before model calls for AI finance operations and risk review.'
        domain = 'AI finance operations and risk review context filtering and token-budget control'
