...
Plugin: AI Instruction Hierarchy Checker 000911
Slug: ai_instruction_hierarchy_checker_000911
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 000911'
        goal = 'Check AI customer support and service workflows for AI tool use instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI customer support and service workflows for AI tool use instruction hierarchy and conflict safety'
