...
Plugin: AI Clinical Admin Tool Safety Reviewer Set 2
Slug: ai_clinical_admin_tool_safety_reviewer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Tool Safety Reviewer Set 2'
_PLUGIN_SLUG: str = 'ai_clinical_admin_tool_safety_reviewer_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Tool Safety Reviewer Set 2'
