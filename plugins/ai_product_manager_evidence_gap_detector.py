...
Capability: AI Product Manager Evidence Gap Detector 000339
...
_PLUGIN_NAME: str = 'AI Product Manager Evidence Gap Detector 000339'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Evidence Gap Detector 000339'
