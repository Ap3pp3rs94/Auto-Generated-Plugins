...
Plugin: AI Operations Monitor Citation Priority Scorer
Slug: ai_operations_monitor_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_operations_monitor_citation_priority_scorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Citation Priority Scorer'
