...
Capability: AI Memory Fact Extractor 000029
Slug: ai_memory_fact_extractor_000029
"""
...
_PLUGIN_SLUG: str = 'ai_memory_fact_extractor_000029'
...
_PLUGIN_MANIFEST = {'name': 'AI Memory Fact Extractor 000029', 'slug': 'ai_memory_fact_extractor_000029', 'goal': 'Extract durable facts, user preferences, decisions, and blockers for AI memory.', 'category': 'ai_memory', 'tags': ['ai', 'memory', 'facts', 'preferences', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI durable memory and fact extraction', 'owner_id': None, 'use_cases': ['Identify facts that should be saved across runs.', 'Separate durable decisions from temporary conversation.', 'Carry blockers and preferences into the next AI workflow.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
