...
# File       : customer_sentiment_analysis.py
# Description: Provides insights into customer satisfaction and sentiment from social media feedback, identifying areas for improvement.
# Goal       : Provides insights into customer satisfaction and sentiment from social media feedback, identifying areas for improvement.
# Category   : sales | marketing
# Tags       : customer, sentiment, feedback
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Customer Sentiment Analysis'
_PLUGIN_GOAL: str = 'Provides insights into customer satisfaction and sentiment from social media feedback, identifying areas for improvement.'
_PLUGIN_CATEGORY: str = 'sales | marketing'
_PLUGIN_TAGS = ['customer', 'sentiment', 'feedback']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_sentiment_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
