...
Plugin: AI Operations Monitor Model Fit Triage
Slug: ai_operations_monitor_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Model Fit Triage'
_PLUGIN_SLUG: str = 'ai_operations_monitor_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Model Fit Triage'
