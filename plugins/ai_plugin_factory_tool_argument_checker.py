...
Capability: AI Capability Factory Tool Argument Checker 000442
...
_PLUGIN_NAME: str = 'AI Capability Factory Tool Argument Checker 000442'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Tool Argument Checker 000442'
