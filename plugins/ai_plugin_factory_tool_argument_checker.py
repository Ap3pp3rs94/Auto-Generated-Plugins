...
Plugin: AI Capability Factory Tool Argument Checker
Slug: ai_plugin_factory_tool_argument_checker
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Tool Argument Checker'
_PLUGIN_SLUG: str = 'ai_plugin_factory_tool_argument_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Tool Argument Checker'
