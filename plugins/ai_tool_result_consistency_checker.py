...
Plugin: AI Tool Result Consistency Checker
...
_PLUGIN_NAME: str = 'AI Tool Result Consistency Checker'
...
_PLUGIN_TAGS = ['ai', 'tools', 'consistency', 'traces', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Result Consistency Checker'
