...
Plugin: AI Data Analysis Output Completeness Grader Set 2
Slug: ai_data_analysis_output_completeness_grader_set_2
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Output Completeness Grader Set 2'
_PLUGIN_SLUG: str = 'ai_data_analysis_output_completeness_grader_set_2'
...
_PLUGIN_TAGS = ['data', 'analytics', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Output Completeness Grader Set 2'
        goal = 'Grade AI data analysis and analytics workflows AI outputs for completeness against task requirements and acceptance criteria.'
