...
Capability: AI Evidence Gap Detector 011235
Slug: ai_evidence_gap_detector_011235
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Detector 011235'
_PLUGIN_SLUG: str = 'ai_evidence_gap_detector_011235'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 011235'
