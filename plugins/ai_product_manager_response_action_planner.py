...
Plugin: AI Product Manager Response Action Planner
Slug: ai_product_manager_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Response Action Planner'
_PLUGIN_SLUG: str = 'ai_product_manager_response_action_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Response Action Planner'
