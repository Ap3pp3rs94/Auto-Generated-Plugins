...
Plugin: AI Content Strategy Prompt Contract Designer Set 2
Slug: ai_content_strategy_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI content strategy and editorial workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI content strategy and editorial workflows prompt contracts and structured instruction design'
