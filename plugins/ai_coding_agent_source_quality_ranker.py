...
Capability: AI Coding Agent Source Quality Ranker 000076
...
_PLUGIN_NAME: str = 'AI Coding Agent Source Quality Ranker 000076'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Source Quality Ranker 000076'
