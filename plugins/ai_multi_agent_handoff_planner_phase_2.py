...
Plugin: AI Multi-Agent Handoff Planner Phase 2
Slug: ai_multi_agent_handoff_planner_phase_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Multi-Agent Handoff Planner Phase 2'
        goal = 'Extend AI Multi-Agent Handoff Planner with phase 2 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
