...
Capability: AI Sales Ops Evidence Gap Detector 000147
...
_PLUGIN_NAME: str = 'AI Sales Ops Evidence Gap Detector 000147'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Evidence Gap Detector 000147'
