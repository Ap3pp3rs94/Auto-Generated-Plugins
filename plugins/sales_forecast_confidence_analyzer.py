...
# Title      : Sales Forecast Confidence Checker
# File       : sales_forecast_confidence_analyzer.py
# Description: Provides insights into sales forecast confidence levels to inform business decisions.
# Goal       : Provides insights into sales forecast confidence levels to inform business decisions.
# Category   : analysis
# Tags       : confidence, forecast, sales
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Forecast Confidence Checker'
_PLUGIN_GOAL: str = 'Provides insights into sales forecast confidence levels to inform business decisions.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['confidence', 'forecast', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_forecast_confidence_analyzer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
