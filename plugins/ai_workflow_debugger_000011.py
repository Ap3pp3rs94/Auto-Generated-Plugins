...
Capability: AI Workflow Debugger 000011
Slug: ai_workflow_debugger_000011
"""
...
_PLUGIN_NAME: str = 'AI Workflow Debugger 000011'
_PLUGIN_SLUG: str = 'ai_workflow_debugger_000011'
...
_PLUGIN_USE_CASES = ['Summarize failed model/tool-call traces.', 'Identify prompt, tool, data, or validation failure points.', 'Recommend the smallest fix to retry safely.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Workflow Debugger 000011', 'slug': 'ai_workflow_debugger_000011', 'goal': 'Analyze failed AI workflow traces and identify likely failure stages and fixes.', 'category': 'ai_agents', 'tags': ['ai', 'workflow', 'debugging', 'traces', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI workflow observability and debugging', 'owner_id': None, 'use_cases': ['Summarize failed model/tool-call traces.', 'Identify prompt, tool, data, or validation failure points.', 'Recommend the smallest fix to retry safely.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Workflow Debugger 000011'
