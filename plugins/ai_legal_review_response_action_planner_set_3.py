...
Plugin: AI Legal Review Response Action Planner Set 3
Slug: ai_legal_review_response_action_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Response Action Planner Set 3'
_PLUGIN_SLUG: str = 'ai_legal_review_response_action_planner_set_3'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI legal review and compliance workflows AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['legal', 'compliance', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI legal review and compliance workflows response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Response Action Planner Set 3'
        goal = 'Convert AI legal review and compliance workflows AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI legal review and compliance workflows response actionability and next-step planning'
