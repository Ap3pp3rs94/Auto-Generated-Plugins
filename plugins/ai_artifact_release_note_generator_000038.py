...
Capability: AI Artifact Release Note Generator 000038
Slug: ai_artifact_release_note_generator_000038
"""
...
_PLUGIN_NAME: str = 'AI Artifact Release Note Generator 000038'
_PLUGIN_SLUG: str = 'ai_artifact_release_note_generator_000038'
...
_PLUGIN_TAGS = ['ai', 'release-notes', 'artifacts', 'validation', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_USE_CASES = ['Summarize generated artifact changes for users.', 'Include validation and semantic-depth evidence.', 'Call out known risks, limitations, and next checks.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Artifact Release Note Generator 000038', 'slug': 'ai_artifact_release_note_generator_000038', 'goal': 'Generate concise release notes for AI-created artifacts, including validation evidence and risks.', 'category': 'ai_agents', 'tags': ['ai', 'release-notes', 'artifacts', 'validation', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI artifact release notes and change communication', 'owner_id': None, 'use_cases': ['Summarize generated artifact changes for users.', 'Include validation and semantic-depth evidence.', 'Call out known risks, limitations, and next checks.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Artifact Release Note Generator 000038'
