...
Capability: AI Retrieval Query Planner 002012
Slug: ai_retrieval_query_planner_002012
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002012'
        goal = 'Plan focused retrieval queries for AI coding agents and repository work for evaluation feedback when evidence is missing or stale.'
        domain = 'AI coding agents and repository work for evaluation feedback retrieval query planning and grounding'
