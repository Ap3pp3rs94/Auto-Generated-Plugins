...
Capability: AI Output Completeness Grader 002675
Slug: ai_output_completeness_grader_002675
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 002675'
        goal = 'Grade AI content strategy and editorial workflows for safety controls AI outputs for completeness against task requirements and acceptance criteria.'
        domain = 'AI content strategy and editorial workflows for safety controls output completeness and acceptance scoring'
