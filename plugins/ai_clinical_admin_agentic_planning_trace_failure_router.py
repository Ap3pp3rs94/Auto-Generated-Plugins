...
Capability: AI Clinical Admin Agentic Planning Trace Failure Router 000571
Slug: ai_clinical_admin_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Agentic Planning Trace Failure Router 000571'
_PLUGIN_SLUG: str = 'ai_clinical_admin_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Agentic Planning Trace Failure Router 000571'
