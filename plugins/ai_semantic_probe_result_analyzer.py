...
Capability: AI Semantic Probe Result Analyzer 000071
...
_PLUGIN_NAME: str = 'AI Semantic Probe Result Analyzer 000071'
...
_PLUGIN_MANIFEST = {'name': 'AI Semantic Probe Result Analyzer 000071', 'slug': 'ai_semantic_probe_result_analyzer', 'goal': 'Analyze semantic probe results and explain whether a generated capability is real, shallow, or off-target.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'semantic-depth', 'validation', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI semantic-depth evaluation and capability acceptance', 'owner_id': 'francis-factory', 'use_cases': ['Compare probe outputs for meaningful behavioral differences.', 'Identify string interpolation masquerading as analysis.', 'Recommend accept, repair, or discard decisions with evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logic_profile_id = resolve_logic_profile(requested_profile_id or 'semantic_probe_result_analyzer_profile') or 'semantic_probe_result_analyzer_profile'
        manifest = {'name': 'AI Semantic Probe Result Analyzer 000071', 'slug': 'ai_semantic_probe_result_analyzer', 'goal': 'Analyze semantic probe results and explain whether a generated capability is real, shallow, or off-target.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'semantic-depth', 'validation', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI semantic-depth evaluation and capability acceptance', 'owner_id': 'francis-factory', 'use_cases': ['Compare probe outputs for meaningful behavioral differences.', 'Identify string interpolation masquerading as analysis.', 'Recommend accept, repair, or discard decisions with evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'semantic_probe_result_analyzer_profile', 'generation_note': 'capability profile registry override'}
