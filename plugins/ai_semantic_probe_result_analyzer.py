...
Plugin: AI Semantic Probe Result Analyzer
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Semantic Probe Result Analyzer'
        goal = 'Analyze semantic probe results and explain whether a generated capability is real, shallow, or off-target.'
        domain = 'AI semantic-depth evaluation and capability acceptance'
        capability_type = 'scoring'
        logic_profile_id = 'semantic_probe_result_analyzer_profile'
        generation_note = 'capability profile registry override'
        use_cases = ['Compare probe outputs for meaningful behavioral differences.', 'Identify string interpolation masquerading as analysis.', 'Recommend accept, repair, or discard decisions with evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
