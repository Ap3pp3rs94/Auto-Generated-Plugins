...
Plugin: AI Sales Ops Agentic Planning Anomaly Watch Builder 000544
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
