...
Plugin: AI Sales Ops Trace Failure Router
Slug: ai_sales_ops_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_sales_ops_trace_failure_router'
...
_PLUGIN_TAGS = ['sales', 'business', 'traces', 'failures', 'debugging', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Trace Failure Router'
