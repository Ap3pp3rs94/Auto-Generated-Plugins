...
Capability: AI Sales Ops Trace Failure Router 000163
...
_PLUGIN_NAME: str = 'AI Sales Ops Trace Failure Router 000163'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Trace Failure Router 000163'
