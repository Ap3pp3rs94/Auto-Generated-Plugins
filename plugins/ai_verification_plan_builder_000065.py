...
Capability: AI Verification Plan Builder 000065
Slug: ai_verification_plan_builder_000065
"""
...
_PLUGIN_NAME: str = 'AI Verification Plan Builder 000065'
_PLUGIN_SLUG: str = 'ai_verification_plan_builder_000065'
...
_PLUGIN_MANIFEST = {'name': 'AI Verification Plan Builder 000065', 'slug': 'ai_verification_plan_builder_000065', 'goal': 'Build focused verification plans for AI-generated code, answers, workflows, or artifacts.', 'category': 'ai_evaluation', 'tags': ['ai', 'verification', 'tests', 'quality', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI verification planning and acceptance checks', 'owner_id': None, 'use_cases': ['Turn acceptance criteria into concrete verification steps.', 'Separate automated checks from human review.', 'Recommend evidence that should be captured before release.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Plan Builder 000065'
