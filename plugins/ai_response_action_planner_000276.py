...
Capability: AI Response Action Planner 000276
Slug: ai_response_action_planner_000276
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000276'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000276'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000276'
