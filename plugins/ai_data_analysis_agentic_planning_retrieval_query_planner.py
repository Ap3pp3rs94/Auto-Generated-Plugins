...
Plugin: AI Data Analysis Agentic Planning Retrieval Query Planner 000692
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
