...
Capability: AI Capability Factory Citation Priority Scorer 000453
...
_PLUGIN_NAME: str = 'AI Capability Factory Citation Priority Scorer 000453'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Citation Priority Scorer 000453'
