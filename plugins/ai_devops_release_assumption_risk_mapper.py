...
Capability: AI DevOps Release Assumption Risk Mapper 000277
...
_PLUGIN_NAME: str = 'AI DevOps Release Assumption Risk Mapper 000277'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Assumption Risk Mapper 000277'
