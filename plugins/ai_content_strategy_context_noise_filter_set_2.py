...
Plugin: AI Content Strategy Context Noise Filter Set 2
Slug: ai_content_strategy_context_noise_filter_set_2
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Context Noise Filter Set 2'
_PLUGIN_SLUG: str = 'ai_content_strategy_context_noise_filter_set_2'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI content strategy and editorial workflows.'
_PLUGIN_TAGS = ['content', 'strategy', 'context', 'tokens', 'noise', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI content strategy and editorial workflows context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Context Noise Filter Set 2'
        goal = 'Filter noisy or redundant context before model calls for AI content strategy and editorial workflows.'
        domain = 'AI content strategy and editorial workflows context filtering and token-budget control'
