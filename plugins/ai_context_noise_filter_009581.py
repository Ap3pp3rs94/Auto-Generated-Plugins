...
Capability: AI Context Noise Filter 009581
Slug: ai_context_noise_filter_009581
"""
...
_PLUGIN_NAME: str = 'AI Context Noise Filter 009581'
_PLUGIN_SLUG: str = 'ai_context_noise_filter_009581'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 009581'
