...
# Title      : Deal Health Insights
# File       : deal_health_insight.py
# Description: Provides actionable insights on deal health to optimize sales performance and improve forecasting accuracy.
# Goal       : Provides actionable insights on deal health to optimize sales performance and improve forecasting accuracy.
# Category   : analysis
# Tags       : deal, health, insights
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Health Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights on deal health to optimize sales performance and improve forecasting accuracy.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['deal', 'health', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_health_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
