...
Plugin: AI Acceptance Criteria Extractor Phase 15
Slug: ai_acceptance_criteria_extractor_phase_15
"""
...
_PLUGIN_NAME: str = 'AI Acceptance Criteria Extractor Phase 15'
_PLUGIN_SLUG: str = 'ai_acceptance_criteria_extractor_phase_15'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Extend AI Acceptance Criteria Extractor with phase 15 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
_PLUGIN_TAGS = ['ai', 'criteria', 'evaluation', 'requirements', 'autonomous_factory', 'ai_progress', 'phase_15']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Acceptance Criteria Extractor Phase 15'
        goal = 'Extend AI Acceptance Criteria Extractor with phase 15 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
        ...
        use_cases = ['Turn loose requirements into measurable pass/fail criteria.', 'Separate hard failures from polish preferences.', 'Produce a checklist usable by humans or validation tools.', 'Show a compact progress state for this AI capability during advanced refinement pass 15.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
