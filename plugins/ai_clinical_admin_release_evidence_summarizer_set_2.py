...
Plugin: AI Clinical Admin Release Evidence Summarizer Set 2
Slug: ai_clinical_admin_release_evidence_summarizer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Release Evidence Summarizer Set 2'
_PLUGIN_SLUG: str = 'ai_clinical_admin_release_evidence_summarizer_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Release Evidence Summarizer Set 2'
