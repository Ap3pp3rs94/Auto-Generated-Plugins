...
# File       : deal_velocity_insight.py
# Description: Provides actionable insights on deal velocity to inform sales strategies and optimize pipeline performance.
# Goal       : Provides actionable insights on deal velocity to inform sales strategies and optimize pipeline performance.
# Category   : sales
# Tags       : deal, velocity, insights
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable insights on deal velocity to inform sales strategies and optimize pipeline performance.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['deal', 'velocity', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_velocity_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
