...
Capability: AI Customer Support Agentic Planning Source Quality Ranker 000508
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
