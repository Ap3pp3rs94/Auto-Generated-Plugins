...
Plugin: AI Workflow Retry Strategy Planner
...
_PLUGIN_NAME: str = 'AI Workflow Retry Strategy Planner'
_PLUGIN_SLUG: str = 'ai_workflow_retry_strategy_planner'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Plan safe retries for failed AI workflows without repeating the same failure.'
_PLUGIN_TAGS = ['ai', 'retry', 'workflow', 'debugging', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Workflow Retry Strategy Planner'
