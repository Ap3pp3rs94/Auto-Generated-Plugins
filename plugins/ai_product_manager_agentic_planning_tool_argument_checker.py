...
Capability: AI Product Manager Agentic Planning Tool Argument Checker 000730
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
