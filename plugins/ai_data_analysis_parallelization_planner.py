...
Capability: AI Data Analysis Parallelization Planner 000296
...
_PLUGIN_NAME: str = 'AI Data Analysis Parallelization Planner 000296'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Parallelization Planner 000296'
