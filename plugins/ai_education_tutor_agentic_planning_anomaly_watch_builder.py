...
Plugin: AI Education Tutor Agentic Planning Anomaly Watch Builder 000640
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
