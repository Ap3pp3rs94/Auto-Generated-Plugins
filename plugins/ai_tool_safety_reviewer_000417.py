...
Capability: AI Tool Safety Reviewer 000417
Slug: ai_tool_safety_reviewer_000417
"""
...
_PLUGIN_NAME: str = 'AI Tool Safety Reviewer 000417'
_PLUGIN_SLUG: str = 'ai_tool_safety_reviewer_000417'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'tools', 'safety', 'permissions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 000417'
