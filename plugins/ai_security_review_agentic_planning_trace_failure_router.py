...
Capability: AI Security Review Agentic Planning Trace Failure Router 000715
Slug: ai_security_review_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Security Review Agentic Planning Trace Failure Router 000715'
_PLUGIN_SLUG: str = 'ai_security_review_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Agentic Planning Trace Failure Router 000715'
