...
# File       : product_market_fit_analysis.py
# Description: Analyzes market trends and product performance to identify opportunities for improvement
# Goal       : Analyzes market trends and product performance to identify opportunities for improvement
# Category   : analysis
# Tags       : market, product
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Product-Market Fit Analyzer'
_PLUGIN_GOAL: str = 'Analyzes market trends and product performance to identify opportunities for improvement'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['market', 'product']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'product_market_fit_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
