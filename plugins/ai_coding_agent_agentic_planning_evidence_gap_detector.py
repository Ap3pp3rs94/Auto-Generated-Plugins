...
Plugin: AI Coding Agent Agentic Planning Evidence Gap Detector
Slug: ai_coding_agent_agentic_planning_evidence_gap_detector
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Evidence Gap Detector'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI coding agents and repository work for agentic planning.'
        domain = 'AI coding agents and repository work for agentic planning evidence gaps and retrieval readiness'
