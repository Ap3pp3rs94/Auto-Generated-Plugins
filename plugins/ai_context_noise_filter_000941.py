...
Capability: AI Context Noise Filter 000941
Slug: ai_context_noise_filter_000941
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 000941'
        goal = 'Filter noisy or redundant context before model calls for AI clinical administration and healthcare operations for AI tool use.'
        domain = 'AI clinical administration and healthcare operations for AI tool use context filtering and token-budget control'
