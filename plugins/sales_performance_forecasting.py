...
# Title      : Sales Performance Forecaster
# File       : sales_performance_forecasting.py
# Description: Forecast future sales performance based on historical data and trends.
# Goal       : Forecast future sales performance based on historical data and trends.
# Category   : analysis
...
_PLUGIN_NAME: str = 'Sales Performance Forecaster'
_PLUGIN_GOAL: str = 'Forecast future sales performance based on historical data and trends.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['forecasting', 'prediction']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_forecasting'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
