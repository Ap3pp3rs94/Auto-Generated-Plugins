...
# File       : sales_performance_insights_2.py
# Description: Provides actionable insights on sales performance to inform strategic decisions.
# Goal       : Provides actionable insights on sales performance to inform strategic decisions.
# Category   : analysis
...
_PLUGIN_GOAL: str = 'Provides actionable insights on sales performance to inform strategic decisions.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['insights', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_insights_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
