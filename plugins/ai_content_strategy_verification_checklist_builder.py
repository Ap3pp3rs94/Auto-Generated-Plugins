...
Plugin: AI Content Strategy Verification Checklist Builder
Slug: ai_content_strategy_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_content_strategy_verification_checklist_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Verification Checklist Builder'
