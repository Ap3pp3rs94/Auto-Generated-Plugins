...
Plugin: AI Product Manager Model Fit Triage
Slug: ai_product_manager_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Model Fit Triage'
_PLUGIN_SLUG: str = 'ai_product_manager_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Model Fit Triage'
