...
Capability: AI Clinical Admin Agentic Planning Verification Checklist Builder 000566
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
