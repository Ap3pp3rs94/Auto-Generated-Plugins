...
Plugin: AI DevOps Release Parallelization Planner
Slug: ai_devops_release_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Parallelization Planner'
_PLUGIN_SLUG: str = 'ai_devops_release_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Parallelization Planner'
