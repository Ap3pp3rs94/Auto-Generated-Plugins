...
# File       : sales_performance_explorer.py
# Description: Visualize sales performance trends and insights to inform strategic decision making.
# Goal       : Visualize sales performance trends and insights to inform strategic decision making.
# Category   : sales
# Tags       : trend, insight
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Performance Explorer'
_PLUGIN_GOAL: str = 'Visualize sales performance trends and insights to inform strategic decision making.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['trend', 'insight']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_explorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
