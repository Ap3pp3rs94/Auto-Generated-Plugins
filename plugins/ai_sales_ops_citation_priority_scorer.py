...
Capability: AI Sales Ops Citation Priority Scorer 000165
...
_PLUGIN_NAME: str = 'AI Sales Ops Citation Priority Scorer 000165'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Citation Priority Scorer 000165'
