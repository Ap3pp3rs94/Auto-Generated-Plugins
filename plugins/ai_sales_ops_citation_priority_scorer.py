...
Plugin: AI Sales Ops Citation Priority Scorer
Slug: ai_sales_ops_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_sales_ops_citation_priority_scorer'
...
_PLUGIN_TAGS = ['sales', 'business', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Citation Priority Scorer'
