...
Capability: AI Retrieval Query Planner 009116
Slug: ai_retrieval_query_planner_009116
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 009116'
        goal = 'Plan focused retrieval queries for AI recruiting, interview planning, candidate review, and hiring workflow support for evaluation feedback when evidence is missing or stale.'
        domain = 'AI recruiting, interview planning, candidate review, and hiring workflow support for evaluation feedback retrieval query planning and grounding'
