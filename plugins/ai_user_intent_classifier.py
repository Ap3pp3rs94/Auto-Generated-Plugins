...
Plugin: AI User Intent Classifier
...
_PLUGIN_NAME: str = 'AI User Intent Classifier'
_PLUGIN_SLUG: str = 'ai_user_intent_classifier'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Classify a user request into the right AI workflow intent and execution mode.'
_PLUGIN_TAGS = ['ai', 'intent', 'routing', 'classification', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI User Intent Classifier'
