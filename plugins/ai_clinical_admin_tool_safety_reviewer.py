...
Capability: AI Clinical Admin Tool Safety Reviewer 000177
...
_PLUGIN_NAME: str = 'AI Clinical Admin Tool Safety Reviewer 000177'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Tool Safety Reviewer 000177'
