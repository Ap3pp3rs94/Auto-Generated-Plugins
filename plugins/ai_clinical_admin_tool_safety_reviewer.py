...
Plugin: AI Clinical Admin Tool Safety Reviewer
Slug: ai_clinical_admin_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_clinical_admin_tool_safety_reviewer'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'tools', 'safety', 'permissions', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Tool Safety Reviewer'
