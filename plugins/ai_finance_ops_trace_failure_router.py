...
Capability: AI Finance Ops Trace Failure Router 000235
...
_PLUGIN_NAME: str = 'AI Finance Ops Trace Failure Router 000235'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Trace Failure Router 000235'
