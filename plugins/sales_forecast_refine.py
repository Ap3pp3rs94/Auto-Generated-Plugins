...
# Title      : Sales Forecast Refinement
# File       : sales_forecast_refine.py
# Description: Refines sales forecasts by identifying and adjusting for potential biases, resulting in more accurate predictions.
# Goal       : Refines sales forecasts by identifying and adjusting for potential biases, resulting in more accurate predictions.
# Category   : sales | automation
# Tags       : forecasting, bias detection
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Forecast Refinement'
_PLUGIN_GOAL: str = 'Refines sales forecasts by identifying and adjusting for potential biases, resulting in more accurate predictions.'
_PLUGIN_CATEGORY: str = 'sales | automation'
_PLUGIN_TAGS = ['forecasting', 'bias detection']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_forecast_refine'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
