...
Plugin: AI Content Strategy Evidence Gap Detector Set 2
Slug: ai_content_strategy_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI content strategy and editorial workflows.'
        domain = 'AI content strategy and editorial workflows evidence gaps and retrieval readiness'
