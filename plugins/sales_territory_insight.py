...
# Title      : Sales Territory Insights
# File       : sales_territory_insight.py
# Description: Provides actionable insights on sales territory performance, enabling data-driven decisions and improved sales strategies.
# Goal       : Provides actionable insights on sales territory performance, enabling data-driven decisions and improved sales strategies.
# Category   : sales
# Tags       : territory, performance, insights
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Territory Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights on sales territory performance, enabling data-driven decisions and improved sales strategies.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['territory', 'performance', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_territory_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
