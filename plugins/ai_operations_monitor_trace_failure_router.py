...
Capability: AI Operations Monitor Trace Failure Router 000427
...
_PLUGIN_NAME: str = 'AI Operations Monitor Trace Failure Router 000427'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Trace Failure Router 000427'
