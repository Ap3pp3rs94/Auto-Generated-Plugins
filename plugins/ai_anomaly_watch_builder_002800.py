...
Capability: AI Anomaly Watch Builder 002800
Slug: ai_anomaly_watch_builder_002800
"""
...
_PLUGIN_NAME: str = 'AI Anomaly Watch Builder 002800'
_PLUGIN_SLUG: str = 'ai_anomaly_watch_builder_002800'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Anomaly Watch Builder 002800'
