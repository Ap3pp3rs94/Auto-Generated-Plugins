...
Capability: AI DevOps Release Agentic Planning Context Noise Filter 000653
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
