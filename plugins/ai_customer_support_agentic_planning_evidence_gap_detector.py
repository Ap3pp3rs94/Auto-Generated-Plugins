...
Capability: AI Customer Support Agentic Planning Evidence Gap Detector 000507
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
