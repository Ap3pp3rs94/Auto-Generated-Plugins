...
# Title      : Deal Performance Tracker
# File       : deal_performance_tracker.py
# Description: Automatically track and analyze deal performance to identify trends, opportunities, and areas for improvement.
# Goal       : Automatically track and analyze deal performance to identify trends, opportunities, and areas for improvement.
# Category   : sales | analysis
# Tags       : deal, performance, tracker
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Performance Tracker'
_PLUGIN_GOAL: str = 'Automatically track and analyze deal performance to identify trends, opportunities, and areas for improvement.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['deal', 'performance', 'tracker']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_tracker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
