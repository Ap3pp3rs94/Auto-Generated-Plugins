...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manifest = {'name': 'AI Capability Profile Gap Detector 000070', 'slug': 'ai_plugin_profile_gap_detector', 'goal': 'Detect missing or weak deterministic profiles before new AI capabilities are generated.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'profiles', 'quality', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI capability profile coverage and generation readiness', 'owner_id': 'francis-factory', 'use_cases': ['Compare roadmap specs against available deterministic profiles.', 'Flag specs that would fall back to generic generation.', 'Recommend profile families or new profile implementations.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'plugin_profile_gap_detector_profile', 'generation_note': 'capability profile registry override'}
