...
Plugin: AI Content Strategy Trace Failure Router
Slug: ai_content_strategy_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_content_strategy_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Trace Failure Router'
