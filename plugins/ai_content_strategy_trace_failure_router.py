...
Capability: AI Content Strategy Trace Failure Router 000379
...
_PLUGIN_NAME: str = 'AI Content Strategy Trace Failure Router 000379'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Trace Failure Router 000379'
