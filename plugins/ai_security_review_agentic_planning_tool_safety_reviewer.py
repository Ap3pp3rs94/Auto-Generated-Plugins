...
Capability: AI Security Review Agentic Planning Tool Safety Reviewer 000705
Slug: ai_security_review_agentic_planning_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Security Review Agentic Planning Tool Safety Reviewer 000705'
_PLUGIN_SLUG: str = 'ai_security_review_agentic_planning_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Agentic Planning Tool Safety Reviewer 000705'
