...
_PLUGIN_NAME: str = 'AI Workflow Debugger'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Workflow Debugger'
        ...
        generation_note = 'workflow debugger semantic evidence fix'
