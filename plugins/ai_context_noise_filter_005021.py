...
Capability: AI Context Noise Filter 005021
Slug: ai_context_noise_filter_005021
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 005021'
        goal = 'Filter noisy or redundant context before model calls for AI operations monitoring and incident response for compliance review.'
        domain = 'AI operations monitoring and incident response for compliance review context filtering and token-budget control'
