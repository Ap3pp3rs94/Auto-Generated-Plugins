...
Plugin: AI Capability Factory Tool Argument Checker Set 2
Slug: ai_plugin_factory_tool_argument_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Tool Argument Checker Set 2'
_PLUGIN_SLUG: str = 'ai_plugin_factory_tool_argument_checker_set_2'
...
_PLUGIN_TAGS = ['capabilities', 'factory', 'tools', 'arguments', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Tool Argument Checker Set 2'
        goal = 'Inspect tool arguments for AI capability factory and generated module operations for unsafe scope, missing bounds, or injected instructions.'
