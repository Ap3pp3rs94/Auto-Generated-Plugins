...
Plugin: AI Security Review Model Fit Triage
Slug: ai_security_review_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Security Review Model Fit Triage'
_PLUGIN_SLUG: str = 'ai_security_review_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Model Fit Triage'
