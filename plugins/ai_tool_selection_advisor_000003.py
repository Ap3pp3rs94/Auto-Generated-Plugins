...
Capability: AI Tool Selection Advisor 000003
Slug: ai_tool_selection_advisor_000003
"""
...
_PLUGIN_SLUG: str = 'ai_tool_selection_advisor_000003'
...
_PLUGIN_MANIFEST = {'name': 'AI Tool Selection Advisor 000003', 'slug': 'ai_tool_selection_advisor_000003', 'goal': 'Select the best available tool or integration for an AI workflow based on task requirements.', 'category': 'ai_agents', 'tags': ['ai', 'tools', 'routing', 'integrations', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'integration', 'intended_domain': 'AI tool routing and integration choice', 'owner_id': None, 'use_cases': ['Map task requirements to candidate tools and explain tradeoffs.', 'Flag when no external tool is needed.', 'Recommend tool call order for multi-step AI workflows.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
