...
Capability: AI Education Tutor Memory Update Recommender 000246
Slug: ai_education_tutor_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Memory Update Recommender 000246'
_PLUGIN_SLUG: str = 'ai_education_tutor_memory_update_recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Memory Update Recommender 000246'
