...
Plugin: AI Customer Support Evidence Gap Detector Set 3
Slug: ai_customer_support_evidence_gap_detector_set_3
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Evidence Gap Detector Set 3'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI customer support and service workflows.'
        domain = 'AI customer support and service workflows evidence gaps and retrieval readiness'
