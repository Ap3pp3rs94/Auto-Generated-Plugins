...
Plugin: AI Finance Ops Instruction Hierarchy Checker
Slug: ai_finance_ops_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_finance_ops_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Instruction Hierarchy Checker'
