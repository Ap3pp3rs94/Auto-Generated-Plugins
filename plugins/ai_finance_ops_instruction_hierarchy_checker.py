...
Capability: AI Finance Ops Instruction Hierarchy Checker 000239
...
_PLUGIN_NAME: str = 'AI Finance Ops Instruction Hierarchy Checker 000239'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Instruction Hierarchy Checker 000239'
