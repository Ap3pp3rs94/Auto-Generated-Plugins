...
# Title      : Deal Qualification Insights
# File       : deal_qualification.py
# Description: Provides actionable insights for qualifying deals, enhancing sales productivity and conversion rates.
# Goal       : Provides actionable insights for qualifying deals, enhancing sales productivity and conversion rates.
# Category   : sales | marketing | support
# Tags       : qualifying, deals, insights
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Qualification Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights for qualifying deals, enhancing sales productivity and conversion rates.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support'
_PLUGIN_TAGS = ['qualifying', 'deals', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_qualification'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
