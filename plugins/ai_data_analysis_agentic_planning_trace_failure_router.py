...
Capability: AI Data Analysis Agentic Planning Trace Failure Router 000691
Slug: ai_data_analysis_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Agentic Planning Trace Failure Router 000691'
_PLUGIN_SLUG: str = 'ai_data_analysis_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Agentic Planning Trace Failure Router 000691'
