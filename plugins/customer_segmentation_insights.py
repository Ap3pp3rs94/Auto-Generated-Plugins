...
# Title      : Customer Segmentation Explorer
# File       : customer_segmentation_insights.py
# Description: Identify key customer segments and characteristics to inform marketing, sales, and product strategies.
# Goal       : Identify key customer segments and characteristics to inform marketing, sales, and product strategies.
# Category   : analysis
# Tags       : segmentation, insight
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Customer Segmentation Explorer'
_PLUGIN_GOAL: str = 'Identify key customer segments and characteristics to inform marketing, sales, and product strategies.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['segmentation', 'insight']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_segmentation_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
