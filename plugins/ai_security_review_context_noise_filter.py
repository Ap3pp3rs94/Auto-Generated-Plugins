...
Capability: AI Security Review Context Noise Filter 000317
...
_PLUGIN_NAME: str = 'AI Security Review Context Noise Filter 000317'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Context Noise Filter 000317'
