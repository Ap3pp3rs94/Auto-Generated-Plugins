...
Plugin: AI Security Review Context Noise Filter
Slug: ai_security_review_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Security Review Context Noise Filter'
_PLUGIN_SLUG: str = 'ai_security_review_context_noise_filter'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Context Noise Filter'
