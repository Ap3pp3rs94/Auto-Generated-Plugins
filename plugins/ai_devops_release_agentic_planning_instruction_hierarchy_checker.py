...
Plugin: AI DevOps Release Agentic Planning Instruction Hierarchy Checker 000671
Slug: ai_devops_release_agentic_planning_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Agentic Planning Instruction Hierarchy Checker 000671'
_PLUGIN_SLUG: str = 'ai_devops_release_agentic_planning_instruction_hierarchy_checker'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI DevOps release and infrastructure workflows for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI DevOps release and infrastructure workflows for agentic planning instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Agentic Planning Instruction Hierarchy Checker 000671'
        goal = 'Check AI DevOps release and infrastructure workflows for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI DevOps release and infrastructure workflows for agentic planning instruction hierarchy and conflict safety'
