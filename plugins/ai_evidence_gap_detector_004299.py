...
Capability: AI Evidence Gap Detector 004299
Slug: ai_evidence_gap_detector_004299
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 004299'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI coding agents and repository work for documentation and knowledge capture.'
        domain = 'AI coding agents and repository work for documentation and knowledge capture evidence gaps and retrieval readiness'
