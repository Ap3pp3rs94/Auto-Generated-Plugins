...
_PLUGIN_MANIFEST = {'name': 'AI Trace Signal Extractor 000027', 'slug': 'ai_trace_signal_extractor', 'goal': 'Extract useful failure and progress signals from AI workflow traces.', 'category': 'ai_agents', 'tags': ['ai', 'traces', 'signals', 'debugging', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI trace analysis and workflow observability', 'owner_id': 'francis-factory', 'use_cases': ['Extract failure signals from model, tool, and validation traces.', 'Classify trace events by likely failure stage.', 'Recommend the smallest retry checkpoint.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
