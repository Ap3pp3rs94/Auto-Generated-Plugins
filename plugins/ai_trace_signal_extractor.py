...
Plugin: AI Trace Signal Extractor
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Trace Signal Extractor'
        goal = 'Extract useful failure and progress signals from AI workflow traces.'
        domain = 'AI trace analysis and workflow observability'
        capability_type = 'data_insight'
        logic_profile_id = 'trace_signal_extractor_profile'
        generation_note = 'capability profile registry override'
        use_cases = ['Extract failure signals from model, tool, and validation traces.', 'Classify trace events by likely failure stage.', 'Recommend the smallest retry checkpoint.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
