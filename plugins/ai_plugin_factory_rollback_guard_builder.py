...
Capability: AI Capability Factory Rollback Guard Builder 000447
...
_PLUGIN_NAME: str = 'AI Capability Factory Rollback Guard Builder 000447'
...
_PLUGIN_TAGS = ['capabilities', 'factory', 'rollback', 'safety', 'release', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Rollback Guard Builder 000447'
