...
Plugin: AI Finance Ops Tool Safety Reviewer Set 3
Slug: ai_finance_ops_tool_safety_reviewer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Tool Safety Reviewer Set 3'
_PLUGIN_SLUG: str = 'ai_finance_ops_tool_safety_reviewer_set_3'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Review proposed tool use for AI finance operations and risk review for side effects, permissions, and rollback needs.'
_PLUGIN_TAGS = ['finance', 'risk', 'tools', 'safety', 'permissions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review AI tool safety and approval control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Tool Safety Reviewer Set 3'
        goal = 'Review proposed tool use for AI finance operations and risk review for side effects, permissions, and rollback needs.'
        domain = 'AI finance operations and risk review AI tool safety and approval control'
