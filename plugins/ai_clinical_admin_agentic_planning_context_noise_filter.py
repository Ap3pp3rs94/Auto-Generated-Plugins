...
Capability: AI Clinical Admin Agentic Planning Context Noise Filter 000557
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
