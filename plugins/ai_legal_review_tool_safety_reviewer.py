...
Capability: AI Legal Review Tool Safety Reviewer 000201
...
_PLUGIN_NAME: str = 'AI Legal Review Tool Safety Reviewer 000201'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Tool Safety Reviewer 000201'
