...
Plugin: AI Legal Review Verification Checklist Builder
Slug: ai_legal_review_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_legal_review_verification_checklist_builder'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'verification', 'tests', 'checklists', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Verification Checklist Builder'
