...
Capability: AI Evidence Gap Detector 009147
Slug: ai_evidence_gap_detector_009147
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 009147'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback.'
        domain = 'AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback evidence gaps and retrieval readiness'
