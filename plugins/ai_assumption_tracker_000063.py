...
Capability: AI Assumption Tracker 000063
Slug: ai_assumption_tracker_000063
"""
...
_PLUGIN_NAME: str = 'AI Assumption Tracker 000063'
_PLUGIN_SLUG: str = 'ai_assumption_tracker_000063'
...
_PLUGIN_MANIFEST = {'name': 'AI Assumption Tracker 000063', 'slug': 'ai_assumption_tracker_000063', 'goal': 'Extract, score, and track assumptions that an AI workflow is relying on.', 'category': 'ai_evaluation', 'tags': ['ai', 'assumptions', 'uncertainty', 'requirements', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI assumptions, uncertainty tracking, and task readiness', 'owner_id': None, 'use_cases': ['List explicit and implicit assumptions in a plan or answer.', 'Score assumptions by risk and confidence.', 'Recommend which assumptions need user confirmation or evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Assumption Tracker 000063'
