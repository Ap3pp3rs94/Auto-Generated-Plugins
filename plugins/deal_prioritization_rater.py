...
# Title      : Deal Prioritization Rater
# File       : deal_prioritization_rater.py
# Description: Ranks deals based on customer intent, sales velocity, and other factors to optimize sales team performance
# Goal       : Ranks deals based on customer intent, sales velocity, and other factors to optimize sales team performance
# Category   : sales | marketing | support | analysis | automation | ops
# Tags       : deal, prioritization, rater
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Prioritization Rater'
_PLUGIN_GOAL: str = 'Ranks deals based on customer intent, sales velocity, and other factors to optimize sales team performance'
_PLUGIN_CATEGORY: str = 'sales | marketing | support | analysis | automation | ops'
_PLUGIN_TAGS = ['deal', 'prioritization', 'rater']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_prioritization_rater'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
