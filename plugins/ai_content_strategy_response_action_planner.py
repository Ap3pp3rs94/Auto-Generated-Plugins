...
Plugin: AI Content Strategy Response Action Planner
Slug: ai_content_strategy_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Response Action Planner'
_PLUGIN_SLUG: str = 'ai_content_strategy_response_action_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Response Action Planner'
