...
Plugin: AI Clinical Admin Prompt Contract Designer Set 2
Slug: ai_clinical_admin_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI clinical administration and healthcare operations with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI clinical administration and healthcare operations prompt contracts and structured instruction design'
