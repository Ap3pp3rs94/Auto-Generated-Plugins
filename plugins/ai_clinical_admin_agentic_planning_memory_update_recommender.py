...
Plugin: AI Clinical Admin Agentic Planning Memory Update Recommender 000558
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
