...
Plugin: AI Research Agent Output Completeness Grader Set 2
Slug: ai_research_agent_output_completeness_grader_set_2
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Output Completeness Grader Set 2'
_PLUGIN_SLUG: str = 'ai_research_agent_output_completeness_grader_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Output Completeness Grader Set 2'
