...
Capability: AI Evidence Gap Detector 005115
Slug: ai_evidence_gap_detector_005115
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 005115'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI customer support and service workflows for personalization.'
        domain = 'AI customer support and service workflows for personalization evidence gaps and retrieval readiness'
