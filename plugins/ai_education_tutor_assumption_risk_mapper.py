...
Capability: AI Education Tutor Assumption Risk Mapper 000253
...
_PLUGIN_NAME: str = 'AI Education Tutor Assumption Risk Mapper 000253'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Assumption Risk Mapper 000253'
