...
Capability: AI Coding Agent Retrieval Query Planner 000092
Slug: ai_coding_agent_retrieval_query_planner
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Retrieval Query Planner 000092'
_PLUGIN_SLUG: str = 'ai_coding_agent_retrieval_query_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Retrieval Query Planner 000092'
