...
Plugin: AI Data Analysis Agentic Planning Anomaly Watch Builder 000688
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
