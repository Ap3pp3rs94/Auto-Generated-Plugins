...
Plugin: AI Finance Ops Source Quality Ranker
Slug: ai_finance_ops_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_finance_ops_source_quality_ranker'
...
_PLUGIN_TAGS = ['finance', 'risk', 'sources', 'trust', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Source Quality Ranker'
