...
Plugin: AI Grounded Answer Planner
...
_PLUGIN_NAME: str = 'AI Grounded Answer Planner'
...
_PLUGIN_TAGS = ['ai', 'grounding', 'retrieval', 'answers', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Grounded Answer Planner'
