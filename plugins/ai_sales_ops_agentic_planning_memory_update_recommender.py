...
Plugin: AI Sales Ops Agentic Planning Memory Update Recommender 000534
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
