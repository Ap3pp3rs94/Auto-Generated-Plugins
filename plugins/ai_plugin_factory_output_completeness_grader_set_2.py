...
Plugin: AI Capability Factory Output Completeness Grader Set 2
Slug: ai_plugin_factory_output_completeness_grader_set_2
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Output Completeness Grader Set 2'
_PLUGIN_SLUG: str = 'ai_plugin_factory_output_completeness_grader_set_2'
...
_PLUGIN_TAGS = ['capabilities', 'factory', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Output Completeness Grader Set 2'
