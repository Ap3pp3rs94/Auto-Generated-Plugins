...
Capability: AI Agent Task Planner 000002
Slug: ai_agent_task_planner_000002
"""
...
_PLUGIN_SLUG: str = 'ai_agent_task_planner_000002'
...
_PLUGIN_MANIFEST = {'name': 'AI Agent Task Planner 000002', 'slug': 'ai_agent_task_planner_000002', 'goal': 'Turn a user objective into a sequenced AI-agent work plan with checkpoints and handoffs.', 'category': 'ai_agents', 'tags': ['ai', 'agents', 'planning', 'workflow', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI agent planning and task decomposition', 'owner_id': None, 'use_cases': ['Break a complex AI task into ordered implementation, review, and verification steps.', 'Separate blocking work from parallelizable side tasks.', 'Recommend checkpoints that prevent agent drift or repeated work.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
