...
Plugin: AI Finance Ops Prompt Clarity Auditor Set 3
Slug: ai_finance_ops_prompt_clarity_auditor_set_3
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Prompt Clarity Auditor Set 3'
        goal = 'Audit prompts for AI finance operations and risk review and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI finance operations and risk review prompt clarity and ambiguity reduction'
