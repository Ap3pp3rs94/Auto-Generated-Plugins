...
Plugin: AI Education Tutor Evidence Gap Detector Set 2
Slug: ai_education_tutor_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI education, tutoring, and learning workflows.'
        domain = 'AI education, tutoring, and learning workflows evidence gaps and retrieval readiness'
