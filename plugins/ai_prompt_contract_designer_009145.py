...
Capability: AI Prompt Contract Designer 009145
Slug: ai_prompt_contract_designer_009145
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Contract Designer 009145'
        goal = 'Design prompt contracts for AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback prompt contracts and structured instruction design'
