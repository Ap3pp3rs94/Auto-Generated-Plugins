...
Capability: AI Retrieval Query Planner 009356
Slug: ai_retrieval_query_planner_009356
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 009356'
        goal = 'Plan focused retrieval queries for AI personal finance planning, budgeting, debt, and financial decision workflows for evaluation feedback when evidence is missing or stale.'
        domain = 'AI personal finance planning, budgeting, debt, and financial decision workflows for evaluation feedback retrieval query planning and grounding'
