...
Capability: AI Prompt Clarity Auditor 000386
Slug: ai_prompt_clarity_auditor_000386
"""
...
_PLUGIN_NAME: str = 'AI Prompt Clarity Auditor 000386'
_PLUGIN_SLUG: str = 'ai_prompt_clarity_auditor_000386'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Clarity Auditor 000386'
