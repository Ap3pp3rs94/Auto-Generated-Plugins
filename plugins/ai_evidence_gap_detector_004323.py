...
Capability: AI Evidence Gap Detector 004323
Slug: ai_evidence_gap_detector_004323
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 004323'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI research, retrieval, and synthesis work for documentation and knowledge capture.'
        domain = 'AI research, retrieval, and synthesis work for documentation and knowledge capture evidence gaps and retrieval readiness'
