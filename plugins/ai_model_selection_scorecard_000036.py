...
Capability: AI Model Selection Scorecard 000036
Slug: ai_model_selection_scorecard_000036
"""
...
_PLUGIN_NAME: str = 'AI Model Selection Scorecard 000036'
_PLUGIN_SLUG: str = 'ai_model_selection_scorecard_000036'
...
_PLUGIN_MANIFEST = {'name': 'AI Model Selection Scorecard 000036', 'slug': 'ai_model_selection_scorecard_000036', 'goal': 'Score which model style or capability tier fits a task based on cost, risk, and complexity.', 'category': 'ai_agents', 'tags': ['ai', 'models', 'routing', 'scorecard', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI model selection and task-fit scoring', 'owner_id': None, 'use_cases': ['Choose between fast, cheap, reasoning-heavy, or tool-using workflows.', 'Flag tasks that need stronger verification.', 'Recommend the lowest sufficient capability tier.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Selection Scorecard 000036'
