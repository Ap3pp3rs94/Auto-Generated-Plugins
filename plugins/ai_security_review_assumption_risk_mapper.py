...
Capability: AI Security Review Assumption Risk Mapper 000325
...
_PLUGIN_NAME: str = 'AI Security Review Assumption Risk Mapper 000325'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Assumption Risk Mapper 000325'
