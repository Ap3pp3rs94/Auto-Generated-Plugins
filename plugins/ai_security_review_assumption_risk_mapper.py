...
Plugin: AI Security Review Assumption Risk Mapper
Slug: ai_security_review_assumption_risk_mapper
"""
...
_PLUGIN_NAME: str = 'AI Security Review Assumption Risk Mapper'
_PLUGIN_SLUG: str = 'ai_security_review_assumption_risk_mapper'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Assumption Risk Mapper'
