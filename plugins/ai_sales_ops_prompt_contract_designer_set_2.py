...
Plugin: AI Sales Ops Prompt Contract Designer Set 2
Slug: ai_sales_ops_prompt_contract_designer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Prompt Contract Designer Set 2'
_PLUGIN_SLUG: str = 'ai_sales_ops_prompt_contract_designer_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Contract Designer Set 2'
