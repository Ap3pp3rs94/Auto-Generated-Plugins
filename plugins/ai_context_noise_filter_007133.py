...
Capability: AI Context Noise Filter 007133
Slug: ai_context_noise_filter_007133
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 007133'
        goal = 'Filter noisy or redundant context before model calls for AI finance operations and risk review for knowledge graph work.'
        domain = 'AI finance operations and risk review for knowledge graph work context filtering and token-budget control'
