...
Capability: AI Product Manager Agentic Planning Source Quality Ranker 000724
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
