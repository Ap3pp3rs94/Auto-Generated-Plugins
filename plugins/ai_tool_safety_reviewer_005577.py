...
Capability: AI Tool Safety Reviewer 005577
Slug: ai_tool_safety_reviewer_005577
"""
...
_PLUGIN_NAME: str = 'AI Tool Safety Reviewer 005577'
_PLUGIN_SLUG: str = 'ai_tool_safety_reviewer_005577'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Review proposed tool use for AI legal review and compliance workflows for multimodal inputs for side effects, permissions, and rollback needs.'
_PLUGIN_TAGS = ['legal', 'compliance', 'multimodal', 'tools', 'safety', 'permissions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI legal review and compliance workflows for multimodal inputs AI tool safety and approval control'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Legal Review Multimodal Inputs.', 'Score tool calls by mutation, exposure, and reversibility risk.', 'Flag actions that need approval or extra verification.', 'Recommend safer tool-use boundaries.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Tool Safety Reviewer 005577', 'slug': 'ai_tool_safety_reviewer_005577', 'goal': 'Review proposed tool use for AI legal review and compliance workflows for multimodal inputs for side effects, permissions, and rollback needs.', 'category': 'ai_safety', 'tags': ['legal', 'compliance', 'multimodal', 'tools', 'safety', 'permissions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI legal review and compliance workflows for multimodal inputs AI tool safety and approval control', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Legal Review Multimodal Inputs.', 'Score tool calls by mutation, exposure, and reversibility risk.', 'Flag actions that need approval or extra verification.', 'Recommend safer tool-use boundaries.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 005577'
        goal = 'Review proposed tool use for AI legal review and compliance workflows for multimodal inputs for side effects, permissions, and rollback needs.'
        domain = 'AI legal review and compliance workflows for multimodal inputs AI tool safety and approval control'
