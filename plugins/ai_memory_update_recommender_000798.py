...
Capability: AI Memory Update Recommender 000798
Slug: ai_memory_update_recommender_000798
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Update Recommender 000798'
        goal = 'Recommend durable memory updates from AI operations monitoring and incident response for agentic planning sessions without saving transient chatter.'
        domain = 'AI operations monitoring and incident response for agentic planning durable memory and preference extraction'
