...
Capability: AI Sales Ops Agentic Planning Verification Checklist Builder 000542
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
