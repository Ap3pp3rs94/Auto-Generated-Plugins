...
Capability: AI Security Review Tool Safety Reviewer 000321
...
_PLUGIN_NAME: str = 'AI Security Review Tool Safety Reviewer 000321'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Tool Safety Reviewer 000321'
