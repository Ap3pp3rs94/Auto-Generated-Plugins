...
Plugin: AI Response Merge Planner
...
_PLUGIN_NAME: str = 'AI Response Merge Planner'
_PLUGIN_SLUG: str = 'ai_response_merge_planner'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Plan how to merge the strongest parts of multiple AI responses without losing requirements.'
_PLUGIN_TAGS = ['ai', 'comparison', 'merge', 'rubric', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Merge Planner'
