...
# File       : sales_performance_visualizer.py
# Description: Generate interactive visualizations to gain insights into sales performance and identify areas for improvement
# Goal       : Generate interactive visualizations to gain insights into sales performance and identify areas for improvement
# Category   : analysis | sales
# Tags       : insight, visualization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Performance Visualization'
_PLUGIN_GOAL: str = 'Generate interactive visualizations to gain insights into sales performance and identify areas for improvement'
_PLUGIN_CATEGORY: str = 'analysis | sales'
_PLUGIN_TAGS = ['insight', 'visualization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_visualizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
