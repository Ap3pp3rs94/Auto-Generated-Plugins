...
Plugin: AI Operations Monitor Rollback Guard Builder
Slug: ai_operations_monitor_rollback_guard_builder
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Rollback Guard Builder'
_PLUGIN_SLUG: str = 'ai_operations_monitor_rollback_guard_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Rollback Guard Builder'
