...
Plugin: AI Education Tutor Response Action Planner Set 3
Slug: ai_education_tutor_response_action_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Response Action Planner Set 3'
_PLUGIN_SLUG: str = 'ai_education_tutor_response_action_planner_set_3'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI education, tutoring, and learning workflows AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['education', 'learning', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI education, tutoring, and learning workflows response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Response Action Planner Set 3'
        goal = 'Convert AI education, tutoring, and learning workflows AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI education, tutoring, and learning workflows response actionability and next-step planning'
