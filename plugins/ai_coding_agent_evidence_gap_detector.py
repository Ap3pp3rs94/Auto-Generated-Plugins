...
Capability: AI Coding Agent Evidence Gap Detector 000075
...
_PLUGIN_NAME: str = 'AI Coding Agent Evidence Gap Detector 000075'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Evidence Gap Detector 000075'
