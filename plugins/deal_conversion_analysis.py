...
# Title      : Deal Conversion Insights
# File       : deal_conversion_analysis.py
# Description: Provides actionable insights to identify opportunities for converting leads into deals
# Goal       : Provides actionable insights to identify opportunities for converting leads into deals
# Category   : sales
# Tags       : conversion, lead, opportunity
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Conversion Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights to identify opportunities for converting leads into deals'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['conversion', 'lead', 'opportunity']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_conversion_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
