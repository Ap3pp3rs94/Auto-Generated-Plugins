...
Plugin: AI Finance Ops Tool Safety Reviewer
Slug: ai_finance_ops_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_finance_ops_tool_safety_reviewer'
...
_PLUGIN_TAGS = ['finance', 'risk', 'tools', 'safety', 'permissions', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Tool Safety Reviewer'
