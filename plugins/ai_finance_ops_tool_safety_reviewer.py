...
Capability: AI Finance Ops Tool Safety Reviewer 000225
...
_PLUGIN_NAME: str = 'AI Finance Ops Tool Safety Reviewer 000225'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Tool Safety Reviewer 000225'
