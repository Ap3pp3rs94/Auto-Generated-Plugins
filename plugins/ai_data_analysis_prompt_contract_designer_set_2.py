...
Plugin: AI Data Analysis Prompt Contract Designer Set 2
Slug: ai_data_analysis_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI data analysis and analytics workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI data analysis and analytics workflows prompt contracts and structured instruction design'
