...
Capability: AI Citation Need Detector 000019
Slug: ai_citation_need_detector_000019
"""
...
_PLUGIN_NAME: str = 'AI Citation Need Detector 000019'
_PLUGIN_SLUG: str = 'ai_citation_need_detector_000019'
...
_PLUGIN_USE_CASES = ['Mark claims that require citations before a response is shipped.', 'Separate common reasoning from source-sensitive factual claims.', 'Recommend uncertainty language for claims without evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Citation Need Detector 000019', 'slug': 'ai_citation_need_detector_000019', 'goal': 'Detect which AI-generated claims need citations, verification, or uncertainty language.', 'category': 'ai_evaluation', 'tags': ['ai', 'citations', 'verification', 'grounding', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI citation planning and factual support', 'owner_id': None, 'use_cases': ['Mark claims that require citations before a response is shipped.', 'Separate common reasoning from source-sensitive factual claims.', 'Recommend uncertainty language for claims without evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Need Detector 000019'
