...
Capability: AI Verification Checklist Builder 000350
Slug: ai_verification_checklist_builder_000350
"""
...
_PLUGIN_NAME: str = 'AI Verification Checklist Builder 000350'
_PLUGIN_SLUG: str = 'ai_verification_checklist_builder_000350'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 000350'
