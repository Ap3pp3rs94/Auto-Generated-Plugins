...
Plugin: AI Capability Factory Context Noise Filter Set 2
Slug: ai_plugin_factory_context_noise_filter_set_2
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Context Noise Filter Set 2'
_PLUGIN_SLUG: str = 'ai_plugin_factory_context_noise_filter_set_2'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI capability factory and generated module operations.'
_PLUGIN_TAGS = ['capabilities', 'factory', 'context', 'tokens', 'noise', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI capability factory and generated module operations context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Context Noise Filter Set 2'
        goal = 'Filter noisy or redundant context before model calls for AI capability factory and generated module operations.'
        domain = 'AI capability factory and generated module operations context filtering and token-budget control'
