...
Plugin: AI Finance Ops Prompt Contract Designer Set 2
Slug: ai_finance_ops_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI finance operations and risk review with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI finance operations and risk review prompt contracts and structured instruction design'
