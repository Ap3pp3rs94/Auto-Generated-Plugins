...
Plugin: AI Customer Support Response Action Planner Set 3
Slug: ai_customer_support_response_action_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Response Action Planner Set 3'
_PLUGIN_SLUG: str = 'ai_customer_support_response_action_planner_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Response Action Planner Set 3'
        goal = 'Convert AI customer support and service workflows AI responses into concrete next actions with owners, checks, and risks.'
