...
_PLUGIN_MANIFEST = {'name': 'AI Capability Logic Blueprint Designer 000042', 'slug': 'ai_plugin_logic_blueprint_designer', 'goal': 'Plan deterministic capability logic before code generation so the body performs the actual capability.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'logic', 'factory', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI capability deterministic logic planning and implementation design', 'owner_id': 'francis-factory', 'use_cases': ['Translate a capability spec into deterministic analysis steps.', 'Define payload fields, scoring signals, and output constructors.', 'Prevent generic template bodies by naming capability-specific algorithms.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manifest = {'name': 'AI Capability Logic Blueprint Designer 000042', 'slug': 'ai_plugin_logic_blueprint_designer', 'goal': 'Plan deterministic capability logic before code generation so the body performs the actual capability.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'logic', 'factory', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI capability deterministic logic planning and implementation design', 'owner_id': 'francis-factory', 'use_cases': ['Translate a capability spec into deterministic analysis steps.', 'Define payload fields, scoring signals, and output constructors.', 'Prevent generic template bodies by naming capability-specific algorithms.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'plugin_logic_blueprint_designer_profile', 'generation_note': 'capability profile registry override'}
