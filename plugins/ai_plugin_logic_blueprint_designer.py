...
Plugin: AI Plugin Logic Blueprint Designer
...
_PLUGIN_NAME: str = 'AI Plugin Logic Blueprint Designer'
_PLUGIN_SLUG: str = 'ai_plugin_logic_blueprint_designer'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Plan deterministic plugin core logic before code generation so the body performs the actual capability.'
_PLUGIN_TAGS = ['ai', 'plugins', 'logic', 'factory', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Plugin Logic Blueprint Designer'
        ...
        use_cases = ['Translate a PluginSpec into deterministic analysis steps.', 'Define payload fields, scoring signals, and output constructors.', 'Prevent generic template bodies by naming capability-specific algorithms.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
