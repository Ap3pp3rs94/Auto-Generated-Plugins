...
Capability: AI Coding Agent Prompt Clarity Auditor 000074
...
_PLUGIN_NAME: str = 'AI Coding Agent Prompt Clarity Auditor 000074'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Prompt Clarity Auditor 000074'
