...
Plugin: AI Clinical Admin Evidence Gap Detector Set 2
Slug: ai_clinical_admin_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI clinical administration and healthcare operations.'
        domain = 'AI clinical administration and healthcare operations evidence gaps and retrieval readiness'
