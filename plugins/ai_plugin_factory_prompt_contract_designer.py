...
Plugin: AI Capability Factory Prompt Contract Designer
Slug: ai_plugin_factory_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_plugin_factory_prompt_contract_designer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Prompt Contract Designer'
