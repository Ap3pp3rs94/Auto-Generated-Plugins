...
Capability: AI Capability Factory Prompt Contract Designer 000433
...
_PLUGIN_NAME: str = 'AI Capability Factory Prompt Contract Designer 000433'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Prompt Contract Designer 000433'
