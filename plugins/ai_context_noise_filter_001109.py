...
Capability: AI Context Noise Filter 001109
Slug: ai_context_noise_filter_001109
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 001109'
        goal = 'Filter noisy or redundant context before model calls for AI product planning and roadmap workflows for AI tool use.'
        domain = 'AI product planning and roadmap workflows for AI tool use context filtering and token-budget control'
