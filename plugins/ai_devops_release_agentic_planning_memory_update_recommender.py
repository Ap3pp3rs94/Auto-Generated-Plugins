...
Plugin: AI DevOps Release Agentic Planning Memory Update Recommender 000654
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
