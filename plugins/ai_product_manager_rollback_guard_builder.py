...
Plugin: AI Product Manager Rollback Guard Builder
Slug: ai_product_manager_rollback_guard_builder
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Rollback Guard Builder'
_PLUGIN_SLUG: str = 'ai_product_manager_rollback_guard_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Rollback Guard Builder'
