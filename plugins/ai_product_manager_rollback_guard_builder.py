...
Capability: AI Product Manager Rollback Guard Builder 000351
...
_PLUGIN_NAME: str = 'AI Product Manager Rollback Guard Builder 000351'
...
_PLUGIN_TAGS = ['product', 'planning', 'rollback', 'safety', 'release', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Rollback Guard Builder 000351'
