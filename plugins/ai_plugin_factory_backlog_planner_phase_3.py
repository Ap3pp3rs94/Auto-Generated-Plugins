...
Plugin: AI Plugin Factory Backlog Planner Phase 3
Slug: ai_plugin_factory_backlog_planner_phase_3
"""
...
_PLUGIN_NAME: str = 'AI Plugin Factory Backlog Planner Phase 3'
_PLUGIN_SLUG: str = 'ai_plugin_factory_backlog_planner_phase_3'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Extend AI Plugin Factory Backlog Planner with phase 3 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
_PLUGIN_TAGS = ['ai', 'plugins', 'backlog', 'factory', 'autonomous_factory', 'ai_progress', 'phase_3']
...
_PLUGIN_USE_CASES = ['Prioritize future plugins by factory leverage, uniqueness, and user value.', 'Define dependency order between spec, generation, validation, repair, and release plugins.', 'Generate next-plugin candidates that avoid random or duplicate roadmap expansion.', 'Show a compact progress state for this AI capability during operator visibility and progress reporting.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Plugin Factory Backlog Planner Phase 3', 'slug': 'ai_plugin_factory_backlog_planner_phase_3', 'goal': 'Extend AI Plugin Factory Backlog Planner with phase 3 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'plugins', 'backlog', 'factory', 'autonomous_factory', 'ai_progress', 'phase_3'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI plugin factory roadmap planning and self-improvement backlog', 'owner_id': 'francis-factory', 'use_cases': ['Prioritize future plugins by factory leverage, uniqueness, and user value.', 'Define dependency order between spec, generation, validation, repair, and release plugins.', 'Generate next-plugin candidates that avoid random or duplicate roadmap expansion.', 'Show a compact progress state for this AI capability during operator visibility and progress reporting.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Plugin Factory Backlog Planner Phase 3'
        goal = 'Extend AI Plugin Factory Backlog Planner with phase 3 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
