...
Capability: AI Finance Ops Agentic Planning Trace Failure Router 000619
Slug: ai_finance_ops_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Agentic Planning Trace Failure Router 000619'
_PLUGIN_SLUG: str = 'ai_finance_ops_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Agentic Planning Trace Failure Router 000619'
