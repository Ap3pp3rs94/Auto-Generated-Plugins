...
Plugin: AI Education Tutor Prompt Clarity Auditor
Slug: ai_education_tutor_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_education_tutor_prompt_clarity_auditor'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Prompt Clarity Auditor'
