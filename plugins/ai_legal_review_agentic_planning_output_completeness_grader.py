...
Plugin: AI Legal Review Agentic Planning Output Completeness Grader 000587
...
_PLUGIN_TAGS = ['legal', 'compliance', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
