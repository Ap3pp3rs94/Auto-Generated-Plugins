...
Capability: AI Retrieval Query Planner 002156
Slug: ai_retrieval_query_planner_002156
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002156'
        goal = 'Plan focused retrieval queries for AI finance operations and risk review for evaluation feedback when evidence is missing or stale.'
        domain = 'AI finance operations and risk review for evaluation feedback retrieval query planning and grounding'
