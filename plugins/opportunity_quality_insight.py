...
# Title      : Opportunity Quality Insights
# File       : opportunity_quality_insight.py
# Description: Provides actionable insights on sales opportunities' quality to inform prioritization and resource allocation decisions
# Goal       : Provides actionable insights on sales opportunities' quality to inform prioritization and resource allocation decisions
# Category   : sales
...
_PLUGIN_NAME: str = 'Opportunity Quality Insights'
_PLUGIN_GOAL: str = "Provides actionable insights on sales opportunities' quality to inform prioritization and resource allocation decisions"
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['sales', 'opportunities']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'opportunity_quality_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
