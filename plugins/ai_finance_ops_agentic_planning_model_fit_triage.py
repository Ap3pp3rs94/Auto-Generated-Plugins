...
Capability: AI Finance Ops Agentic Planning Model Fit Triage 000622
Slug: ai_finance_ops_agentic_planning_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Agentic Planning Model Fit Triage 000622'
_PLUGIN_SLUG: str = 'ai_finance_ops_agentic_planning_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Agentic Planning Model Fit Triage 000622'
