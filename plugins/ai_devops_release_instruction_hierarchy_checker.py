...
Capability: AI DevOps Release Instruction Hierarchy Checker 000287
...
_PLUGIN_NAME: str = 'AI DevOps Release Instruction Hierarchy Checker 000287'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Instruction Hierarchy Checker 000287'
