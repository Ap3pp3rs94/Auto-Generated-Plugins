...
Plugin: AI Clinical Admin Response Action Planner
Slug: ai_clinical_admin_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Response Action Planner'
_PLUGIN_SLUG: str = 'ai_clinical_admin_response_action_planner'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Response Action Planner'
        goal = 'Convert AI clinical administration and healthcare operations AI responses into concrete next actions with owners, checks, and risks.'
