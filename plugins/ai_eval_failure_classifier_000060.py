...
Capability: AI Eval Failure Classifier 000060
Slug: ai_eval_failure_classifier_000060
"""
...
_PLUGIN_NAME: str = 'AI Eval Failure Classifier 000060'
_PLUGIN_SLUG: str = 'ai_eval_failure_classifier_000060'
...
_PLUGIN_MANIFEST = {'name': 'AI Eval Failure Classifier 000060', 'slug': 'ai_eval_failure_classifier_000060', 'goal': 'Classify evaluation failures into blocking defects, missing evidence, polish gaps, or rubric mismatch.', 'category': 'ai_evaluation', 'tags': ['ai', 'evaluation', 'failures', 'rubric', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI evaluation failure triage and repair routing', 'owner_id': None, 'use_cases': ['Group failed checks by severity and repair path.', 'Separate hard acceptance failures from subjective quality issues.', 'Recommend whether to repair, regenerate, or accept with caveats.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Eval Failure Classifier 000060'
