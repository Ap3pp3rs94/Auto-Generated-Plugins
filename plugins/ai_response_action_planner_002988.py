...
Capability: AI Response Action Planner 002988
Slug: ai_response_action_planner_002988
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 002988'
_PLUGIN_SLUG: str = 'ai_response_action_planner_002988'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 002988'
        goal = 'Convert AI data analysis and analytics workflows for workflow orchestration AI responses into concrete next actions with owners, checks, and risks.'
