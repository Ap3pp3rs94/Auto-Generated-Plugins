...
Capability: AI Data Analysis Agentic Planning Tool Argument Checker 000682
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
