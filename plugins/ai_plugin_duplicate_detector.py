...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manifest = {'name': 'AI Capability Duplicate Detector 000045', 'slug': 'ai_plugin_duplicate_detector', 'goal': 'Detect when a proposed AI capability duplicates existing behavior and recommend merge, reject, or redesign.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'duplicates', 'roadmap', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI capability uniqueness, overlap analysis, and roadmap hygiene', 'owner_id': 'francis-factory', 'use_cases': ['Compare a proposed capability against existing capability names, goals, and output contracts.', 'Create uniqueness fingerprints for capability ideas.', 'Recommend whether to merge, reject, or redesign overlapping capabilities.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'capability_overlap_checker_profile', 'generation_note': 'capability profile registry override'}
