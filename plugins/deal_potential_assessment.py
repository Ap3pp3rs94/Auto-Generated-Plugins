...
# Title      : Deal Potential Assessment
# File       : deal_potential_assessment.py
# Description: Assesses deal potential by analyzing customer data and predicting conversion likelihood.
# Goal       : Assesses deal potential by analyzing customer data and predicting conversion likelihood.
# Category   : sales
# Tags       : deals, potential, conversion
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Potential Assessment'
_PLUGIN_GOAL: str = 'Assesses deal potential by analyzing customer data and predicting conversion likelihood.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['deals', 'potential', 'conversion']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_potential_assessment'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
