...
Capability: AI Data Analysis Context Noise Filter 000293
...
_PLUGIN_NAME: str = 'AI Data Analysis Context Noise Filter 000293'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Context Noise Filter 000293'
