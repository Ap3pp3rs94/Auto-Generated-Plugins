...
Capability: AI Product Manager Source Quality Ranker 000340
...
_PLUGIN_NAME: str = 'AI Product Manager Source Quality Ranker 000340'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Source Quality Ranker 000340'
