...
Plugin: AI Product Manager Source Quality Ranker
Slug: ai_product_manager_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_product_manager_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Source Quality Ranker'
