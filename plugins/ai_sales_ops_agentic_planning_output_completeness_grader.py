...
Plugin: AI Sales Ops Agentic Planning Output Completeness Grader 000539
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
