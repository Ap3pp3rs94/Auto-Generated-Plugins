...
Capability: AI Coding Agent Agentic Planning Context Noise Filter 000461
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Context Noise Filter 000461'
...
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Context Noise Filter 000461'
