...
# Title      : Deal Value Estimator
# File       : deal_value_estimator.py
# Description: Estimate the value of a deal based on historical data and business rules.
# Goal       : Estimate the value of a deal based on historical data and business rules.
# Category   : sales | analytics
# Tags       : deal, value, estimation
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Value Estimator'
_PLUGIN_GOAL: str = 'Estimate the value of a deal based on historical data and business rules.'
_PLUGIN_CATEGORY: str = 'sales | analytics'
_PLUGIN_TAGS = ['deal', 'value', 'estimation']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_value_estimator'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
