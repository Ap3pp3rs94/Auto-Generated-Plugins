...
Capability: AI Legal Review Agentic Planning Verification Checklist Builder 000590
...
_PLUGIN_TAGS = ['legal', 'compliance', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
