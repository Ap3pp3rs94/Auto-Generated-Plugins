...
Plugin: AI Product Manager Trace Failure Router
Slug: ai_product_manager_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_product_manager_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Trace Failure Router'
