...
Capability: AI Product Manager Trace Failure Router 000355
...
_PLUGIN_NAME: str = 'AI Product Manager Trace Failure Router 000355'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Trace Failure Router 000355'
