...
Plugin: AI Content Strategy Retrieval Query Planner
...
_PLUGIN_NAME: str = 'AI Content Strategy Retrieval Query Planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Retrieval Query Planner'
