...
Plugin: AI Data Analysis Memory Update Recommender
...
_PLUGIN_NAME: str = 'AI Data Analysis Memory Update Recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Memory Update Recommender'
