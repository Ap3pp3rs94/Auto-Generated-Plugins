...
Plugin: AI Clinical Admin Capability Overlap Checker Set 2
Slug: ai_clinical_admin_capability_overlap_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Capability Overlap Checker Set 2'
_PLUGIN_SLUG: str = 'ai_clinical_admin_capability_overlap_checker_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Capability Overlap Checker Set 2'
