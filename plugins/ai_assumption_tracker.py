...
_PLUGIN_MANIFEST = {'name': 'AI Assumption Tracker 000063', 'slug': 'ai_assumption_tracker', 'goal': 'Extract, score, and track assumptions that an AI workflow is relying on.', 'category': 'ai_evaluation', 'tags': ['ai', 'assumptions', 'uncertainty', 'requirements', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI assumptions, uncertainty tracking, and task readiness', 'owner_id': 'francis-factory', 'use_cases': ['List explicit and implicit assumptions in a plan or answer.', 'Score assumptions by risk and confidence.', 'Recommend which assumptions need user confirmation or evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
