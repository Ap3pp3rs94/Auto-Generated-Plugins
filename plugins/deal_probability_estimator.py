...
# Title      : Deal Probability Estimator
# File       : deal_probability_estimator.py
# Description: Estimate the likelihood of a deal closing based on historical data and sales trends
# Goal       : Estimate the likelihood of a deal closing based on historical data and sales trends
# Category   : sales
...
_PLUGIN_NAME: str = 'Deal Probability Estimator'
_PLUGIN_GOAL: str = 'Estimate the likelihood of a deal closing based on historical data and sales trends'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['probability', 'forecasting']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_probability_estimator'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
