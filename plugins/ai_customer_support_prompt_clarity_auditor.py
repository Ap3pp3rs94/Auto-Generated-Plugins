...
Plugin: AI Customer Support Prompt Clarity Auditor
Slug: ai_customer_support_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_customer_support_prompt_clarity_auditor'
...
_PLUGIN_TAGS = ['support', 'service', 'prompting', 'clarity', 'audit', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Prompt Clarity Auditor'
