...
Plugin: AI Research Agent Agentic Planning Memory Update Recommender 000486
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
