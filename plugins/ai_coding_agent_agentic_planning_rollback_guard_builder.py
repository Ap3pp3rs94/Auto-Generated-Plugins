...
Plugin: AI Coding Agent Agentic Planning Rollback Guard Builder
Slug: ai_coding_agent_agentic_planning_rollback_guard_builder
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Rollback Guard Builder'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_rollback_guard_builder'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check rollback readiness for AI coding agents and repository work for agentic planning AI changes before they are applied or published.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'rollback', 'safety', 'release', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning rollback safety and recovery planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Rollback Guard Builder'
        goal = 'Check rollback readiness for AI coding agents and repository work for agentic planning AI changes before they are applied or published.'
        domain = 'AI coding agents and repository work for agentic planning rollback safety and recovery planning'
