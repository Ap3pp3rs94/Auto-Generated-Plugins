...
Capability: AI Clinical Admin Assumption Risk Mapper 000181
...
_PLUGIN_NAME: str = 'AI Clinical Admin Assumption Risk Mapper 000181'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Assumption Risk Mapper 000181'
