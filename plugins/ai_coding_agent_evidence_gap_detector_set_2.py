...
Plugin: AI Coding Agent Evidence Gap Detector Set 2
Slug: ai_coding_agent_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI coding agents and repository work.'
        domain = 'AI coding agents and repository work evidence gaps and retrieval readiness'
