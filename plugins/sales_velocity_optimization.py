...
# Title      : Sales Velocity Optimizer
# File       : sales_velocity_optimization.py
# Description: Identifies top sales channels and recommends optimizations to increase revenue.
# Goal       : Identifies top sales channels and recommends optimizations to increase revenue.
# Category   : analysis
# Tags       : optimization, revenue
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Velocity Optimizer'
_PLUGIN_GOAL: str = 'Identifies top sales channels and recommends optimizations to increase revenue.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['optimization', 'revenue']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_velocity_optimization'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
