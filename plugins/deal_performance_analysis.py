...
# Title      : Deal Performance Analyzer
# File       : deal_performance_analysis.py
# Description: Analyzes deal performance to identify trends and opportunities for improvement.
# Goal       : Analyzes deal performance to identify trends and opportunities for improvement.
# Category   : sales | marketing | ops
# Tags       : deals, performance, analysis
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Performance Analyzer'
_PLUGIN_GOAL: str = 'Analyzes deal performance to identify trends and opportunities for improvement.'
_PLUGIN_CATEGORY: str = 'sales | marketing | ops'
_PLUGIN_TAGS = ['deals', 'performance', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
