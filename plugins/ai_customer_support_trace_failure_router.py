...
Capability: AI Customer Support Trace Failure Router 000139
...
_PLUGIN_NAME: str = 'AI Customer Support Trace Failure Router 000139'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Trace Failure Router 000139'
