...
Plugin: AI Customer Support Instruction Hierarchy Checker
Slug: ai_customer_support_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_customer_support_instruction_hierarchy_checker'
...
_PLUGIN_TAGS = ['support', 'service', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Instruction Hierarchy Checker'
