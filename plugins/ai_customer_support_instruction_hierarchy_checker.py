...
Capability: AI Customer Support Instruction Hierarchy Checker 000143
...
_PLUGIN_NAME: str = 'AI Customer Support Instruction Hierarchy Checker 000143'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Instruction Hierarchy Checker 000143'
