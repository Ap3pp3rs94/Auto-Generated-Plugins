...
# Description: Identify trends and opportunities to optimize sales performance by analyzing historical data and providing actionable insights.
# Goal       : Identify trends and opportunities to optimize sales performance by analyzing historical data and providing actionable insights.
# Category   : analysis
# Tags       : sales, performance, trends
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Identify trends and opportunities to optimize sales performance by analyzing historical data and providing actionable insights.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['sales', 'performance', 'trends']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_analyzer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
