...
Capability: AI Product Manager Citation Priority Scorer 000357
...
_PLUGIN_NAME: str = 'AI Product Manager Citation Priority Scorer 000357'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Citation Priority Scorer 000357'
