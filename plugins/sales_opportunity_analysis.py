...
# File       : sales_opportunity_analysis.py
# Description: Identify high-potential sales opportunities by analyzing customer behavior and interactions
# Goal       : Identify high-potential sales opportunities by analyzing customer behavior and interactions
# Category   : analysis | sales
# Tags       : insights, opportunities
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Identify high-potential sales opportunities by analyzing customer behavior and interactions'
_PLUGIN_CATEGORY: str = 'analysis | sales'
_PLUGIN_TAGS = ['insights', 'opportunities']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
