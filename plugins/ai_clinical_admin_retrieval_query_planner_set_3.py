...
Plugin: AI Clinical Admin Retrieval Query Planner Set 3
Slug: ai_clinical_admin_retrieval_query_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Retrieval Query Planner Set 3'
_PLUGIN_SLUG: str = 'ai_clinical_admin_retrieval_query_planner_set_3'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Retrieval Query Planner Set 3'
