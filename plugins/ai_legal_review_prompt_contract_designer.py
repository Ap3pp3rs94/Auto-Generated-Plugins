...
Capability: AI Legal Review Prompt Contract Designer 000193
...
_PLUGIN_NAME: str = 'AI Legal Review Prompt Contract Designer 000193'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Prompt Contract Designer 000193'
