...
Plugin: AI Legal Review Prompt Contract Designer
Slug: ai_legal_review_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_legal_review_prompt_contract_designer'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Prompt Contract Designer'
