...
# File       : sales_performance_optimizer.py
# Description: Identify and optimize sales performance by analyzing customer behavior and adjusting sales strategies accordingly.
# Goal       : Identify and optimize sales performance by analyzing customer behavior and adjusting sales strategies accordingly.
...
_PLUGIN_GOAL: str = 'Identify and optimize sales performance by analyzing customer behavior and adjusting sales strategies accordingly.'
_PLUGIN_CATEGORY: str = 'analysis | automation'
_PLUGIN_TAGS = ['optimization', 'performance']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_optimizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
