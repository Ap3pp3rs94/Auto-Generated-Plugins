...
Capability: AI Model Fit Triage 002806
Slug: ai_model_fit_triage_002806
"""
...
_PLUGIN_NAME: str = 'AI Model Fit Triage 002806'
_PLUGIN_SLUG: str = 'ai_model_fit_triage_002806'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Fit Triage 002806'
