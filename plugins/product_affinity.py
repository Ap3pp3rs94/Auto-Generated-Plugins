...
# File       : product_affinity.py
# Description: Identify and analyze product relationships to inform marketing and sales strategies.
# Goal       : Identify and analyze product relationships to inform marketing and sales strategies.
# Category   : analysis
# Tags       : product, affinity, insights
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Product Affinity Insights'
_PLUGIN_GOAL: str = 'Identify and analyze product relationships to inform marketing and sales strategies.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['product', 'affinity', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'product_affinity'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
