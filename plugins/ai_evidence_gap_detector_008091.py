...
Capability: AI Evidence Gap Detector 008091
Slug: ai_evidence_gap_detector_008091
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 008091'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response for detecting signals.'
        domain = 'AI operations monitoring and incident response for detecting signals evidence gaps and retrieval readiness'
