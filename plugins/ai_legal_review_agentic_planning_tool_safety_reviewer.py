...
Capability: AI Legal Review Agentic Planning Tool Safety Reviewer 000585
Slug: ai_legal_review_agentic_planning_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Agentic Planning Tool Safety Reviewer 000585'
_PLUGIN_SLUG: str = 'ai_legal_review_agentic_planning_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Agentic Planning Tool Safety Reviewer 000585'
