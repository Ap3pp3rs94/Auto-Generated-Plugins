...
Plugin: AI Clinical Admin Prompt Contract Designer
Slug: ai_clinical_admin_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_clinical_admin_prompt_contract_designer'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Prompt Contract Designer'
