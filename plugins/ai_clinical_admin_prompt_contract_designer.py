...
Capability: AI Clinical Admin Prompt Contract Designer 000169
...
_PLUGIN_NAME: str = 'AI Clinical Admin Prompt Contract Designer 000169'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Prompt Contract Designer 000169'
