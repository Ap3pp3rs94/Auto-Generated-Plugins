...
Capability: AI Clinical Admin Model Fit Triage 000190
...
_PLUGIN_NAME: str = 'AI Clinical Admin Model Fit Triage 000190'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Model Fit Triage 000190'
