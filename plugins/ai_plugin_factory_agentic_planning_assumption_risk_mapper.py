...
Plugin: AI Capability Factory Agentic Planning Assumption Risk Mapper 000829
Slug: ai_plugin_factory_agentic_planning_assumption_risk_mapper
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Agentic Planning Assumption Risk Mapper 000829'
_PLUGIN_SLUG: str = 'ai_plugin_factory_agentic_planning_assumption_risk_mapper'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Map assumptions in AI capability factory and generated module operations for agentic planning work and score which ones need evidence or user confirmation.'
_PLUGIN_TAGS = ['capabilities', 'factory', 'agentic', 'planning', 'assumptions', 'risk', 'readiness', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI capability factory and generated module operations for agentic planning assumption tracking and readiness scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Agentic Planning Assumption Risk Mapper 000829'
        goal = 'Map assumptions in AI capability factory and generated module operations for agentic planning work and score which ones need evidence or user confirmation.'
        domain = 'AI capability factory and generated module operations for agentic planning assumption tracking and readiness scoring'
