...
Capability: AI Model Failure Mode Classifier 000051
Slug: ai_model_failure_mode_classifier_000051
"""
...
_PLUGIN_NAME: str = 'AI Model Failure Mode Classifier 000051'
_PLUGIN_SLUG: str = 'ai_model_failure_mode_classifier_000051'
...
_PLUGIN_TAGS = ['ai', 'evaluation', 'failures', 'debugging', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_MANIFEST = {'name': 'AI Model Failure Mode Classifier 000051', 'slug': 'ai_model_failure_mode_classifier_000051', 'goal': 'Classify model failures into prompt, context, reasoning, tool, retrieval, or validation causes.', 'category': 'ai_evaluation', 'tags': ['ai', 'evaluation', 'failures', 'debugging', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI failure classification and model behavior debugging', 'owner_id': None, 'use_cases': ['Label failed outputs by likely failure mode.', 'Separate prompt ambiguity from missing evidence or tool mismatch.', 'Recommend the smallest repair path for each failure class.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Failure Mode Classifier 000051'
