...
Plugin: AI Prompt Test Case Generator 000010
...
_PLUGIN_NAME: str = 'AI Prompt Test Case Generator 000010'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Test Case Generator 000010'
