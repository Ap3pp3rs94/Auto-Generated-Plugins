...
Plugin: AI Clinical Admin Agent Handoff Checker
Slug: ai_clinical_admin_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_clinical_admin_agent_handoff_checker'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agents', 'handoff', 'coordination', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Agent Handoff Checker'
