...
# File       : sales_performance_analysis.py
# Description: Analyze sales performance metrics to identify trends and opportunities for improvement.
# Goal       : Analyze sales performance metrics to identify trends and opportunities for improvement.
# Category   : sales | analysis
# Tags       : sales, performance, analysis
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Performance Analysis'
_PLUGIN_GOAL: str = 'Analyze sales performance metrics to identify trends and opportunities for improvement.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['sales', 'performance', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
