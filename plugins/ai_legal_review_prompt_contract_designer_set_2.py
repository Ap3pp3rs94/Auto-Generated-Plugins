...
Plugin: AI Legal Review Prompt Contract Designer Set 2
Slug: ai_legal_review_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI legal review and compliance workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI legal review and compliance workflows prompt contracts and structured instruction design'
