...
Capability: AI Response Action Planner 002484
Slug: ai_response_action_planner_002484
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 002484'
_PLUGIN_SLUG: str = 'ai_response_action_planner_002484'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 002484'
