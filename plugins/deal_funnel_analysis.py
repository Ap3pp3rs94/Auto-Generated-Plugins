...
# Title      : Deal Funnel Analyzer
# File       : deal_funnel_analysis.py
# Description: Automatically analyzes and visualizes sales funnel performance to identify bottlenecks and optimize deal flow.
# Goal       : Automatically analyzes and visualizes sales funnel performance to identify bottlenecks and optimize deal flow.
# Category   : sales | marketing | analysis
# Tags       : funnel, analysis, optimization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Funnel Analyzer'
_PLUGIN_GOAL: str = 'Automatically analyzes and visualizes sales funnel performance to identify bottlenecks and optimize deal flow.'
_PLUGIN_CATEGORY: str = 'sales | marketing | analysis'
_PLUGIN_TAGS = ['funnel', 'analysis', 'optimization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_funnel_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
