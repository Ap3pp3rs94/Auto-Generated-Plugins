...
# File       : sales_territory_insights.py
# Description: Analyze and visualize sales territory performance to identify trends, optimize routes, and improve customer engagement.
# Goal       : Analyze and visualize sales territory performance to identify trends, optimize routes, and improve customer engagement.
# Category   : analysis | ops
# Tags       : territory, sales, optimization
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Analyze and visualize sales territory performance to identify trends, optimize routes, and improve customer engagement.'
_PLUGIN_CATEGORY: str = 'analysis | ops'
_PLUGIN_TAGS = ['territory', 'sales', 'optimization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_territory_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
