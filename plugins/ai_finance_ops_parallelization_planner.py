...
Capability: AI Finance Ops Parallelization Planner 000224
...
_PLUGIN_NAME: str = 'AI Finance Ops Parallelization Planner 000224'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Parallelization Planner 000224'
