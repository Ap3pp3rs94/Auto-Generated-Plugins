...
Capability: AI Response Action Planner 002652
Slug: ai_response_action_planner_002652
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 002652'
_PLUGIN_SLUG: str = 'ai_response_action_planner_002652'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 002652'
        goal = 'Convert AI product planning and roadmap workflows for safety controls AI responses into concrete next actions with owners, checks, and risks.'
