...
# File       : sales_cycle_insight.py
# Description: Provides actionable insights into sales cycle performance to optimize sales strategies and improve conversion rates.
# Goal       : Provides actionable insights into sales cycle performance to optimize sales strategies and improve conversion rates.
# Category   : sales
# Tags       : cycle, insights
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable insights into sales cycle performance to optimize sales strategies and improve conversion rates.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['cycle', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_cycle_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
