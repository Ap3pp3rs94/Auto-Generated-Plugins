...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Progress Tracker'
        goal = 'Track AI project progress from plans, logs, and completed steps into a clear next-action state.'
        domain = 'AI project progress and long-running agent work'
        capability_type = 'data_insight'
        logic_profile_id = 'progress_tracker_profile'
