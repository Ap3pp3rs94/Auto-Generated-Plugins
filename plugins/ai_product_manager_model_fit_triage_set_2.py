...
Plugin: AI Product Manager Model Fit Triage Set 2
Slug: ai_product_manager_model_fit_triage_set_2
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Model Fit Triage Set 2'
_PLUGIN_SLUG: str = 'ai_product_manager_model_fit_triage_set_2'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Triage which model tier or workflow style fits AI product planning and roadmap workflows tasks based on risk and complexity.'
_PLUGIN_TAGS = ['product', 'planning', 'models', 'routing', 'triage', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI product planning and roadmap workflows model selection and capability fit'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Model Fit Triage Set 2'
        goal = 'Triage which model tier or workflow style fits AI product planning and roadmap workflows tasks based on risk and complexity.'
        domain = 'AI product planning and roadmap workflows model selection and capability fit'
