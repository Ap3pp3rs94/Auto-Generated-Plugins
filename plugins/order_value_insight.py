...
# File       : order_value_insight.py
# Description: This skill analyzes customer order values to identify trends and opportunities for upselling or cross-selling.
# Goal       : This skill analyzes customer order values to identify trends and opportunities for upselling or cross-selling.
# Category   : sales | marketing | support | analysis
# Tags       : order, value, analysis
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Order Value Analysis'
_PLUGIN_GOAL: str = 'This skill analyzes customer order values to identify trends and opportunities for upselling or cross-selling.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support | analysis'
_PLUGIN_TAGS = ['order', 'value', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'order_value_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
