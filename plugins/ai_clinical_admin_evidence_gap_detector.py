...
Plugin: AI Clinical Admin Evidence Gap Detector
Slug: ai_clinical_admin_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_clinical_admin_evidence_gap_detector'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Evidence Gap Detector'
