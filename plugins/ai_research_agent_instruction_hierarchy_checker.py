...
Capability: AI Research Agent Instruction Hierarchy Checker 000119
...
_PLUGIN_NAME: str = 'AI Research Agent Instruction Hierarchy Checker 000119'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Instruction Hierarchy Checker 000119'
