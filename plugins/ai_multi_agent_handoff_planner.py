...
Plugin: AI Multi-Agent Handoff Planner
...
_PLUGIN_NAME: str = 'AI Multi-Agent Handoff Planner'
_PLUGIN_SLUG: str = 'ai_multi_agent_handoff_planner'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Design clear handoffs between specialized AI agents without duplicated ownership.'
_PLUGIN_TAGS = ['ai', 'agents', 'handoff', 'coordination', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Multi-Agent Handoff Planner'
