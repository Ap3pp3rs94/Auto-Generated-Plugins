...
Plugin: AI DevOps Release Output Completeness Grader
...
_PLUGIN_NAME: str = 'AI DevOps Release Output Completeness Grader'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Output Completeness Grader'
