...
Capability: AI Finance Ops Release Evidence Summarizer 000234
...
_PLUGIN_NAME: str = 'AI Finance Ops Release Evidence Summarizer 000234'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Release Evidence Summarizer 000234'
