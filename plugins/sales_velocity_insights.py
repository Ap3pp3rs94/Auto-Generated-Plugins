...
# File       : sales_velocity_insights.py
# Description: Provides actionable sales velocity insights to inform strategic business decisions and improve forecasting accuracy.
# Goal       : Provides actionable sales velocity insights to inform strategic business decisions and improve forecasting accuracy.
# Category   : analysis
# Tags       : sales, velocity, forecasting
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable sales velocity insights to inform strategic business decisions and improve forecasting accuracy.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['sales', 'velocity', 'forecasting']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_velocity_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
