...
Plugin: Francis AI Capability 000473 - AI Coding Agent Agentic Planning Capability Overlap Checker
Slug: ai_coding_agent_agentic_planning_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'Francis AI Capability 000473 - AI Coding Agent Agentic Planning Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_capability_overlap_checker'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check whether proposed AI coding agents and repository work for agentic planning capabilities overlap existing modules or deserve a new canonical slot.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'capabilities', 'duplicates', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning capability uniqueness and roadmap hygiene'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'Francis AI Capability 000473 - AI Coding Agent Agentic Planning Capability Overlap Checker'
        goal = 'Check whether proposed AI coding agents and repository work for agentic planning capabilities overlap existing modules or deserve a new canonical slot.'
        domain = 'AI coding agents and repository work for agentic planning capability uniqueness and roadmap hygiene'
