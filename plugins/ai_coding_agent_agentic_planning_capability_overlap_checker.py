...
Plugin: AI Coding Agent Agentic Planning Capability Overlap Checker 000473
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Capability Overlap Checker 000473'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Capability Overlap Checker 000473'
