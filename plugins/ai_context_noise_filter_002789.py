...
Capability: AI Context Noise Filter 002789
Slug: ai_context_noise_filter_002789
"""
...
_PLUGIN_NAME: str = 'AI Context Noise Filter 002789'
_PLUGIN_SLUG: str = 'ai_context_noise_filter_002789'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 002789'
