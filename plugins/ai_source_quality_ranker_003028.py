...
Capability: AI Source Quality Ranker 003028
Slug: ai_source_quality_ranker_003028
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 003028'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_003028'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 003028'
