...
Capability: AI Research Agent Agentic Planning Release Evidence Summarizer 000498
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'release', 'evidence', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
