...
Plugin: Francis AI Capability 000476 - AI Coding Agent Agentic Planning Retrieval Query Planner
...
_PLUGIN_NAME: str = 'Francis AI Capability 000476 - AI Coding Agent Agentic Planning Retrieval Query Planner'
...
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'Francis AI Capability 000476 - AI Coding Agent Agentic Planning Retrieval Query Planner'
