...
Plugin: AI Capability Factory Source Quality Ranker
Slug: ai_plugin_factory_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_plugin_factory_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Source Quality Ranker'
