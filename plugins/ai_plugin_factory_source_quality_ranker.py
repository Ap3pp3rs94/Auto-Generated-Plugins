...
Capability: AI Capability Factory Source Quality Ranker 000436
...
_PLUGIN_NAME: str = 'AI Capability Factory Source Quality Ranker 000436'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Source Quality Ranker 000436'
