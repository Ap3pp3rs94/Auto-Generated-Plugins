...
# File       : sales_opportunity_prioritizer.py
# Description: Automatically prioritize sales opportunities based on predefined criteria and business rules.
# Goal       : Automatically prioritize sales opportunities based on predefined criteria and business rules.
# Category   : sales
# Tags       : opportunity, prioritization, sales
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Automatically prioritize sales opportunities based on predefined criteria and business rules.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['opportunity', 'prioritization', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_prioritizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
