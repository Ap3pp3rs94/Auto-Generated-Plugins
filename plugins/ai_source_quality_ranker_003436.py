...
Capability: AI Source Quality Ranker 003436
Slug: ai_source_quality_ranker_003436
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 003436'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_003436'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Rank provided sources for AI content strategy and editorial workflows for release operations by trust, relevance, freshness, and answer usefulness.'
_PLUGIN_TAGS = ['content', 'strategy', 'release', 'operations', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI content strategy and editorial workflows for release operations source quality and grounded answer preparation'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Content Strategy Release Ops.', 'Score source notes before synthesis.', 'Flag stale, weak, or low-relevance evidence.', 'Recommend which sources should anchor the final output.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Source Quality Ranker 003436', 'slug': 'ai_source_quality_ranker_003436', 'goal': 'Rank provided sources for AI content strategy and editorial workflows for release operations by trust, relevance, freshness, and answer usefulness.', 'category': 'ai_retrieval', 'tags': ['content', 'strategy', 'release', 'operations', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI content strategy and editorial workflows for release operations source quality and grounded answer preparation', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Content Strategy Release Ops.', 'Score source notes before synthesis.', 'Flag stale, weak, or low-relevance evidence.', 'Recommend which sources should anchor the final output.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 003436'
        goal = 'Rank provided sources for AI content strategy and editorial workflows for release operations by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI content strategy and editorial workflows for release operations source quality and grounded answer preparation'
