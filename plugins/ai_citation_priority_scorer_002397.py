...
Capability: AI Citation Priority Scorer 002397
Slug: ai_citation_priority_scorer_002397
"""
...
_PLUGIN_NAME: str = 'AI Citation Priority Scorer 002397'
_PLUGIN_SLUG: str = 'ai_citation_priority_scorer_002397'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 002397'
