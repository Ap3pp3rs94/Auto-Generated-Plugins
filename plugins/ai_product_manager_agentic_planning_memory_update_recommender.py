...
Plugin: AI Product Manager Agentic Planning Memory Update Recommender 000726
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
