...
Capability: AI Source Quality Ranker 009148
Slug: ai_source_quality_ranker_009148
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 009148'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_009148'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Rank provided sources for AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback by trust, relevance, freshness, and answer usefulness.'
_PLUGIN_TAGS = ['project', 'delivery', 'risk', 'evaluation', 'feedback', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback source quality and grounded answer preparation'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 009148'
        goal = 'Rank provided sources for AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI project delivery, milestone tracking, risk review, and stakeholder update workflows for evaluation feedback source quality and grounded answer preparation'
