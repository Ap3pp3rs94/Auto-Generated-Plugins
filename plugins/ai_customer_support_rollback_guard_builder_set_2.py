...
Plugin: AI Customer Support Rollback Guard Builder Set 2
Slug: ai_customer_support_rollback_guard_builder_set_2
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Rollback Guard Builder Set 2'
_PLUGIN_SLUG: str = 'ai_customer_support_rollback_guard_builder_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Rollback Guard Builder Set 2'
