...
Slug: ai_structured_prompt_builder_000014
"""
...
_PLUGIN_SLUG: str = 'ai_structured_prompt_builder_000014'
...
_PLUGIN_MANIFEST = {'name': 'AI Structured Prompt Builder 000014', 'slug': 'ai_structured_prompt_builder_000014', 'goal': 'Convert informal requirements into structured prompts with roles, inputs, outputs, and checks.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'templates', 'structure', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI prompt architecture and reusable prompt templates', 'owner_id': None, 'use_cases': ['Create a reusable prompt from loose notes.', 'Add explicit output schemas and validation checks.', 'Preserve user intent while reducing ambiguity.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
