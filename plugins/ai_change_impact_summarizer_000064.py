...
Capability: AI Change Impact Summarizer 000064
Slug: ai_change_impact_summarizer_000064
"""
...
_PLUGIN_NAME: str = 'AI Change Impact Summarizer 000064'
_PLUGIN_SLUG: str = 'ai_change_impact_summarizer_000064'
...
_PLUGIN_MANIFEST = {'name': 'AI Change Impact Summarizer 000064', 'slug': 'ai_change_impact_summarizer_000064', 'goal': 'Summarize the user-facing, technical, and validation impact of AI-generated changes.', 'category': 'ai_agents', 'tags': ['ai', 'changes', 'impact', 'release', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI change impact analysis and release communication', 'owner_id': None, 'use_cases': ['Explain what changed and why it matters.', 'Separate user-facing effects from internal implementation details.', 'Call out validation evidence and residual risks.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Change Impact Summarizer 000064'
