...
Plugin: AI Requirement Gap Analyzer
...
_PLUGIN_NAME: str = 'AI Requirement Gap Analyzer'
...
_PLUGIN_TAGS = ['ai', 'requirements', 'gaps', 'readiness', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Requirement Gap Analyzer'
