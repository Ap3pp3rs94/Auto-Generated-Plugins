...
Capability: AI Sales Ops Prompt Clarity Auditor 000146
...
_PLUGIN_NAME: str = 'AI Sales Ops Prompt Clarity Auditor 000146'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Clarity Auditor 000146'
