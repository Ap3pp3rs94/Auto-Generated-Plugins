...
Capability: AI Finance Ops Evidence Gap Detector 000219
...
_PLUGIN_NAME: str = 'AI Finance Ops Evidence Gap Detector 000219'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Evidence Gap Detector 000219'
