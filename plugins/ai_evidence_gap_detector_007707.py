...
Capability: AI Evidence Gap Detector 007707
Slug: ai_evidence_gap_detector_007707
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 007707'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response for live monitoring.'
        domain = 'AI operations monitoring and incident response for live monitoring evidence gaps and retrieval readiness'
