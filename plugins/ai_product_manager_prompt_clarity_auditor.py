...
Plugin: AI Product Manager Prompt Clarity Auditor
Slug: ai_product_manager_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_product_manager_prompt_clarity_auditor'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Prompt Clarity Auditor'
