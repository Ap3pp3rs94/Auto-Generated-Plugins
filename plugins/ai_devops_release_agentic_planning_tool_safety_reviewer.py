...
Capability: AI DevOps Release Agentic Planning Tool Safety Reviewer 000657
Slug: ai_devops_release_agentic_planning_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Agentic Planning Tool Safety Reviewer 000657'
_PLUGIN_SLUG: str = 'ai_devops_release_agentic_planning_tool_safety_reviewer'
...
_PLUGIN_MANIFEST = {'name': 'AI DevOps Release Agentic Planning Tool Safety Reviewer 000657', 'slug': 'ai_devops_release_agentic_planning_tool_safety_reviewer', 'goal': 'Review proposed tool use for AI DevOps release and infrastructure workflows for agentic planning for side effects, permissions, and rollback needs.', 'category': 'ai_safety', 'tags': ['devops', 'release', 'agentic', 'planning', 'tools', 'safety', 'permissions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI DevOps release and infrastructure workflows for agentic planning AI tool safety and approval control', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: DevOps Release Agentic Planning.', 'Score tool calls by mutation, exposure, and reversibility risk.', 'Flag actions that need approval or extra verification.', 'Recommend safer tool-use boundaries.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Agentic Planning Tool Safety Reviewer 000657'
