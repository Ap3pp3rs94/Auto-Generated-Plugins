...
Plugin: AI Education Tutor Prompt Contract Designer Set 3
Slug: ai_education_tutor_prompt_contract_designer_set_3
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Prompt Contract Designer Set 3'
        goal = 'Design prompt contracts for AI education, tutoring, and learning workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI education, tutoring, and learning workflows prompt contracts and structured instruction design'
