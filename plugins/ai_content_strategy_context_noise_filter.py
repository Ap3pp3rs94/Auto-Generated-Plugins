...
Plugin: AI Content Strategy Context Noise Filter
Slug: ai_content_strategy_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Context Noise Filter'
_PLUGIN_SLUG: str = 'ai_content_strategy_context_noise_filter'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Context Noise Filter'
