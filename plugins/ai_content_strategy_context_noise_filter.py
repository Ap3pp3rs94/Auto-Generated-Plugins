...
Capability: AI Content Strategy Context Noise Filter 000365
...
_PLUGIN_NAME: str = 'AI Content Strategy Context Noise Filter 000365'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Context Noise Filter 000365'
