...
Capability: AI Content Strategy Output Completeness Grader 000371
Slug: ai_content_strategy_output_completeness_grader
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Output Completeness Grader 000371'
_PLUGIN_SLUG: str = 'ai_content_strategy_output_completeness_grader'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Output Completeness Grader 000371'
