...
Capability: AI Coding Agent Trace Failure Router 000091
...
_PLUGIN_NAME: str = 'AI Coding Agent Trace Failure Router 000091'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Trace Failure Router 000091'
