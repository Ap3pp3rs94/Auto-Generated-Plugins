...
Plugin: AI Coding Agent Trace Failure Router
Slug: ai_coding_agent_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Trace Failure Router'
_PLUGIN_SLUG: str = 'ai_coding_agent_trace_failure_router'
...
_PLUGIN_TAGS = ['coding', 'agents', 'traces', 'failures', 'debugging', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Trace Failure Router'
