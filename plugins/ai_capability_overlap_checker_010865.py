...
Capability: AI Capability Overlap Checker 010865
Slug: ai_capability_overlap_checker_010865
"""
...
_PLUGIN_NAME: str = 'AI Capability Overlap Checker 010865'
_PLUGIN_SLUG: str = 'ai_capability_overlap_checker_010865'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check whether proposed AI cyber defense, alert triage, incident handling, and threat intelligence workflows for safety controls capabilities overlap existing modules or deserve a new canonical slot.'
_PLUGIN_TAGS = ['cybersecurity', 'incidents', 'threat-intel', 'safety', 'controls', 'capabilities', 'duplicates', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI cyber defense, alert triage, incident handling, and threat intelligence workflows for safety controls capability uniqueness and roadmap hygiene'
