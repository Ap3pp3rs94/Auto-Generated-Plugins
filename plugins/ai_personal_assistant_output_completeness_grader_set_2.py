...
Plugin: AI Personal Assistant Output Completeness Grader Set 2
Slug: ai_personal_assistant_output_completeness_grader_set_2
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Output Completeness Grader Set 2'
_PLUGIN_SLUG: str = 'ai_personal_assistant_output_completeness_grader_set_2'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Output Completeness Grader Set 2'
