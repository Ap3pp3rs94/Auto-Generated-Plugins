...
Plugin: AI Evidence Gap Detector 000891
Slug: ai_evidence_gap_detector_000891
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 000891'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI customer support and service workflows for AI tool use.'
        domain = 'AI customer support and service workflows for AI tool use evidence gaps and retrieval readiness'
