...
# File       : sales_territory_optimization.py
# Description: Identifies underperforming territories and provides actionable recommendations for improvement.
# Goal       : Identifies underperforming territories and provides actionable recommendations for improvement.
# Category   : marketing | sales
# Tags       : territory, optimization, sales
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Territory Optimization'
_PLUGIN_GOAL: str = 'Identifies underperforming territories and provides actionable recommendations for improvement.'
_PLUGIN_CATEGORY: str = 'marketing | sales'
_PLUGIN_TAGS = ['territory', 'optimization', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_territory_optimization'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
