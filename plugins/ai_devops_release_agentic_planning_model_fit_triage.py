...
Capability: AI DevOps Release Agentic Planning Model Fit Triage 000670
Slug: ai_devops_release_agentic_planning_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Agentic Planning Model Fit Triage 000670'
_PLUGIN_SLUG: str = 'ai_devops_release_agentic_planning_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Agentic Planning Model Fit Triage 000670'
