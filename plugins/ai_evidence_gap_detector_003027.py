...
Capability: AI Evidence Gap Detector 003027
Slug: ai_evidence_gap_detector_003027
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Detector 003027'
_PLUGIN_SLUG: str = 'ai_evidence_gap_detector_003027'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 003027'
