...
Capability: AI Citation Priority Scorer 008853
Slug: ai_citation_priority_scorer_008853
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 008853'
        goal = 'Score which AI personal productivity and scheduling workflows for AI tool use for detecting signals claims most urgently need citations or uncertainty language.'
        domain = 'AI personal productivity and scheduling workflows for AI tool use for detecting signals citation priority and factual-risk scoring'
