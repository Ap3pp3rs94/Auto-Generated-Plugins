...
Plugin: AI Model Selection Scorecard
...
_PLUGIN_NAME: str = 'AI Model Selection Scorecard'
_PLUGIN_SLUG: str = 'ai_model_selection_scorecard'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which model style or capability tier fits a task based on cost, risk, and complexity.'
_PLUGIN_TAGS = ['ai', 'models', 'routing', 'scorecard', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Selection Scorecard'
