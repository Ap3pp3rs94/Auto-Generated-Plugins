...
Capability: AI Sales Ops Memory Update Recommender 000150
...
_PLUGIN_NAME: str = 'AI Sales Ops Memory Update Recommender 000150'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Memory Update Recommender 000150'
