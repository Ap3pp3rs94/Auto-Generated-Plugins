...
Plugin: AI Response Comparator Phase 16
Slug: ai_response_comparator_phase_16
"""
...
_PLUGIN_NAME: str = 'AI Response Comparator Phase 16'
_PLUGIN_SLUG: str = 'ai_response_comparator_phase_16'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Extend AI Response Comparator with phase 16 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
_PLUGIN_TAGS = ['ai', 'comparison', 'evaluation', 'rubric', 'autonomous_factory', 'ai_progress', 'phase_16']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Comparator Phase 16'
        goal = 'Extend AI Response Comparator with phase 16 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
        ...
        use_cases = ['Compare candidate responses for completeness and accuracy.', 'Explain why one output is stronger than another.', 'Merge the best parts of multiple responses into a recommendation.', 'Show a compact progress state for this AI capability during advanced refinement pass 16.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
