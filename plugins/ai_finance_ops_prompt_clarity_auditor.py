...
Capability: AI Finance Ops Prompt Clarity Auditor 000218
...
_PLUGIN_NAME: str = 'AI Finance Ops Prompt Clarity Auditor 000218'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Prompt Clarity Auditor 000218'
