...
# File       : sales_performance_explorer_2.py
# Description: Visualize sales performance metrics and identify trends to inform data-driven decisions
# Goal       : Visualize sales performance metrics and identify trends to inform data-driven decisions
...
_PLUGIN_GOAL: str = 'Visualize sales performance metrics and identify trends to inform data-driven decisions'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['insight', 'trend']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_explorer_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
