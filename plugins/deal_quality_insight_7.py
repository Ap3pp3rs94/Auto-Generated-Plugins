...
# File       : deal_quality_insight_7.py
# Description: Provides actionable insights to improve deal quality by analyzing factors that affect conversion rates and revenue.
# Goal       : Provides actionable insights to improve deal quality by analyzing factors that affect conversion rates and revenue.
# Category   : sales | marketing | support
# Tags       : deal, quality, conversion, revenue
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable insights to improve deal quality by analyzing factors that affect conversion rates and revenue.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support'
_PLUGIN_TAGS = ['deal', 'quality', 'conversion', 'revenue']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_quality_insight_7'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
