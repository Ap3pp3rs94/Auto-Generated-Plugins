...
# File       : sales_opportunity_enricher.py
# Description: Enhance sales opportunities by providing detailed customer insights and relevant information to improve conversion rates.
# Goal       : Enhance sales opportunities by providing detailed customer insights and relevant information to improve conversion rates.
# Category   : analysis
# Tags       : enrichment, opportunity, insight
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Enhance sales opportunities by providing detailed customer insights and relevant information to improve conversion rates.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['enrichment', 'opportunity', 'insight']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_enricher'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
