...
Plugin: AI Research Agent Prompt Contract Designer Set 2
Slug: ai_research_agent_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI research, retrieval, and synthesis work with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI research, retrieval, and synthesis work prompt contracts and structured instruction design'
