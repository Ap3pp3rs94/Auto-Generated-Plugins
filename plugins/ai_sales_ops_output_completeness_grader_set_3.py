...
Plugin: AI Sales Ops Output Completeness Grader Set 3
Slug: ai_sales_ops_output_completeness_grader_set_3
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Output Completeness Grader Set 3'
_PLUGIN_SLUG: str = 'ai_sales_ops_output_completeness_grader_set_3'
...
_PLUGIN_TAGS = ['sales', 'business', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Output Completeness Grader Set 3'
