...
Capability: AI DevOps Release Agentic Planning Verification Checklist Builder 000662
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
