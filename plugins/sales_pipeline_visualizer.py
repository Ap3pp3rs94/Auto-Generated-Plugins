...
# File       : sales_pipeline_visualizer.py
# Description: Visualize sales pipeline stages and their relationships to optimize lead management
# Goal       : Visualize sales pipeline stages and their relationships to optimize lead management
# Category   : analysis
# Tags       : data_insight, visual
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Pipeline Visualization'
_PLUGIN_GOAL: str = 'Visualize sales pipeline stages and their relationships to optimize lead management'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['data_insight', 'visual']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_pipeline_visualizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
