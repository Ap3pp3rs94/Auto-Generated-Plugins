...
Capability: AI Content Strategy Parallelization Planner 000368
Slug: ai_content_strategy_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Parallelization Planner 000368'
_PLUGIN_SLUG: str = 'ai_content_strategy_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Parallelization Planner 000368'
