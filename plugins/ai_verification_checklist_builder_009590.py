...
Capability: AI Verification Checklist Builder 009590
Slug: ai_verification_checklist_builder_009590
"""
...
_PLUGIN_NAME: str = 'AI Verification Checklist Builder 009590'
_PLUGIN_SLUG: str = 'ai_verification_checklist_builder_009590'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 009590'
