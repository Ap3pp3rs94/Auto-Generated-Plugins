...
# File       : sales_performance_insights.py
# Description: Identify sales performance trends and insights to inform data-driven decisions
# Goal       : Identify sales performance trends and insights to inform data-driven decisions
...
_PLUGIN_NAME: str = 'Sales Performance Insights'
_PLUGIN_GOAL: str = 'Identify sales performance trends and insights to inform data-driven decisions'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['insight', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
