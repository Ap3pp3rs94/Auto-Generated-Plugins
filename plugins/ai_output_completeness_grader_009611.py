...
Capability: AI Output Completeness Grader 009611
Slug: ai_output_completeness_grader_009611
"""
...
_PLUGIN_NAME: str = 'AI Output Completeness Grader 009611'
_PLUGIN_SLUG: str = 'ai_output_completeness_grader_009611'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 009611'
