...
# Title      : Deal Profitability Explorer
# File       : deal_profitability_explorer.py
# Description: Analyzes deal profitability to identify areas for improvement and optimize sales strategies
# Goal       : Analyzes deal profitability to identify areas for improvement and optimize sales strategies
# Category   : analysis
# Tags       : profit, deal, sales
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Profitability Explorer'
_PLUGIN_GOAL: str = 'Analyzes deal profitability to identify areas for improvement and optimize sales strategies'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['profit', 'deal', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_profitability_explorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
