...
Capability: AI Response Action Planner 000468
Slug: ai_response_action_planner_000468
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000468'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000468'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000468'
        goal = 'Convert AI coding agents and repository work for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
