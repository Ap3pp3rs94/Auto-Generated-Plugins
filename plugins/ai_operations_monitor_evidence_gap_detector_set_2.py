...
Plugin: AI Operations Monitor Evidence Gap Detector Set 2
Slug: ai_operations_monitor_evidence_gap_detector_set_2
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Evidence Gap Detector Set 2'
_PLUGIN_SLUG: str = 'ai_operations_monitor_evidence_gap_detector_set_2'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response.'
_PLUGIN_TAGS = ['operations', 'monitoring', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI operations monitoring and incident response evidence gaps and retrieval readiness'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response.'
        domain = 'AI operations monitoring and incident response evidence gaps and retrieval readiness'
