...
Capability: AI Security Review Evidence Gap Detector 000315
...
_PLUGIN_NAME: str = 'AI Security Review Evidence Gap Detector 000315'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Evidence Gap Detector 000315'
