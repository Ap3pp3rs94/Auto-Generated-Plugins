...
Plugin: AI DevOps Release Agentic Planning Anomaly Watch Builder 000664
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
