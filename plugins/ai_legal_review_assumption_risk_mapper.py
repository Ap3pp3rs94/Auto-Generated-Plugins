...
Capability: AI Legal Review Assumption Risk Mapper 000205
...
_PLUGIN_NAME: str = 'AI Legal Review Assumption Risk Mapper 000205'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Assumption Risk Mapper 000205'
