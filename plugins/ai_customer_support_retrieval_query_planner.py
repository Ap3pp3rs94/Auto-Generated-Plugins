...
Capability: AI Customer Support Retrieval Query Planner 000140
...
_PLUGIN_NAME: str = 'AI Customer Support Retrieval Query Planner 000140'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Retrieval Query Planner 000140'
