...
Plugin: AI Data Analysis Retrieval Query Planner Set 2
Slug: ai_data_analysis_retrieval_query_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Retrieval Query Planner Set 2'
_PLUGIN_SLUG: str = 'ai_data_analysis_retrieval_query_planner_set_2'
...
_PLUGIN_TAGS = ['data', 'analytics', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Retrieval Query Planner Set 2'
