...
Capability: AI Response Action Planner 000780
Slug: ai_response_action_planner_000780
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000780'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000780'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'agentic', 'planning', 'evaluation', 'actions', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000780'
