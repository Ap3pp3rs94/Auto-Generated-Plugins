...
Capability: AI Finance Ops Memory Update Recommender 000222
...
_PLUGIN_NAME: str = 'AI Finance Ops Memory Update Recommender 000222'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Memory Update Recommender 000222'
