...
Plugin: AI Data Contract Mapper
...
_PLUGIN_NAME: str = 'AI Data Contract Mapper'
_PLUGIN_SLUG: str = 'ai_data_contract_mapper'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Map expected AI plugin input and output contracts from task descriptions and examples.'
_PLUGIN_TAGS = ['ai', 'schema', 'contracts', 'plugins', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Contract Mapper'
