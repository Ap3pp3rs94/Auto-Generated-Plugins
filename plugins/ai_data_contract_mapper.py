...
_PLUGIN_MANIFEST = {'name': 'AI Data Contract Mapper 000039', 'slug': 'ai_data_contract_mapper', 'goal': 'Map expected AI capability input and output contracts from task descriptions and examples.', 'category': 'ai_evaluation', 'tags': ['ai', 'schema', 'contracts', 'capabilities', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI data contracts and schema planning', 'owner_id': 'francis-factory', 'use_cases': ['Extract expected payload fields and result fields.', 'Flag schema ambiguity before implementation.', 'Recommend validation checks for capability contracts.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
