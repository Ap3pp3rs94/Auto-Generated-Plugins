...
# Title      : Opportunity Quality Analyzer
# File       : opportunity_quality_insights.py
# Description: Analyze and prioritize sales opportunities based on key performance indicators and customer data to improve conversion rates.
# Goal       : Analyze and prioritize sales opportunities based on key performance indicators and customer data to improve conversion rates.
# Category   : sales
# Tags       : lead, prospect, conversion
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Opportunity Quality Analyzer'
_PLUGIN_GOAL: str = 'Analyze and prioritize sales opportunities based on key performance indicators and customer data to improve conversion rates.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['lead', 'prospect', 'conversion']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'opportunity_quality_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
