...
Capability: AI Memory Update Recommender 007710
Slug: ai_memory_update_recommender_007710
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Update Recommender 007710'
        goal = 'Recommend durable memory updates from AI operations monitoring and incident response for live monitoring sessions without saving transient chatter.'
        domain = 'AI operations monitoring and incident response for live monitoring durable memory and preference extraction'
