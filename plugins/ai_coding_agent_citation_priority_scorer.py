...
Capability: AI Coding Agent Citation Priority Scorer 000093
...
_PLUGIN_NAME: str = 'AI Coding Agent Citation Priority Scorer 000093'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Citation Priority Scorer 000093'
