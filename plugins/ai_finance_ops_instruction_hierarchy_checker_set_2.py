...
Plugin: AI Finance Ops Instruction Hierarchy Checker Set 2
Slug: ai_finance_ops_instruction_hierarchy_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Instruction Hierarchy Checker Set 2'
_PLUGIN_SLUG: str = 'ai_finance_ops_instruction_hierarchy_checker_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Instruction Hierarchy Checker Set 2'
