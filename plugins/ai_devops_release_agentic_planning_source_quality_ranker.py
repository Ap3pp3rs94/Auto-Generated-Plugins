...
Capability: AI DevOps Release Agentic Planning Source Quality Ranker 000652
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
