...
Capability: AI Citation Priority Scorer 005421
Slug: ai_citation_priority_scorer_005421
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 005421'
        goal = 'Score which AI operations monitoring and incident response for personalization claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for personalization citation priority and factual-risk scoring'
