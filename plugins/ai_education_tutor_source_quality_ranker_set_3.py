...
Plugin: AI Education Tutor Source Quality Ranker Set 3
Slug: ai_education_tutor_source_quality_ranker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Source Quality Ranker Set 3'
_PLUGIN_SLUG: str = 'ai_education_tutor_source_quality_ranker_set_3'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Rank provided sources for AI education, tutoring, and learning workflows by trust, relevance, freshness, and answer usefulness.'
_PLUGIN_TAGS = ['education', 'learning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI education, tutoring, and learning workflows source quality and grounded answer preparation'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Source Quality Ranker Set 3'
        goal = 'Rank provided sources for AI education, tutoring, and learning workflows by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI education, tutoring, and learning workflows source quality and grounded answer preparation'
