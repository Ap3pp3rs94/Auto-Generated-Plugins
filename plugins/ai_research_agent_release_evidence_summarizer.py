...
Capability: AI Research Agent Release Evidence Summarizer 000114
...
_PLUGIN_NAME: str = 'AI Research Agent Release Evidence Summarizer 000114'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Release Evidence Summarizer 000114'
