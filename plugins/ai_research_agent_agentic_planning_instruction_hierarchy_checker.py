...
Plugin: AI Research Agent Agentic Planning Instruction Hierarchy Checker 000503
Slug: ai_research_agent_agentic_planning_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Agentic Planning Instruction Hierarchy Checker 000503'
_PLUGIN_SLUG: str = 'ai_research_agent_agentic_planning_instruction_hierarchy_checker'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI research, retrieval, and synthesis work for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI research, retrieval, and synthesis work for agentic planning instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Agentic Planning Instruction Hierarchy Checker 000503'
        goal = 'Check AI research, retrieval, and synthesis work for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI research, retrieval, and synthesis work for agentic planning instruction hierarchy and conflict safety'
