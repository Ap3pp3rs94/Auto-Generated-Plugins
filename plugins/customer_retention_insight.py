...
# File       : customer_retention_insight.py
# Description: Identify and prioritize customers at risk of churn to inform proactive retention strategies.
# Goal       : Identify and prioritize customers at risk of churn to inform proactive retention strategies.
# Category   : analysis
...
_PLUGIN_NAME: str = 'Customer Retention Insights'
_PLUGIN_GOAL: str = 'Identify and prioritize customers at risk of churn to inform proactive retention strategies.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['churn', 'retention', 'customers']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_retention_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
