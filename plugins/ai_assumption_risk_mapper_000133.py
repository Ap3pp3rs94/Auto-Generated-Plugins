...
Capability: AI Assumption Risk Mapper 000133
Slug: ai_assumption_risk_mapper_000133
"""
...
_PLUGIN_NAME: str = 'AI Assumption Risk Mapper 000133'
_PLUGIN_SLUG: str = 'ai_assumption_risk_mapper_000133'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Assumption Risk Mapper 000133'
