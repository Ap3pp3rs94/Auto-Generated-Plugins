...
Capability: AI Workflow Retry Strategy Planner 000035
Slug: ai_workflow_retry_strategy_planner_000035
"""
...
_PLUGIN_NAME: str = 'AI Workflow Retry Strategy Planner 000035'
_PLUGIN_SLUG: str = 'ai_workflow_retry_strategy_planner_000035'
...
_PLUGIN_USE_CASES = ['Convert failure traces into retry strategies.', 'Change one variable at a time for safer debugging.', 'Recommend when to stop retrying and ask for input.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Workflow Retry Strategy Planner 000035', 'slug': 'ai_workflow_retry_strategy_planner_000035', 'goal': 'Plan safe retries for failed AI workflows without repeating the same failure.', 'category': 'ai_agents', 'tags': ['ai', 'retry', 'workflow', 'debugging', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI workflow retry planning and failure recovery', 'owner_id': None, 'use_cases': ['Convert failure traces into retry strategies.', 'Change one variable at a time for safer debugging.', 'Recommend when to stop retrying and ask for input.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Workflow Retry Strategy Planner 000035'
