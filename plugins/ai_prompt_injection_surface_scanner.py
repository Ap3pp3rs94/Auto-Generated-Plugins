...
Plugin: AI Prompt Injection Surface Scanner
...
_PLUGIN_NAME: str = 'AI Prompt Injection Surface Scanner'
...
_PLUGIN_TAGS = ['ai', 'safety', 'injection', 'instructions', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Injection Surface Scanner'
