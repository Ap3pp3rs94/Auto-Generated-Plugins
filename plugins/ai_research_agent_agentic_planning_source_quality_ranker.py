...
Capability: AI Research Agent Agentic Planning Source Quality Ranker 000484
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
