...
Capability: AI Product Manager Verification Checklist Builder 000350
...
_PLUGIN_NAME: str = 'AI Product Manager Verification Checklist Builder 000350'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Verification Checklist Builder 000350'
