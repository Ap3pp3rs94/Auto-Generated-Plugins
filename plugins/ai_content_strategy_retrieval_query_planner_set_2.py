...
Plugin: AI Content Strategy Retrieval Query Planner Set 2
Slug: ai_content_strategy_retrieval_query_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Retrieval Query Planner Set 2'
_PLUGIN_SLUG: str = 'ai_content_strategy_retrieval_query_planner_set_2'
...
_PLUGIN_TAGS = ['content', 'strategy', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Retrieval Query Planner Set 2'
