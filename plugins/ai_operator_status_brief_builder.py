...
Plugin: AI Operator Status Brief Builder
...
_PLUGIN_NAME: str = 'AI Operator Status Brief Builder'
_PLUGIN_SLUG: str = 'ai_operator_status_brief_builder'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Turn autonomous AI run state into a concise operator-facing status brief.'
_PLUGIN_TAGS = ['ai', 'status', 'operators', 'progress', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operator Status Brief Builder'
