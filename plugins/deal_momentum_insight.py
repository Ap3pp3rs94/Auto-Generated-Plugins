...
# Title      : Deal Momentum Insights
# File       : deal_momentum_insight.py
# Description: Identify and prioritize deals based on their historical momentum to maximize conversion rates.
# Goal       : Identify and prioritize deals based on their historical momentum to maximize conversion rates.
# Category   : sales
# Tags       : deal, conversion, prioritization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Momentum Insights'
_PLUGIN_GOAL: str = 'Identify and prioritize deals based on their historical momentum to maximize conversion rates.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['deal', 'conversion', 'prioritization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_momentum_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
