...
_PLUGIN_MANIFEST = {'name': 'AI Prompt Persona Adapter 000049', 'slug': 'ai_prompt_persona_adapter', 'goal': 'Adapt prompts for a target audience, role, or expertise level without changing the core task.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'persona', 'audience', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI prompt persona adaptation and audience fit', 'owner_id': 'francis-factory', 'use_cases': ['Rewrite prompts for beginner, expert, executive, or operator audiences.', 'Preserve task constraints while changing tone and explanation depth.', 'Flag persona changes that would distort the original request.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
