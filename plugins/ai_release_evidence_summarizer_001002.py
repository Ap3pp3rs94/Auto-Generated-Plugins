...
Capability: AI Release Evidence Summarizer 001002
Slug: ai_release_evidence_summarizer_001002
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 001002'
        goal = 'Summarize validation and release evidence for AI finance operations and risk review for AI tool use AI capability artifacts.'
        domain = 'AI finance operations and risk review for AI tool use release evidence and publishing readiness'
