...
Capability: AI Research Agent Prompt Contract Designer 000097
...
_PLUGIN_NAME: str = 'AI Research Agent Prompt Contract Designer 000097'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Prompt Contract Designer 000097'
