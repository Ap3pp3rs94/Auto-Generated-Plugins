...
# Title      : Sales Velocity Trend Analyzer
# File       : sales_velocity_trend_analysis.py
# Description: Identify and visualize sales velocity trends to inform strategic decisions and optimize performance
# Goal       : Identify and visualize sales velocity trends to inform strategic decisions and optimize performance
# Category   : sales | analysis
# Tags       : trends, velocity, sales
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Velocity Trend Analyzer'
_PLUGIN_GOAL: str = 'Identify and visualize sales velocity trends to inform strategic decisions and optimize performance'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['trends', 'velocity', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_velocity_trend_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
