...
Capability: AI Security Review Agentic Planning Source Quality Ranker 000700
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
