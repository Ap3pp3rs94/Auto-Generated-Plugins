...
Plugin: AI Research Agent Evidence Gap Detector Set 3
Slug: ai_research_agent_evidence_gap_detector_set_3
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Evidence Gap Detector Set 3'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI research, retrieval, and synthesis work.'
        domain = 'AI research, retrieval, and synthesis work evidence gaps and retrieval readiness'
