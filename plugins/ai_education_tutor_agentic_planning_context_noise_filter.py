...
Capability: AI Education Tutor Agentic Planning Context Noise Filter 000629
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
