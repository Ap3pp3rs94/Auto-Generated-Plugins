...
Plugin: AI Education Tutor Agentic Planning Context Noise Filter 000629
Slug: ai_education_tutor_agentic_planning_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Agentic Planning Context Noise Filter 000629'
_PLUGIN_SLUG: str = 'ai_education_tutor_agentic_planning_context_noise_filter'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI education, tutoring, and learning workflows for agentic planning.'
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI education, tutoring, and learning workflows for agentic planning context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Agentic Planning Context Noise Filter 000629'
        goal = 'Filter noisy or redundant context before model calls for AI education, tutoring, and learning workflows for agentic planning.'
        domain = 'AI education, tutoring, and learning workflows for agentic planning context filtering and token-budget control'
