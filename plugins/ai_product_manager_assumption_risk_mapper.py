...
Capability: AI Product Manager Assumption Risk Mapper 000349
...
_PLUGIN_NAME: str = 'AI Product Manager Assumption Risk Mapper 000349'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Assumption Risk Mapper 000349'
