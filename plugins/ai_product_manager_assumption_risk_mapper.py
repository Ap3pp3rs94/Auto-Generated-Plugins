...
Plugin: AI Product Manager Assumption Risk Mapper
Slug: ai_product_manager_assumption_risk_mapper
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Assumption Risk Mapper'
_PLUGIN_SLUG: str = 'ai_product_manager_assumption_risk_mapper'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Map assumptions in AI product planning and roadmap workflows work and score which ones need evidence or user confirmation.'
_PLUGIN_TAGS = ['product', 'planning', 'assumptions', 'risk', 'readiness', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI product planning and roadmap workflows assumption tracking and readiness scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Assumption Risk Mapper'
        goal = 'Map assumptions in AI product planning and roadmap workflows work and score which ones need evidence or user confirmation.'
        domain = 'AI product planning and roadmap workflows assumption tracking and readiness scoring'
