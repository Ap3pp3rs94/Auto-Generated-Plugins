...
Plugin: AI Education Tutor Agent Handoff Checker
Slug: ai_education_tutor_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_education_tutor_agent_handoff_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Agent Handoff Checker'
