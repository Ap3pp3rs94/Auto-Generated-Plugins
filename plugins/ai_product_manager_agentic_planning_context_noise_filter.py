...
Capability: AI Product Manager Agentic Planning Context Noise Filter 000725
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
