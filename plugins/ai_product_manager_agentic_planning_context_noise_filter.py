...
Plugin: AI Product Manager Agentic Planning Context Noise Filter 000725
Slug: ai_product_manager_agentic_planning_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Agentic Planning Context Noise Filter 000725'
_PLUGIN_SLUG: str = 'ai_product_manager_agentic_planning_context_noise_filter'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI product planning and roadmap workflows for agentic planning.'
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'context', 'tokens', 'noise', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI product planning and roadmap workflows for agentic planning context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Agentic Planning Context Noise Filter 000725'
        goal = 'Filter noisy or redundant context before model calls for AI product planning and roadmap workflows for agentic planning.'
        domain = 'AI product planning and roadmap workflows for agentic planning context filtering and token-budget control'
