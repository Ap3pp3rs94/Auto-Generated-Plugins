...
Plugin: AI Security Review Verification Checklist Builder
Slug: ai_security_review_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Security Review Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_security_review_verification_checklist_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Verification Checklist Builder'
