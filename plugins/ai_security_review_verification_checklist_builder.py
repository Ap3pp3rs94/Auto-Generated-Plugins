...
Capability: AI Security Review Verification Checklist Builder 000326
...
_PLUGIN_NAME: str = 'AI Security Review Verification Checklist Builder 000326'
...
_PLUGIN_TAGS = ['security', 'safety', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Verification Checklist Builder 000326'
