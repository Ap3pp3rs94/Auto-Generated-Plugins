...
Plugin: AI Capability Factory Evidence Gap Detector Set 2
Slug: ai_plugin_factory_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI capability factory and generated module operations.'
        domain = 'AI capability factory and generated module operations evidence gaps and retrieval readiness'
