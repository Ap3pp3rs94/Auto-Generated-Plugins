...
Plugin: AI Memory Conflict Resolver
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Conflict Resolver'
        goal = 'Detect conflicting memory facts and recommend which version should be kept, updated, or retired.'
        domain = 'AI memory conflict detection and durable fact hygiene'
        capability_type = 'research_synthesizer'
        logic_profile_id = 'memory_conflict_resolver_profile'
