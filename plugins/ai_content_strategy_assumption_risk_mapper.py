...
Capability: AI Content Strategy Assumption Risk Mapper 000373
...
_PLUGIN_NAME: str = 'AI Content Strategy Assumption Risk Mapper 000373'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Assumption Risk Mapper 000373'
