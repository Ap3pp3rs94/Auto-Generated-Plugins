...
Plugin: AI Retrieval Query Expander 000008
...
_PLUGIN_NAME: str = 'AI Retrieval Query Expander 000008'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Expander 000008'
