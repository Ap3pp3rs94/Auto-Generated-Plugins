...
Plugin: AI Coding Agent Capability Overlap Checker
Slug: ai_coding_agent_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_coding_agent_capability_overlap_checker'
...
_PLUGIN_TAGS = ['coding', 'agents', 'capabilities', 'duplicates', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Capability Overlap Checker'
