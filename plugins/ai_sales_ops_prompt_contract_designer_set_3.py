...
Plugin: AI Sales Ops Prompt Contract Designer Set 3
Slug: ai_sales_ops_prompt_contract_designer_set_3
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Contract Designer Set 3'
        goal = 'Design prompt contracts for AI sales operations and account workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI sales operations and account workflows prompt contracts and structured instruction design'
