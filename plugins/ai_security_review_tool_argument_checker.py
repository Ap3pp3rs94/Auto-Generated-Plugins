...
Plugin: AI Security Review Tool Argument Checker
Slug: ai_security_review_tool_argument_checker
"""
...
_PLUGIN_NAME: str = 'AI Security Review Tool Argument Checker'
_PLUGIN_SLUG: str = 'ai_security_review_tool_argument_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Tool Argument Checker'
