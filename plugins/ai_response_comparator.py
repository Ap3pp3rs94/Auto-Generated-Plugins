...
_PLUGIN_MANIFEST = {'name': 'AI Response Comparator 000012', 'slug': 'ai_response_comparator', 'goal': 'Compare multiple AI responses and rank them against a task-specific rubric.', 'category': 'ai_evaluation', 'tags': ['ai', 'comparison', 'evaluation', 'rubric', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI model comparison and answer selection', 'owner_id': 'francis-factory', 'use_cases': ['Compare candidate responses for completeness and accuracy.', 'Explain why one output is stronger than another.', 'Merge the best parts of multiple responses into a recommendation.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
