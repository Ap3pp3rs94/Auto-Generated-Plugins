...
_PLUGIN_NAME: str = 'AI Response Comparator'
_PLUGIN_SLUG: str = 'ai_response_comparator'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Compare multiple AI responses and rank them against a task-specific rubric.'
_PLUGIN_TAGS = ['ai', 'comparison', 'evaluation', 'rubric', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Comparator'
        ...
        use_cases = ['Compare candidate responses for completeness and accuracy.', 'Explain why one output is stronger than another.', 'Merge the best parts of multiple responses into a recommendation.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
