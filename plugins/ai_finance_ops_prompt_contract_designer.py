...
Capability: AI Finance Ops Prompt Contract Designer 000217
...
_PLUGIN_NAME: str = 'AI Finance Ops Prompt Contract Designer 000217'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Prompt Contract Designer 000217'
