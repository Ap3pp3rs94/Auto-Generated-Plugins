...
Capability: AI DevOps Release Tool Safety Reviewer 000273
...
_PLUGIN_NAME: str = 'AI DevOps Release Tool Safety Reviewer 000273'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Tool Safety Reviewer 000273'
