...
Capability: AI Automation Safety Gate 000017
Slug: ai_automation_safety_gate_000017
"""
...
_PLUGIN_NAME: str = 'AI Automation Safety Gate 000017'
_PLUGIN_SLUG: str = 'ai_automation_safety_gate_000017'
...
_PLUGIN_USE_CASES = ['Score automation plans before execution.', 'Flag destructive or irreversible steps.', 'Recommend approval, logging, and rollback controls.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Automation Safety Gate 000017', 'slug': 'ai_automation_safety_gate_000017', 'goal': 'Review proposed AI automation steps for side effects, missing approvals, and rollback needs.', 'category': 'ai_safety', 'tags': ['ai', 'automation', 'safety', 'risk', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI automation safety and operational risk', 'owner_id': None, 'use_cases': ['Score automation plans before execution.', 'Flag destructive or irreversible steps.', 'Recommend approval, logging, and rollback controls.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Automation Safety Gate 000017'
