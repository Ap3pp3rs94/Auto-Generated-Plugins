...
Plugin: AI Coding Agent Response Action Planner
Slug: ai_coding_agent_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Response Action Planner'
_PLUGIN_SLUG: str = 'ai_coding_agent_response_action_planner'
...
_PLUGIN_TAGS = ['coding', 'agents', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Response Action Planner'
