...
Capability: AI User Intent Classifier 000023
Slug: ai_user_intent_classifier_000023
"""
...
_PLUGIN_NAME: str = 'AI User Intent Classifier 000023'
_PLUGIN_SLUG: str = 'ai_user_intent_classifier_000023'
...
_PLUGIN_MANIFEST = {'name': 'AI User Intent Classifier 000023', 'slug': 'ai_user_intent_classifier_000023', 'goal': 'Classify a user request into the right AI workflow intent and execution mode.', 'category': 'ai_agents', 'tags': ['ai', 'intent', 'routing', 'classification', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'integration', 'intended_domain': 'AI user intent routing and workflow selection', 'owner_id': None, 'use_cases': ['Classify requests into coding, research, planning, evaluation, or safety.', 'Detect whether the user wants action, explanation, review, or brainstorming.', 'Recommend the smallest workflow that satisfies the request.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI User Intent Classifier 000023'
        ...
        generation_note = 'router evidence surface repair after numbered cadence audit'
