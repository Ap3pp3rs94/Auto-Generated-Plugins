...
# File       : customer_journey_analysis.py
# Description: Visualize customer journey to identify pain points and optimize sales processes
# Goal       : Visualize customer journey to identify pain points and optimize sales processes
...
_PLUGIN_NAME: str = 'Customer Journey Visualization'
_PLUGIN_GOAL: str = 'Visualize customer journey to identify pain points and optimize sales processes'
_PLUGIN_CATEGORY: str = 'sales | marketing | support'
_PLUGIN_TAGS = ['journey', 'visual']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_journey_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
