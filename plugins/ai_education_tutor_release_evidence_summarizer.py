...
Plugin: AI Education Tutor Release Evidence Summarizer
Slug: ai_education_tutor_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_education_tutor_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Release Evidence Summarizer'
