...
Capability: AI Education Tutor Release Evidence Summarizer 000258
...
_PLUGIN_NAME: str = 'AI Education Tutor Release Evidence Summarizer 000258'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Release Evidence Summarizer 000258'
