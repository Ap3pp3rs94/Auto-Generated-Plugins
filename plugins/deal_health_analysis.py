...
# Title      : Deal Health Analyzer
# File       : deal_health_analysis.py
# Description: Analyze deal health by identifying potential issues and suggesting actionable steps to improve win rates and revenue.
# Goal       : Analyze deal health by identifying potential issues and suggesting actionable steps to improve win rates and revenue.
# Category   : sales | marketing | support
# Tags       : deal, health, analysis
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Health Analyzer'
_PLUGIN_GOAL: str = 'Analyze deal health by identifying potential issues and suggesting actionable steps to improve win rates and revenue.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support'
_PLUGIN_TAGS = ['deal', 'health', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_health_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
