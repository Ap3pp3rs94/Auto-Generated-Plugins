...
Capability: AI Product Manager Prompt Contract Designer 000337
...
_PLUGIN_NAME: str = 'AI Product Manager Prompt Contract Designer 000337'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Prompt Contract Designer 000337'
