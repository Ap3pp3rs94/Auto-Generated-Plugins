...
Plugin: AI Product Manager Prompt Contract Designer
Slug: ai_product_manager_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_product_manager_prompt_contract_designer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Prompt Contract Designer'
