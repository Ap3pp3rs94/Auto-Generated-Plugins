...
Plugin: AI Research Agent Prompt Contract Designer Set 3
Slug: ai_research_agent_prompt_contract_designer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Prompt Contract Designer Set 3'
_PLUGIN_SLUG: str = 'ai_research_agent_prompt_contract_designer_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Prompt Contract Designer Set 3'
