...
Plugin: AI Security Review Release Evidence Summarizer
Slug: ai_security_review_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Security Review Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_security_review_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Release Evidence Summarizer'
