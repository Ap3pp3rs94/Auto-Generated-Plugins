...
Capability: AI Security Review Release Evidence Summarizer 000330
...
_PLUGIN_NAME: str = 'AI Security Review Release Evidence Summarizer 000330'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Release Evidence Summarizer 000330'
