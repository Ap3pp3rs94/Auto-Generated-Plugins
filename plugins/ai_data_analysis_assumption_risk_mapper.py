...
Capability: AI Data Analysis Assumption Risk Mapper 000301
...
_PLUGIN_NAME: str = 'AI Data Analysis Assumption Risk Mapper 000301'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Assumption Risk Mapper 000301'
