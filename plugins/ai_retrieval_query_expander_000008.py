...
Capability: AI Retrieval Query Expander 000008
Slug: ai_retrieval_query_expander_000008
"""
...
_PLUGIN_SLUG: str = 'ai_retrieval_query_expander_000008'
...
_PLUGIN_MANIFEST = {'name': 'AI Retrieval Query Expander 000008', 'slug': 'ai_retrieval_query_expander_000008', 'goal': 'Generate targeted retrieval queries and filters for RAG-style knowledge lookup.', 'category': 'ai_retrieval', 'tags': ['ai', 'retrieval', 'rag', 'search', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI retrieval, RAG, search planning, and knowledge grounding', 'owner_id': None, 'use_cases': ['Expand a user question into precise search queries.', 'Suggest metadata filters and source priorities.', 'Separate broad discovery queries from exact verification queries.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
