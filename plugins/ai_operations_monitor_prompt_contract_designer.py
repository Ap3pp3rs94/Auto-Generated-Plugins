...
Plugin: AI Operations Monitor Prompt Contract Designer
Slug: ai_operations_monitor_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_operations_monitor_prompt_contract_designer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Prompt Contract Designer'
