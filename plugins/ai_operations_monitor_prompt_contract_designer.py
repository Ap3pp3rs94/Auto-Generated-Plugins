...
Capability: AI Operations Monitor Prompt Contract Designer 000409
...
_PLUGIN_NAME: str = 'AI Operations Monitor Prompt Contract Designer 000409'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Prompt Contract Designer 000409'
