...
Capability: AI Security Review Prompt Contract Designer 000313
...
_PLUGIN_NAME: str = 'AI Security Review Prompt Contract Designer 000313'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Prompt Contract Designer 000313'
