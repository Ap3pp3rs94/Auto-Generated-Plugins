...
Capability: AI Security Review Agentic Planning Memory Update Recommender 000702
Slug: ai_security_review_agentic_planning_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Security Review Agentic Planning Memory Update Recommender 000702'
_PLUGIN_SLUG: str = 'ai_security_review_agentic_planning_memory_update_recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Agentic Planning Memory Update Recommender 000702'
