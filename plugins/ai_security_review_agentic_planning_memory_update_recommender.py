...
Plugin: AI Security Review Agentic Planning Memory Update Recommender 000702
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
