...
# Title      : Business Analytics Skill 212
# File       : business_analytics_skill_212.py
# Description: Analyze business-related data (operations, finance, or sales) to produce structured insights.
...
_PLUGIN_NAME: str = 'Business Analytics Skill 212'
_PLUGIN_GOAL: str = 'Analyze business-related data (operations, finance, or sales) to produce structured insights.'
_PLUGIN_CATEGORY: str = 'business_analytics'
_PLUGIN_TAGS = ['business', 'analytics']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'business_analytics_skill_212'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
