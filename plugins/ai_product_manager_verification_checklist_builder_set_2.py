...
Plugin: AI Product Manager Verification Checklist Builder Set 2
Slug: ai_product_manager_verification_checklist_builder_set_2
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Verification Checklist Builder Set 2'
_PLUGIN_SLUG: str = 'ai_product_manager_verification_checklist_builder_set_2'
...
_PLUGIN_TAGS = ['product', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Verification Checklist Builder Set 2'
        goal = 'Build verification checklists for AI product planning and roadmap workflows AI artifacts before release or handoff.'
