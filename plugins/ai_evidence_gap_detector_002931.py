...
Capability: AI Evidence Gap Detector 002931
Slug: ai_evidence_gap_detector_002931
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Detector 002931'
_PLUGIN_SLUG: str = 'ai_evidence_gap_detector_002931'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 002931'
