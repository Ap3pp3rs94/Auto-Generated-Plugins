...
Capability: AI Content Strategy Model Fit Triage 000382
...
_PLUGIN_NAME: str = 'AI Content Strategy Model Fit Triage 000382'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Model Fit Triage 000382'
