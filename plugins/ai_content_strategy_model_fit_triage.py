...
Plugin: AI Content Strategy Model Fit Triage
Slug: ai_content_strategy_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Model Fit Triage'
_PLUGIN_SLUG: str = 'ai_content_strategy_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Model Fit Triage'
