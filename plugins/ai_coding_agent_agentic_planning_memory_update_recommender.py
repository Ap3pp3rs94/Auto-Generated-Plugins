...
Plugin: AI Coding Agent Agentic Planning Memory Update Recommender
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Memory Update Recommender'
...
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Memory Update Recommender'
