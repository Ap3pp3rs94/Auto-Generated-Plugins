...
Capability: AI Coding Agent Agentic Planning Memory Update Recommender 000462
Slug: ai_coding_agent_agentic_planning_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Memory Update Recommender 000462'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_memory_update_recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Memory Update Recommender 000462'
