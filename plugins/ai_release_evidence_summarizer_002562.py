...
Capability: AI Release Evidence Summarizer 002562
Slug: ai_release_evidence_summarizer_002562
"""
...
_PLUGIN_NAME: str = 'AI Release Evidence Summarizer 002562'
_PLUGIN_SLUG: str = 'ai_release_evidence_summarizer_002562'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 002562'
