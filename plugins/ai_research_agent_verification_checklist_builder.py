...
Plugin: AI Research Agent Verification Checklist Builder
Slug: ai_research_agent_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_research_agent_verification_checklist_builder'
...
_PLUGIN_TAGS = ['research', 'retrieval', 'verification', 'tests', 'checklists', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Verification Checklist Builder'
