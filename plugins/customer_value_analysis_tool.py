...
# Title      : Customer Value Insights
# File       : customer_value_analysis_tool.py
# Description: Provide actionable customer value insights to inform sales and marketing strategies
# Goal       : Provide actionable customer value insights to inform sales and marketing strategies
# Category   : analysis
# Tags       : insights, customers
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Customer Value Insights'
_PLUGIN_GOAL: str = 'Provide actionable customer value insights to inform sales and marketing strategies'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['insights', 'customers']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_value_analysis_tool'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
