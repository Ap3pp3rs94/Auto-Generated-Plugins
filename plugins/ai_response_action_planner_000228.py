...
Capability: AI Response Action Planner 000228
Slug: ai_response_action_planner_000228
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000228'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000228'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000228'
        goal = 'Convert AI finance operations and risk review AI responses into concrete next actions with owners, checks, and risks.'
