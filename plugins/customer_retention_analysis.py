...
# File       : customer_retention_analysis.py
# Description: Identify at-risk customers and provide insights to retain them
# Goal       : Identify at-risk customers and provide insights to retain them
# Category   : sales | marketing | support | analysis
# Tags       : customer retention, predictive analytics
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Identify at-risk customers and provide insights to retain them'
_PLUGIN_CATEGORY: str = 'sales | marketing | support | analysis'
_PLUGIN_TAGS = ['customer retention', 'predictive analytics']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_retention_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
