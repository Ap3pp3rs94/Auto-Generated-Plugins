...
# Title      : Sales Opportunity Categorization
# File       : sales_opportunity_categorizer.py
# Description: Automatically categorize sales opportunities based on customer intent, behavior, and demographics to improve lead conversion and sales performance.
# Goal       : Automatically categorize sales opportunities based on customer intent, behavior, and demographics to improve lead conversion and sales performance.
# Category   : sales | analysis
# Tags       : classification, lead scoring
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Opportunity Categorization'
_PLUGIN_GOAL: str = 'Automatically categorize sales opportunities based on customer intent, behavior, and demographics to improve lead conversion and sales performance.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['classification', 'lead scoring']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_categorizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
