...
Plugin: AI Product Manager Retrieval Query Planner
...
_PLUGIN_NAME: str = 'AI Product Manager Retrieval Query Planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Retrieval Query Planner'
