...
Plugin: AI Content Strategy Tool Safety Reviewer
Slug: ai_content_strategy_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_content_strategy_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Tool Safety Reviewer'
