...
Capability: AI Content Strategy Tool Safety Reviewer 000369
...
_PLUGIN_NAME: str = 'AI Content Strategy Tool Safety Reviewer 000369'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Tool Safety Reviewer 000369'
