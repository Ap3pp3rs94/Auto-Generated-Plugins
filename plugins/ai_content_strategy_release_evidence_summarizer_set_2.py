...
Plugin: AI Content Strategy Release Evidence Summarizer Set 2
Slug: ai_content_strategy_release_evidence_summarizer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Release Evidence Summarizer Set 2'
_PLUGIN_SLUG: str = 'ai_content_strategy_release_evidence_summarizer_set_2'
...
_PLUGIN_TAGS = ['content', 'strategy', 'release', 'evidence', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Release Evidence Summarizer Set 2'
