...
Capability: AI Instruction Hierarchy Checker 008111
Slug: ai_instruction_hierarchy_checker_008111
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 008111'
        goal = 'Check AI operations monitoring and incident response for detecting signals instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI operations monitoring and incident response for detecting signals instruction hierarchy and conflict safety'
