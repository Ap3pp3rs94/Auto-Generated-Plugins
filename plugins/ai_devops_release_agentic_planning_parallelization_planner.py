...
Capability: AI DevOps Release Agentic Planning Parallelization Planner 000656
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
