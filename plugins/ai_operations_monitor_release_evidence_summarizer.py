...
Capability: AI Operations Monitor Release Evidence Summarizer 000426
...
_PLUGIN_NAME: str = 'AI Operations Monitor Release Evidence Summarizer 000426'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Release Evidence Summarizer 000426'
