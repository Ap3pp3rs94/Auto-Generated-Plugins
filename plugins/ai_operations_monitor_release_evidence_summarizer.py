...
Plugin: AI Operations Monitor Release Evidence Summarizer
Slug: ai_operations_monitor_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_operations_monitor_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Release Evidence Summarizer'
