...
Capability: AI Context Noise Filter 001133
Slug: ai_context_noise_filter_001133
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 001133'
        goal = 'Filter noisy or redundant context before model calls for AI content strategy and editorial workflows for AI tool use.'
        domain = 'AI content strategy and editorial workflows for AI tool use context filtering and token-budget control'
