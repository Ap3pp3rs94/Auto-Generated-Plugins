...
Capability: AI Agent Handoff Checker 002743
Slug: ai_agent_handoff_checker_002743
"""
...
_PLUGIN_NAME: str = 'AI Agent Handoff Checker 002743'
_PLUGIN_SLUG: str = 'ai_agent_handoff_checker_002743'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Agent Handoff Checker 002743'
