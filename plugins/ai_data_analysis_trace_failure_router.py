...
Capability: AI Data Analysis Trace Failure Router 000307
...
_PLUGIN_NAME: str = 'AI Data Analysis Trace Failure Router 000307'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Trace Failure Router 000307'
