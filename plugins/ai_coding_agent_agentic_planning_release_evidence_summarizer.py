...
Capability: AI Coding Agent Agentic Planning Release Evidence Summarizer 000474
...
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'release', 'evidence', 'factory', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
