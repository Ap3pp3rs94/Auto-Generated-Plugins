...
Plugin: AI Coding Agent Agentic Planning Release Evidence Summarizer 000474
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Release Evidence Summarizer 000474'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Release Evidence Summarizer 000474'
