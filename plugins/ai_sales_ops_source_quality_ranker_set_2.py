...
Plugin: AI Sales Ops Source Quality Ranker Set 2
Slug: ai_sales_ops_source_quality_ranker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Source Quality Ranker Set 2'
_PLUGIN_SLUG: str = 'ai_sales_ops_source_quality_ranker_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Source Quality Ranker Set 2'
