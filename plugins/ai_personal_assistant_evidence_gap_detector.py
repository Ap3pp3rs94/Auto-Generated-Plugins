...
Plugin: AI Personal Assistant Evidence Gap Detector
Slug: ai_personal_assistant_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_personal_assistant_evidence_gap_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Evidence Gap Detector'
