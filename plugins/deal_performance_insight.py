...
# Title      : Deal Performance Insight
# File       : deal_performance_insight.py
# Description: Provides in-depth insights into deal performance to inform sales strategies and optimize pipeline growth.
# Goal       : Provides in-depth insights into deal performance to inform sales strategies and optimize pipeline growth.
...
_PLUGIN_NAME: str = 'Deal Performance Insight'
_PLUGIN_GOAL: str = 'Provides in-depth insights into deal performance to inform sales strategies and optimize pipeline growth.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['performance', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
