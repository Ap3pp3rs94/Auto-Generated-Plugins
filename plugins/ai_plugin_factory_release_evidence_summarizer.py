...
Plugin: AI Capability Factory Release Evidence Summarizer
Slug: ai_plugin_factory_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_plugin_factory_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Release Evidence Summarizer'
