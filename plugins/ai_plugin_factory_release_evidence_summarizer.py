...
Capability: AI Capability Factory Release Evidence Summarizer 000450
...
_PLUGIN_NAME: str = 'AI Capability Factory Release Evidence Summarizer 000450'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Release Evidence Summarizer 000450'
