...
Plugin: AI Data Analysis Prompt Clarity Auditor
Slug: ai_data_analysis_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_data_analysis_prompt_clarity_auditor'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Prompt Clarity Auditor'
