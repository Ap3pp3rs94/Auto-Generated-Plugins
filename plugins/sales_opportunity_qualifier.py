...
# Title      : Sales Opportunity Qualification
# File       : sales_opportunity_qualifier.py
# Description: Qualify sales opportunities by assessing relevance, priority, and potential value.
# Goal       : Qualify sales opportunities by assessing relevance, priority, and potential value.
# Category   : analysis
# Tags       : qualifying, opportunities
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Opportunity Qualification'
_PLUGIN_GOAL: str = 'Qualify sales opportunities by assessing relevance, priority, and potential value.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['qualifying', 'opportunities']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_qualifier'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
