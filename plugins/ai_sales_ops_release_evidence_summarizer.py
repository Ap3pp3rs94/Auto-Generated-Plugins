...
Plugin: AI Sales Ops Release Evidence Summarizer
Slug: ai_sales_ops_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_sales_ops_release_evidence_summarizer'
...
_PLUGIN_TAGS = ['sales', 'business', 'release', 'evidence', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Release Evidence Summarizer'
