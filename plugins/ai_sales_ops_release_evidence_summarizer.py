...
Capability: AI Sales Ops Release Evidence Summarizer 000162
...
_PLUGIN_NAME: str = 'AI Sales Ops Release Evidence Summarizer 000162'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Release Evidence Summarizer 000162'
