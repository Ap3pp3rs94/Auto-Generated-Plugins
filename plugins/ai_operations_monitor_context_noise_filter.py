...
Plugin: AI Operations Monitor Context Noise Filter
Slug: ai_operations_monitor_context_noise_filter
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Context Noise Filter'
_PLUGIN_SLUG: str = 'ai_operations_monitor_context_noise_filter'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Context Noise Filter'
