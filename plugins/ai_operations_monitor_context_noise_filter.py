...
Capability: AI Operations Monitor Context Noise Filter 000413
...
_PLUGIN_NAME: str = 'AI Operations Monitor Context Noise Filter 000413'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Context Noise Filter 000413'
