...
Plugin: AI DevOps Release Retrieval Query Planner
...
_PLUGIN_NAME: str = 'AI DevOps Release Retrieval Query Planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Retrieval Query Planner'
