...
Capability: AI Product Manager Tool Argument Checker 000346
...
_PLUGIN_NAME: str = 'AI Product Manager Tool Argument Checker 000346'
...
_PLUGIN_TAGS = ['product', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Tool Argument Checker 000346'
