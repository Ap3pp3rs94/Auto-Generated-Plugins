...
Capability: AI Coding Agent Context Noise Filter 000077
...
_PLUGIN_NAME: str = 'AI Coding Agent Context Noise Filter 000077'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Context Noise Filter 000077'
