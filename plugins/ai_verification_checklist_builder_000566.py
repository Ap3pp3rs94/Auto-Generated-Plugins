...
Capability: AI Verification Checklist Builder 000566
Slug: ai_verification_checklist_builder_000566
"""
...
_PLUGIN_NAME: str = 'AI Verification Checklist Builder 000566'
_PLUGIN_SLUG: str = 'ai_verification_checklist_builder_000566'
...
_PLUGIN_MANIFEST = {'name': 'AI Verification Checklist Builder 000566', 'slug': 'ai_verification_checklist_builder_000566', 'goal': 'Build verification checklists for AI clinical administration and healthcare operations for agentic planning AI artifacts before release or handoff.', 'category': 'ai_evaluation', 'tags': ['healthcare', 'clinical', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI clinical administration and healthcare operations for agentic planning verification planning and acceptance checks', 'owner_id': None, 'use_cases': ['Apply this capability to the distinct use case: Clinical Admin Agentic Planning.', 'Turn acceptance criteria into concrete checks.', 'Separate automated checks from human review.', 'Record evidence needed before publish or handoff.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 000566'
