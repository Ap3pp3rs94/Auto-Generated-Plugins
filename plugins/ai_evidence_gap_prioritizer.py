...
Plugin: AI Evidence Gap Prioritizer
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Prioritizer'
        goal = 'Prioritize missing evidence that must be retrieved before an AI answer can be trusted.'
        domain = 'AI evidence gaps and retrieval prioritization'
        capability_type = 'research_synthesizer'
        logic_profile_id = 'evidence_gap_prioritizer_profile'
