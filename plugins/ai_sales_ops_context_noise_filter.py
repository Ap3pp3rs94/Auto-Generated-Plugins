...
Capability: AI Sales Ops Context Noise Filter 000149
...
_PLUGIN_NAME: str = 'AI Sales Ops Context Noise Filter 000149'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Context Noise Filter 000149'
