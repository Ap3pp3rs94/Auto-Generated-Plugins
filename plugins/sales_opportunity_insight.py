...
# Title      : Sales Opportunity Insights
# File       : sales_opportunity_insight.py
# Description: This skill generates insights on sales opportunities by analyzing customer behavior and sales pipeline data to identify trends, patterns, and potential issues.
# Goal       : This skill generates insights on sales opportunities by analyzing customer behavior and sales pipeline data to identify trends, patterns, and potential issues.
# Category   : analysis
...
_PLUGIN_NAME: str = 'Sales Opportunity Insights'
_PLUGIN_GOAL: str = 'This skill generates insights on sales opportunities by analyzing customer behavior and sales pipeline data to identify trends, patterns, and potential issues.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['insights', 'opportunities']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_insight'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
