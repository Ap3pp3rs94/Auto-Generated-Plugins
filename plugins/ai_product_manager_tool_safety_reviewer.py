...
Plugin: AI Product Manager Tool Safety Reviewer
Slug: ai_product_manager_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Tool Safety Reviewer'
_PLUGIN_SLUG: str = 'ai_product_manager_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Tool Safety Reviewer'
