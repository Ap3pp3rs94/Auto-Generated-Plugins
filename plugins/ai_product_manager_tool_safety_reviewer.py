...
Capability: AI Product Manager Tool Safety Reviewer 000345
...
_PLUGIN_NAME: str = 'AI Product Manager Tool Safety Reviewer 000345'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Tool Safety Reviewer 000345'
