...
Capability: AI Evidence Gap Detector 010323
Slug: ai_evidence_gap_detector_010323
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Detector 010323'
_PLUGIN_SLUG: str = 'ai_evidence_gap_detector_010323'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Detect missing evidence that blocks trustworthy answers in AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls.'
_PLUGIN_TAGS = ['marketplace', 'trust', 'catalog', 'safety', 'controls', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls evidence gaps and retrieval readiness'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Marketplace Ops Safety Controls.', 'List unsupported claims in Marketplace Ops Safety Controls work.', 'Rank evidence gaps by risk and retrieval priority.', 'Suggest focused retrieval questions for each missing source.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Evidence Gap Detector 010323', 'slug': 'ai_evidence_gap_detector_010323', 'goal': 'Detect missing evidence that blocks trustworthy answers in AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls.', 'category': 'ai_retrieval', 'tags': ['marketplace', 'trust', 'catalog', 'safety', 'controls', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls evidence gaps and retrieval readiness', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Marketplace Ops Safety Controls.', 'List unsupported claims in Marketplace Ops Safety Controls work.', 'Rank evidence gaps by risk and retrieval priority.', 'Suggest focused retrieval questions for each missing source.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 010323'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls.'
        domain = 'AI marketplace trust, seller operations, catalog quality, and transaction workflows for safety controls evidence gaps and retrieval readiness'
