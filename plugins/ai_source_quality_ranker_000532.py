...
Capability: AI Source Quality Ranker 000532
Slug: ai_source_quality_ranker_000532
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 000532'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_000532'
...
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Sales Ops Agentic Planning.', 'Score source notes before synthesis.', 'Flag stale, weak, or low-relevance evidence.', 'Recommend which sources should anchor the final output.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Source Quality Ranker 000532', 'slug': 'ai_source_quality_ranker_000532', 'goal': 'Rank provided sources for AI sales operations and account workflows for agentic planning by trust, relevance, freshness, and answer usefulness.', 'category': 'ai_retrieval', 'tags': ['sales', 'business', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI sales operations and account workflows for agentic planning source quality and grounded answer preparation', 'owner_id': None, 'use_cases': ['Apply this capability to the distinct use case: Sales Ops Agentic Planning.', 'Score source notes before synthesis.', 'Flag stale, weak, or low-relevance evidence.', 'Recommend which sources should anchor the final output.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 000532'
