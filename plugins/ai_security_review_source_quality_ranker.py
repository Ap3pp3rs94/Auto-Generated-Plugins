...
Plugin: AI Security Review Source Quality Ranker
Slug: ai_security_review_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Security Review Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_security_review_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Source Quality Ranker'
