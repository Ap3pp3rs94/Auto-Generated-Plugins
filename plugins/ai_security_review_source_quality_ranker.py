...
Capability: AI Security Review Source Quality Ranker 000316
...
_PLUGIN_NAME: str = 'AI Security Review Source Quality Ranker 000316'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Source Quality Ranker 000316'
