...
Plugin: AI Research Agent Agent Handoff Checker Set 3
Slug: ai_research_agent_agent_handoff_checker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Agent Handoff Checker Set 3'
_PLUGIN_SLUG: str = 'ai_research_agent_agent_handoff_checker_set_3'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI research, retrieval, and synthesis work agent handoffs for missing context, ownership overlap, and unsafe next steps.'
_PLUGIN_TAGS = ['research', 'retrieval', 'agents', 'handoff', 'coordination', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'system_automation'
_PLUGIN_INTENDED_DOMAIN = 'AI research, retrieval, and synthesis work agent handoff quality and coordination'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Agent Handoff Checker Set 3'
        goal = 'Check AI research, retrieval, and synthesis work agent handoffs for missing context, ownership overlap, and unsafe next steps.'
        domain = 'AI research, retrieval, and synthesis work agent handoff quality and coordination'
