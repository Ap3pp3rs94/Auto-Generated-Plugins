...
Plugin: AI Sales Ops Prompt Clarity Auditor Set 3
Slug: ai_sales_ops_prompt_clarity_auditor_set_3
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Prompt Clarity Auditor Set 3'
_PLUGIN_SLUG: str = 'ai_sales_ops_prompt_clarity_auditor_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Clarity Auditor Set 3'
