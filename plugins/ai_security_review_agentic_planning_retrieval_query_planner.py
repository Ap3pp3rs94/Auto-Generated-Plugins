...
Plugin: AI Security Review Agentic Planning Retrieval Query Planner 000716
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
