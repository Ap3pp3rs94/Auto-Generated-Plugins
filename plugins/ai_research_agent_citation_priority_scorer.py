...
Capability: AI Research Agent Citation Priority Scorer 000117
...
_PLUGIN_NAME: str = 'AI Research Agent Citation Priority Scorer 000117'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Citation Priority Scorer 000117'
