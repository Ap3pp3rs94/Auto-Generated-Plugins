...
Plugin: AI Clinical Admin Instruction Hierarchy Checker Set 3
Slug: ai_clinical_admin_instruction_hierarchy_checker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Instruction Hierarchy Checker Set 3'
_PLUGIN_SLUG: str = 'ai_clinical_admin_instruction_hierarchy_checker_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Instruction Hierarchy Checker Set 3'
