...
Capability: AI Instruction Hierarchy Checker 002543
Slug: ai_instruction_hierarchy_checker_002543
"""
...
_PLUGIN_NAME: str = 'AI Instruction Hierarchy Checker 002543'
_PLUGIN_SLUG: str = 'ai_instruction_hierarchy_checker_002543'
...
_PLUGIN_MANIFEST = {'name': 'AI Instruction Hierarchy Checker 002543', 'slug': 'ai_instruction_hierarchy_checker_002543', 'goal': 'Check AI finance operations and risk review for safety controls instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.', 'category': 'ai_safety', 'tags': ['finance', 'risk', 'safety', 'controls', 'instructions', 'hierarchy', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI finance operations and risk review for safety controls instruction hierarchy and conflict safety', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Finance Ops Safety Controls.', 'Find conflicts between instruction layers.', 'Flag unsafe or impossible requirements.', 'Recommend a clarified instruction set.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 002543'
