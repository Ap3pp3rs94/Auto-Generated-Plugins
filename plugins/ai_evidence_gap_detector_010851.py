...
Capability: AI Evidence Gap Detector 010851
Slug: ai_evidence_gap_detector_010851
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 010851'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI cyber defense, alert triage, incident handling, and threat intelligence workflows for safety controls.'
        domain = 'AI cyber defense, alert triage, incident handling, and threat intelligence workflows for safety controls evidence gaps and retrieval readiness'
