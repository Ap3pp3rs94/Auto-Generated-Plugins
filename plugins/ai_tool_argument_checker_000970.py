...
Capability: AI Tool Argument Checker 000970
Slug: ai_tool_argument_checker_000970
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Argument Checker 000970'
        goal = 'Inspect tool arguments for AI legal review and compliance workflows for AI tool use for unsafe scope, missing bounds, or injected instructions.'
        domain = 'AI legal review and compliance workflows for AI tool use tool argument safety and sanitization'
