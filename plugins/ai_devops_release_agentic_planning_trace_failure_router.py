...
Capability: AI DevOps Release Agentic Planning Trace Failure Router 000667
Slug: ai_devops_release_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Agentic Planning Trace Failure Router 000667'
_PLUGIN_SLUG: str = 'ai_devops_release_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Agentic Planning Trace Failure Router 000667'
