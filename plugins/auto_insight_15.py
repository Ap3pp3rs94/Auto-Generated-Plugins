...
# Title      : AutoInsightSkill_15
# File       : auto_insight_15.py
...
_PLUGIN_NAME: str = 'AutoInsightSkill_15'
...
_PLUGIN_SLUG: str = 'auto_insight_15'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
