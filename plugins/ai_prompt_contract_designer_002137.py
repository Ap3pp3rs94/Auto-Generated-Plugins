...
Capability: AI Prompt Contract Designer 002137
Slug: ai_prompt_contract_designer_002137
"""
...
_PLUGIN_NAME: str = 'AI Prompt Contract Designer 002137'
_PLUGIN_SLUG: str = 'ai_prompt_contract_designer_002137'
_PLUGIN_CATEGORY: str = 'ai_prompting'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Design prompt contracts for AI finance operations and risk review for evaluation feedback with explicit inputs, outputs, constraints, and checks.'
_PLUGIN_TAGS = ['finance', 'risk', 'evaluation', 'feedback', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'enrichment'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review for evaluation feedback prompt contracts and structured instruction design'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Finance Ops Evaluation Feedback.', 'Turn loose Finance Ops Evaluation Feedback requests into strict prompt contracts.', 'Name required inputs, outputs, constraints, and validation checks.', 'Flag contract gaps before the prompt is sent to a model.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Prompt Contract Designer 002137', 'slug': 'ai_prompt_contract_designer_002137', 'goal': 'Design prompt contracts for AI finance operations and risk review for evaluation feedback with explicit inputs, outputs, constraints, and checks.', 'category': 'ai_prompting', 'tags': ['finance', 'risk', 'evaluation', 'feedback', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI finance operations and risk review for evaluation feedback prompt contracts and structured instruction design', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Finance Ops Evaluation Feedback.', 'Turn loose Finance Ops Evaluation Feedback requests into strict prompt contracts.', 'Name required inputs, outputs, constraints, and validation checks.', 'Flag contract gaps before the prompt is sent to a model.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Contract Designer 002137'
        goal = 'Design prompt contracts for AI finance operations and risk review for evaluation feedback with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI finance operations and risk review for evaluation feedback prompt contracts and structured instruction design'
