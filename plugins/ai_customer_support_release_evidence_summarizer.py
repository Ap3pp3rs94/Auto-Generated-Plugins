...
Plugin: AI Customer Support Release Evidence Summarizer
Slug: ai_customer_support_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_customer_support_release_evidence_summarizer'
...
_PLUGIN_TAGS = ['support', 'service', 'release', 'evidence', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Release Evidence Summarizer'
