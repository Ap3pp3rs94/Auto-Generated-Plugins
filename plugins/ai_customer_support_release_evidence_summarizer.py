...
Capability: AI Customer Support Release Evidence Summarizer 000138
...
_PLUGIN_NAME: str = 'AI Customer Support Release Evidence Summarizer 000138'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Release Evidence Summarizer 000138'
