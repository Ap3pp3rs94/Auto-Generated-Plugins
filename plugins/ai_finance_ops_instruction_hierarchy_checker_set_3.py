...
Plugin: AI Finance Ops Instruction Hierarchy Checker Set 3
Slug: ai_finance_ops_instruction_hierarchy_checker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Instruction Hierarchy Checker Set 3'
_PLUGIN_SLUG: str = 'ai_finance_ops_instruction_hierarchy_checker_set_3'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI finance operations and risk review instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['finance', 'risk', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Instruction Hierarchy Checker Set 3'
        goal = 'Check AI finance operations and risk review instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI finance operations and risk review instruction hierarchy and conflict safety'
