...
Plugin: AI Education Tutor Memory Update Recommender Set 2
Slug: ai_education_tutor_memory_update_recommender_set_2
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Memory Update Recommender Set 2'
_PLUGIN_SLUG: str = 'ai_education_tutor_memory_update_recommender_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Memory Update Recommender Set 2'
