...
# File       : deal_qualification_enhancement_3.py
# Description: Automatically enrich deal data to improve sales team productivity and forecasting accuracy.
# Goal       : Automatically enrich deal data to improve sales team productivity and forecasting accuracy.
# Category   : sales
...
_PLUGIN_GOAL: str = 'Automatically enrich deal data to improve sales team productivity and forecasting accuracy.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['deal', 'qualification', 'enhancement']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_qualification_enhancement_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
