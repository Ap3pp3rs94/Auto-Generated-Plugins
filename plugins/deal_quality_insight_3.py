...
# File       : deal_quality_insight_3.py
# Description: Identifies key factors influencing deal quality and provides actionable recommendations for improvement.
# Goal       : Identifies key factors influencing deal quality and provides actionable recommendations for improvement.
# Category   : sales
...
_PLUGIN_GOAL: str = 'Identifies key factors influencing deal quality and provides actionable recommendations for improvement.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['deal', 'quality', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_quality_insight_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
