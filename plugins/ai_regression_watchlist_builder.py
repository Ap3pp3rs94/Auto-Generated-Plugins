...
Plugin: AI Regression Watchlist Builder
...
_PLUGIN_NAME: str = 'AI Regression Watchlist Builder'
...
_PLUGIN_TAGS = ['ai', 'regression', 'tests', 'watchlist', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Regression Watchlist Builder'
