...
Plugin: AI Coding Agent Context Noise Filter Set 2
Slug: ai_coding_agent_context_noise_filter_set_2
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Context Noise Filter Set 2'
_PLUGIN_SLUG: str = 'ai_coding_agent_context_noise_filter_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Context Noise Filter Set 2'
