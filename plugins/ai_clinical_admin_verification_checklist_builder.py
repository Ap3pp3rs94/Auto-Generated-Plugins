...
Capability: AI Clinical Admin Verification Checklist Builder 000182
...
_PLUGIN_NAME: str = 'AI Clinical Admin Verification Checklist Builder 000182'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Verification Checklist Builder 000182'
