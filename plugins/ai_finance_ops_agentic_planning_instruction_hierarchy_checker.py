...
Plugin: AI Finance Ops Agentic Planning Instruction Hierarchy Checker 000623
Slug: ai_finance_ops_agentic_planning_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Agentic Planning Instruction Hierarchy Checker 000623'
_PLUGIN_SLUG: str = 'ai_finance_ops_agentic_planning_instruction_hierarchy_checker'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI finance operations and risk review for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI finance operations and risk review for agentic planning instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Agentic Planning Instruction Hierarchy Checker 000623'
        goal = 'Check AI finance operations and risk review for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI finance operations and risk review for agentic planning instruction hierarchy and conflict safety'
