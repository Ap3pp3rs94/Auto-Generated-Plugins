...
# File       : sales_opportunity_prioritization_3.py
# Description: Prioritize sales opportunities based on likelihood of conversion and revenue potential.
# Goal       : Prioritize sales opportunities based on likelihood of conversion and revenue potential.
...
_PLUGIN_GOAL: str = 'Prioritize sales opportunities based on likelihood of conversion and revenue potential.'
_PLUGIN_CATEGORY: str = 'sales | marketing'
_PLUGIN_TAGS = ['opportunity', 'prioritization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_opportunity_prioritization_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
