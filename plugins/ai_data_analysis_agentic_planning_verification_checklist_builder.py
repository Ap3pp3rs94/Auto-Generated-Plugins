...
Capability: AI Data Analysis Agentic Planning Verification Checklist Builder 000686
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
