...
Capability: AI Capability Factory Instruction Hierarchy Checker 000455
...
_PLUGIN_NAME: str = 'AI Capability Factory Instruction Hierarchy Checker 000455'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Instruction Hierarchy Checker 000455'
