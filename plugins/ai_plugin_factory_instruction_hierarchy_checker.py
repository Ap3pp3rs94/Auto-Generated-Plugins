...
Plugin: AI Capability Factory Instruction Hierarchy Checker
Slug: ai_plugin_factory_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_plugin_factory_instruction_hierarchy_checker'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI capability factory and generated module operations instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['capabilities', 'factory', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI capability factory and generated module operations instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Instruction Hierarchy Checker'
        goal = 'Check AI capability factory and generated module operations instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI capability factory and generated module operations instruction hierarchy and conflict safety'
