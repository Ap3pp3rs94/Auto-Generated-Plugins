...
Capability: AI Research Agent Agentic Planning Verification Checklist Builder 000494
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
