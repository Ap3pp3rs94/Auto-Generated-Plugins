...
Capability: AI Instruction Hierarchy Checker 007343
Slug: ai_instruction_hierarchy_checker_007343
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 007343'
        goal = 'Check AI operations monitoring and incident response for knowledge graph work instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI operations monitoring and incident response for knowledge graph work instruction hierarchy and conflict safety'
