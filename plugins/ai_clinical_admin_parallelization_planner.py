...
Capability: AI Clinical Admin Parallelization Planner 000176
...
_PLUGIN_NAME: str = 'AI Clinical Admin Parallelization Planner 000176'
...
_PLUGIN_MANIFEST = {'name': 'AI Clinical Admin Parallelization Planner 000176', 'slug': 'ai_clinical_admin_parallelization_planner', 'goal': 'Identify safe parallel work packets for AI clinical administration and healthcare operations without duplicating or blocking work.', 'category': 'ai_agents', 'tags': ['healthcare', 'clinical', 'agents', 'parallel', 'planning', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI clinical administration and healthcare operations parallel AI workflow planning', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Clinical Admin.', 'Split work into blocking and parallelizable paths.', 'Detect dependency conflicts before delegation.', 'Create bounded sidecar tasks with merge checkpoints.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Parallelization Planner 000176'
