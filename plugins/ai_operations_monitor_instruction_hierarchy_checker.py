...
Plugin: AI Operations Monitor Instruction Hierarchy Checker
Slug: ai_operations_monitor_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_operations_monitor_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Instruction Hierarchy Checker'
