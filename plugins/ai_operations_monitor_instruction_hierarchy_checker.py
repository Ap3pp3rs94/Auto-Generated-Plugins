...
Capability: AI Operations Monitor Instruction Hierarchy Checker 000431
...
_PLUGIN_NAME: str = 'AI Operations Monitor Instruction Hierarchy Checker 000431'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Instruction Hierarchy Checker 000431'
