...
Plugin: AI Finance Ops Data Contract Validator
Slug: ai_finance_ops_data_contract_validator
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Data Contract Validator'
_PLUGIN_SLUG: str = 'ai_finance_ops_data_contract_validator'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Data Contract Validator'
