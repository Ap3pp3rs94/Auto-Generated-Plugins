...
# Title      : Sales Performance Benchmarking
# File       : sales_performance_benchmark.py
# Description: Provides insights into sales team performance and identifies areas for improvement
# Goal       : Provides insights into sales team performance and identifies areas for improvement
# Category   : analysis
...
_PLUGIN_NAME: str = 'Sales Performance Benchmarking'
_PLUGIN_GOAL: str = 'Provides insights into sales team performance and identifies areas for improvement'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['benchmark', 'performance']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_benchmark'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
