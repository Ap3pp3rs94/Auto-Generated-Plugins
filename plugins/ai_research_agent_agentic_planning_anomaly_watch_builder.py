...
Plugin: AI Research Agent Agentic Planning Anomaly Watch Builder 000496
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
