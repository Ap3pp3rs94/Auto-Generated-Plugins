...
Capability: AI Response Merge Planner 000028
Slug: ai_response_merge_planner_000028
"""
...
_PLUGIN_NAME: str = 'AI Response Merge Planner 000028'
_PLUGIN_SLUG: str = 'ai_response_merge_planner_000028'
...
_PLUGIN_USE_CASES = ['Rank candidate responses and identify the best base.', 'Preserve unique useful details from lower-ranked responses.', 'Create a final merge checklist against a rubric.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Response Merge Planner 000028', 'slug': 'ai_response_merge_planner_000028', 'goal': 'Plan how to merge the strongest parts of multiple AI responses without losing requirements.', 'category': 'ai_evaluation', 'tags': ['ai', 'comparison', 'merge', 'rubric', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI response comparison and synthesis planning', 'owner_id': None, 'use_cases': ['Rank candidate responses and identify the best base.', 'Preserve unique useful details from lower-ranked responses.', 'Create a final merge checklist against a rubric.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Merge Planner 000028'
