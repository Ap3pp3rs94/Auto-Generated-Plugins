...
Capability: AI User Clarification Question Builder 000062
Slug: ai_user_clarification_question_builder_000062
"""
...
_PLUGIN_NAME: str = 'AI User Clarification Question Builder 000062'
_PLUGIN_SLUG: str = 'ai_user_clarification_question_builder_000062'
...
_PLUGIN_MANIFEST = {'name': 'AI User Clarification Question Builder 000062', 'slug': 'ai_user_clarification_question_builder_000062', 'goal': 'Generate the smallest useful set of clarification questions when an AI task is under-specified.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'clarification', 'requirements', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI clarification strategy and missing input collection', 'owner_id': None, 'use_cases': ['Ask only questions that unblock execution.', 'Avoid unnecessary clarification when assumptions are safe.', 'Group questions by objective, constraints, data, and output format.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI User Clarification Question Builder 000062'
