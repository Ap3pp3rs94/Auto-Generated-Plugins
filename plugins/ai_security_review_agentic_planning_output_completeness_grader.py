...
Plugin: AI Security Review Agentic Planning Output Completeness Grader 000707
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
