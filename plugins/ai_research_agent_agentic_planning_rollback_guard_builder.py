...
Capability: AI Research Agent Agentic Planning Rollback Guard Builder 000495
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'rollback', 'safety', 'release', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
