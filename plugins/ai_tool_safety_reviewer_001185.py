...
Capability: AI Tool Safety Reviewer 001185
Slug: ai_tool_safety_reviewer_001185
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 001185'
        goal = 'Review proposed tool use for AI operations monitoring and incident response for AI tool use for side effects, permissions, and rollback needs.'
        domain = 'AI operations monitoring and incident response for AI tool use AI tool safety and approval control'
