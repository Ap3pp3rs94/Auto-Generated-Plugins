...
Capability: AI Education Tutor Agentic Planning Verification Checklist Builder 000638
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
