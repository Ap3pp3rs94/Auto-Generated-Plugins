...
Capability: AI Prompt Clarity Auditor 004610
Slug: ai_prompt_clarity_auditor_004610
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Clarity Auditor 004610'
        goal = 'Audit prompts for AI personal productivity and scheduling workflows for documentation and knowledge capture and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI personal productivity and scheduling workflows for documentation and knowledge capture prompt clarity and ambiguity reduction'
