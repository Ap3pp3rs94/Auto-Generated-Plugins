...
Capability: AI Personal Assistant Instruction Hierarchy Checker 000407
...
_PLUGIN_NAME: str = 'AI Personal Assistant Instruction Hierarchy Checker 000407'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Instruction Hierarchy Checker 000407'
