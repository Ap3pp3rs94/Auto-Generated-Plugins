...
Plugin: AI Personal Assistant Instruction Hierarchy Checker
Slug: ai_personal_assistant_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_personal_assistant_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Instruction Hierarchy Checker'
