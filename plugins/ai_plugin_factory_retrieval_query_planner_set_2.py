...
Plugin: AI Capability Factory Retrieval Query Planner Set 2
Slug: ai_plugin_factory_retrieval_query_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Retrieval Query Planner Set 2'
_PLUGIN_SLUG: str = 'ai_plugin_factory_retrieval_query_planner_set_2'
...
_PLUGIN_TAGS = ['capabilities', 'factory', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Retrieval Query Planner Set 2'
