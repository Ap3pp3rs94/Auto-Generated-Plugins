...
Capability: AI Personal Assistant Response Action Planner 000396
...
_PLUGIN_NAME: str = 'AI Personal Assistant Response Action Planner 000396'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_MANIFEST = {'name': 'AI Personal Assistant Response Action Planner 000396', 'slug': 'ai_personal_assistant_response_action_planner', 'goal': 'Convert AI personal productivity and scheduling workflows AI responses into concrete next actions with owners, checks, and risks.', 'category': 'ai_evaluation', 'tags': ['productivity', 'assistant', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI personal productivity and scheduling workflows response actionability and next-step planning', 'owner_id': None, 'use_cases': ['Apply this capability to the distinct use case: Personal Assistant.', 'Find vague advice that needs executable next steps.', 'Create action items with checks and risk notes.', 'Score whether the response is ready to act on.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Response Action Planner 000396'
