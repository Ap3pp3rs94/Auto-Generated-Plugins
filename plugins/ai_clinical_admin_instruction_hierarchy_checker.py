...
Capability: AI Clinical Admin Instruction Hierarchy Checker 000191
...
_PLUGIN_NAME: str = 'AI Clinical Admin Instruction Hierarchy Checker 000191'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Instruction Hierarchy Checker 000191'
