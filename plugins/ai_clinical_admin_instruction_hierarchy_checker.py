...
Plugin: AI Clinical Admin Instruction Hierarchy Checker
Slug: ai_clinical_admin_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_clinical_admin_instruction_hierarchy_checker'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Instruction Hierarchy Checker'
