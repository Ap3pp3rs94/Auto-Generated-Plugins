...
Plugin: AI Product Manager Anomaly Watch Builder
...
_PLUGIN_NAME: str = 'AI Product Manager Anomaly Watch Builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Anomaly Watch Builder'
