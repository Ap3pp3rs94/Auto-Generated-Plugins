...
Plugin: AI DevOps Release Agentic Planning Output Completeness Grader 000659
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
