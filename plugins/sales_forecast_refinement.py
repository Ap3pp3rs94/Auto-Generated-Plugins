...
# Title      : Sales Forecast Refiner
# File       : sales_forecast_refinement.py
# Description: Refines sales forecasts by identifying and adjusting for biases in historical data.
# Goal       : Refines sales forecasts by identifying and adjusting for biases in historical data.
# Category   : analysis | automation
# Tags       : forecasting, bias, data refinement
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Forecast Refiner'
_PLUGIN_GOAL: str = 'Refines sales forecasts by identifying and adjusting for biases in historical data.'
_PLUGIN_CATEGORY: str = 'analysis | automation'
_PLUGIN_TAGS = ['forecasting', 'bias', 'data refinement']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_forecast_refinement'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
