...
Capability: AI Sales Ops Tool Safety Reviewer 000153
...
_PLUGIN_NAME: str = 'AI Sales Ops Tool Safety Reviewer 000153'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Tool Safety Reviewer 000153'
