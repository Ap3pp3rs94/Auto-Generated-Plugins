...
# Title      : Deal Performance Forecaster
# File       : deal_performance_forecast.py
# Description: Forecast deal performance based on historical data and market trends.
# Goal       : Forecast deal performance based on historical data and market trends.
# Category   : sales | analysis
# Tags       : forecasting, deal_stage, sales_pipeline
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Performance Forecaster'
_PLUGIN_GOAL: str = 'Forecast deal performance based on historical data and market trends.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['forecasting', 'deal_stage', 'sales_pipeline']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_forecast'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
