...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manifest = {'name': 'AI Capability Spec Architect 000041', 'slug': 'ai_plugin_spec_architect', 'goal': 'Design precise, non-duplicate capability specs for new AI capabilities before generation starts.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'specs', 'factory', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI capability specification design and capability boundaries', 'owner_id': 'francis-factory', 'use_cases': ['Turn a loose capability idea into a complete generation blueprint.', 'Define capability boundaries so the module does not duplicate existing capabilities.', 'List required inputs, outputs, acceptance criteria, and quality signals before build.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'plugin_spec_architect_profile', 'generation_note': 'capability profile registry override'}
