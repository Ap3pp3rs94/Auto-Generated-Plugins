...
Plugin: AI Clinical Admin Agentic Planning Output Completeness Grader 000563
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
