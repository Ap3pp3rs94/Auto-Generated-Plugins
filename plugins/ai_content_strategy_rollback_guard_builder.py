...
Capability: AI Content Strategy Rollback Guard Builder 000375
...
_PLUGIN_NAME: str = 'AI Content Strategy Rollback Guard Builder 000375'
...
_PLUGIN_TAGS = ['content', 'strategy', 'rollback', 'safety', 'release', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Rollback Guard Builder 000375'
