...
Capability: AI Context Noise Filter 010445
Slug: ai_context_noise_filter_010445
"""
...
_PLUGIN_NAME: str = 'AI Context Noise Filter 010445'
_PLUGIN_SLUG: str = 'ai_context_noise_filter_010445'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Filter noisy or redundant context before model calls for AI fitness coaching, wellness planning, habit review, and progress workflows for safety controls.'
_PLUGIN_TAGS = ['fitness', 'wellness', 'coaching', 'safety', 'controls', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI fitness coaching, wellness planning, habit review, and progress workflows for safety controls context filtering and token-budget control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 010445'
        goal = 'Filter noisy or redundant context before model calls for AI fitness coaching, wellness planning, habit review, and progress workflows for safety controls.'
        domain = 'AI fitness coaching, wellness planning, habit review, and progress workflows for safety controls context filtering and token-budget control'
