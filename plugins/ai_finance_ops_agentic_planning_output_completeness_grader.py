...
Plugin: AI Finance Ops Agentic Planning Output Completeness Grader 000611
...
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
