...
Capability: AI Data Analysis Citation Priority Scorer 000309
...
_PLUGIN_NAME: str = 'AI Data Analysis Citation Priority Scorer 000309'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Citation Priority Scorer 000309'
