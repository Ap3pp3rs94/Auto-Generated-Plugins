...
Plugin: AI Operations Monitor Tool Argument Checker
Slug: ai_operations_monitor_tool_argument_checker
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Tool Argument Checker'
_PLUGIN_SLUG: str = 'ai_operations_monitor_tool_argument_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Tool Argument Checker'
