...
Capability: AI Agent Handoff Checker 006559
Slug: ai_agent_handoff_checker_006559
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Agent Handoff Checker 006559'
        goal = 'Check AI operations monitoring and incident response for task decomposition agent handoffs for missing context, ownership overlap, and unsafe next steps.'
        domain = 'AI operations monitoring and incident response for task decomposition agent handoff quality and coordination'
