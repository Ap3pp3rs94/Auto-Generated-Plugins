...
Capability: AI Output Completeness Grader 000587
Slug: ai_output_completeness_grader_000587
"""
...
_PLUGIN_NAME: str = 'AI Output Completeness Grader 000587'
_PLUGIN_SLUG: str = 'ai_output_completeness_grader_000587'
...
_PLUGIN_MANIFEST = {'name': 'AI Output Completeness Grader 000587', 'slug': 'ai_output_completeness_grader_000587', 'goal': 'Grade AI legal review and compliance workflows for agentic planning AI outputs for completeness against task requirements and acceptance criteria.', 'category': 'ai_evaluation', 'tags': ['legal', 'compliance', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI legal review and compliance workflows for agentic planning output completeness and acceptance scoring', 'owner_id': None, 'use_cases': ['Apply this capability to the distinct use case: Legal Review Agentic Planning.', 'Identify missing sections or unmet requirements.', 'Score completeness using task-specific signals.', 'Recommend edits that close blocking gaps.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 000587'
