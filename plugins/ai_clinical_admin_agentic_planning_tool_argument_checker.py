...
Capability: AI Clinical Admin Agentic Planning Tool Argument Checker 000562
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
