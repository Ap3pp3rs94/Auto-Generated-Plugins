...
Plugin: AI DevOps Release Agentic Planning Retrieval Query Planner 000668
...
_PLUGIN_TAGS = ['devops', 'release', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
