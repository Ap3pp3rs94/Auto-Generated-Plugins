...
Capability: AI Retrieval Query Planner 002876
Slug: ai_retrieval_query_planner_002876
"""
...
_PLUGIN_NAME: str = 'AI Retrieval Query Planner 002876'
_PLUGIN_SLUG: str = 'ai_retrieval_query_planner_002876'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002876'
