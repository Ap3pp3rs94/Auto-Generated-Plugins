...
Plugin: AI Personal Assistant Citation Priority Scorer
Slug: ai_personal_assistant_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_personal_assistant_citation_priority_scorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Citation Priority Scorer'
