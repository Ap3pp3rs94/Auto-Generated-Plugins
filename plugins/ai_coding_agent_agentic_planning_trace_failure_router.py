...
Plugin: AI Coding Agent Agentic Planning Trace Failure Router 000475
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Trace Failure Router 000475'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Trace Failure Router 000475'
