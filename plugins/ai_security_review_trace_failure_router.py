...
Capability: AI Security Review Trace Failure Router 000331
...
_PLUGIN_NAME: str = 'AI Security Review Trace Failure Router 000331'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Trace Failure Router 000331'
