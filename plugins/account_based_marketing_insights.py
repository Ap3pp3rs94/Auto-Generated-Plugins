...
# Title      : Account-Based Marketing Insights
# File       : account_based_marketing_insights.py
# Description: Identify high-value customer segments and tailor marketing efforts for personalized engagement
# Goal       : Identify high-value customer segments and tailor marketing efforts for personalized engagement
# Category   : marketing
# Tags       : personalization, customer segmentation
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Account-Based Marketing Insights'
_PLUGIN_GOAL: str = 'Identify high-value customer segments and tailor marketing efforts for personalized engagement'
_PLUGIN_CATEGORY: str = 'marketing'
_PLUGIN_TAGS = ['personalization', 'customer segmentation']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'account_based_marketing_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
