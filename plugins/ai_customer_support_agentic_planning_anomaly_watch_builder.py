...
Plugin: AI Customer Support Agentic Planning Anomaly Watch Builder 000520
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
