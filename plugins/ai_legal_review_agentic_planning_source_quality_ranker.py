...
Plugin: AI Legal Review Agentic Planning Source Quality Ranker 000580
Slug: ai_legal_review_agentic_planning_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Agentic Planning Source Quality Ranker 000580'
_PLUGIN_SLUG: str = 'ai_legal_review_agentic_planning_source_quality_ranker'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Rank provided sources for AI legal review and compliance workflows for agentic planning by trust, relevance, freshness, and answer usefulness.'
_PLUGIN_TAGS = ['legal', 'compliance', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI legal review and compliance workflows for agentic planning source quality and grounded answer preparation'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Agentic Planning Source Quality Ranker 000580'
        goal = 'Rank provided sources for AI legal review and compliance workflows for agentic planning by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI legal review and compliance workflows for agentic planning source quality and grounded answer preparation'
