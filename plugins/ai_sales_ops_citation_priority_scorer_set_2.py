...
Plugin: AI Sales Ops Citation Priority Scorer Set 2
Slug: ai_sales_ops_citation_priority_scorer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Citation Priority Scorer Set 2'
_PLUGIN_SLUG: str = 'ai_sales_ops_citation_priority_scorer_set_2'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI sales operations and account workflows claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['sales', 'business', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI sales operations and account workflows citation priority and factual-risk scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Citation Priority Scorer Set 2'
        goal = 'Score which AI sales operations and account workflows claims most urgently need citations or uncertainty language.'
        domain = 'AI sales operations and account workflows citation priority and factual-risk scoring'
