...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        manifest = {'name': 'AI Release Readiness Scorecard 000072', 'slug': 'ai_release_readiness_scorecard', 'goal': 'Score whether an AI capability module is ready to publish based on quality, uniqueness, and validation evidence.', 'category': 'ai_plugin_factory', 'tags': ['ai', 'capabilities', 'release', 'scorecard', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI capability release readiness and GitHub publishing quality', 'owner_id': 'francis-factory', 'use_cases': ['Score validation, semantic depth, uniqueness, and documentation readiness.', 'Flag release blockers before commit and push.', 'Recommend publish, repair, or discard with specific evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'logic_profile_id': 'release_readiness_scorecard_profile', 'generation_note': 'capability profile registry override'}
