...
Plugin: AI Capability Factory Capability Overlap Checker
Slug: ai_plugin_factory_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_plugin_factory_capability_overlap_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Capability Overlap Checker'
