...
Capability: AI Output Completeness Grader 000779
Slug: ai_output_completeness_grader_000779
"""
...
_PLUGIN_NAME: str = 'AI Output Completeness Grader 000779'
_PLUGIN_SLUG: str = 'ai_output_completeness_grader_000779'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 000779'
