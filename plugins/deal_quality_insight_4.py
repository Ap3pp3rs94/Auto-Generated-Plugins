...
# File       : deal_quality_insight_4.py
# Description: Provides actionable insights on deal quality to inform sales strategies and optimization efforts.
# Goal       : Provides actionable insights on deal quality to inform sales strategies and optimization efforts.
# Category   : analysis
# Tags       : quality, insights
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides actionable insights on deal quality to inform sales strategies and optimization efforts.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['quality', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_quality_insight_4'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
