...
Plugin: AI Customer Support Prompt Contract Designer
Slug: ai_customer_support_prompt_contract_designer
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_customer_support_prompt_contract_designer'
...
_PLUGIN_TAGS = ['support', 'service', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Prompt Contract Designer'
