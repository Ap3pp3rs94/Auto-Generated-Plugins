...
Capability: AI Customer Support Prompt Contract Designer 000121
...
_PLUGIN_NAME: str = 'AI Customer Support Prompt Contract Designer 000121'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Prompt Contract Designer 000121'
