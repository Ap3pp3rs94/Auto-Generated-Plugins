...
Plugin: AI Security Review Output Completeness Grader
...
_PLUGIN_NAME: str = 'AI Security Review Output Completeness Grader'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Output Completeness Grader'
