...
Capability: AI Education Tutor Trace Failure Router 000259
...
_PLUGIN_NAME: str = 'AI Education Tutor Trace Failure Router 000259'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Trace Failure Router 000259'
