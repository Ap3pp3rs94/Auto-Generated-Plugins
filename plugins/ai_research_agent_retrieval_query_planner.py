...
Plugin: AI Research Agent Retrieval Query Planner
...
_PLUGIN_NAME: str = 'AI Research Agent Retrieval Query Planner'
...
_PLUGIN_TAGS = ['research', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Retrieval Query Planner'
