...
Capability: AI Research Agent Retrieval Query Planner 000116
Slug: ai_research_agent_retrieval_query_planner
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Retrieval Query Planner 000116'
_PLUGIN_SLUG: str = 'ai_research_agent_retrieval_query_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Retrieval Query Planner 000116'
