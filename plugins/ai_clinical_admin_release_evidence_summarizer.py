...
Capability: AI Clinical Admin Release Evidence Summarizer 000186
...
_PLUGIN_NAME: str = 'AI Clinical Admin Release Evidence Summarizer 000186'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Release Evidence Summarizer 000186'
