...
Plugin: AI Clinical Admin Release Evidence Summarizer
Slug: ai_clinical_admin_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_clinical_admin_release_evidence_summarizer'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'release', 'evidence', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Release Evidence Summarizer'
