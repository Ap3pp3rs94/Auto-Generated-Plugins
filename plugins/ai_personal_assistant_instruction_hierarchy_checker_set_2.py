...
Plugin: AI Personal Assistant Instruction Hierarchy Checker Set 2
Slug: ai_personal_assistant_instruction_hierarchy_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Instruction Hierarchy Checker Set 2'
_PLUGIN_SLUG: str = 'ai_personal_assistant_instruction_hierarchy_checker_set_2'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI personal productivity and scheduling workflows instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['productivity', 'assistant', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI personal productivity and scheduling workflows instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Instruction Hierarchy Checker Set 2'
        goal = 'Check AI personal productivity and scheduling workflows instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI personal productivity and scheduling workflows instruction hierarchy and conflict safety'
