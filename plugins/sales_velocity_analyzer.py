...
# Title      : Sales Velocity Analyzer
# File       : sales_velocity_analyzer.py
# Description: Auto-regenerated plugin for sales_velocity_analyzer
# Goal       : Auto-regenerated plugin for sales_velocity_analyzer
# Category   : analysis
...
_PLUGIN_NAME: str = 'Sales Velocity Analyzer'
_PLUGIN_GOAL: str = 'Auto-regenerated plugin for sales_velocity_analyzer'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['regenerated', 'fix']
_PLUGIN_VERSION: str = '0.2.0'
_PLUGIN_SLUG: str = 'sales_velocity_analyzer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
