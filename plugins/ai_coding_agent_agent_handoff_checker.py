...
Plugin: AI Coding Agent Agent Handoff Checker
Slug: ai_coding_agent_agent_handoff_checker
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agent Handoff Checker'
_PLUGIN_SLUG: str = 'ai_coding_agent_agent_handoff_checker'
...
_PLUGIN_TAGS = ['coding', 'agents', 'handoff', 'coordination', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agent Handoff Checker'
