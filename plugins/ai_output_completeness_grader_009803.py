...
Capability: AI Output Completeness Grader 009803
Slug: ai_output_completeness_grader_009803
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 009803'
        goal = 'Grade AI capability factory and generated module operations for safety controls AI outputs for completeness against task requirements and acceptance criteria.'
        domain = 'AI capability factory and generated module operations for safety controls output completeness and acceptance scoring'
