...
Plugin: AI Security Review Evidence Gap Detector Set 2
Slug: ai_security_review_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI security review and threat analysis.'
        domain = 'AI security review and threat analysis evidence gaps and retrieval readiness'
