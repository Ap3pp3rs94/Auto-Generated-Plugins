...
Plugin: AI DevOps Release Source Quality Ranker
Slug: ai_devops_release_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_devops_release_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Source Quality Ranker'
