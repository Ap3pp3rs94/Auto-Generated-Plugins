...
Capability: AI DevOps Release Source Quality Ranker 000268
...
_PLUGIN_NAME: str = 'AI DevOps Release Source Quality Ranker 000268'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Source Quality Ranker 000268'
