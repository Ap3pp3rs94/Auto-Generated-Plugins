...
Plugin: AI DevOps Release Prompt Contract Designer Set 2
Slug: ai_devops_release_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI DevOps release and infrastructure workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI DevOps release and infrastructure workflows prompt contracts and structured instruction design'
