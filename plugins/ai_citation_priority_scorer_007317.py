...
Capability: AI Citation Priority Scorer 007317
Slug: ai_citation_priority_scorer_007317
"""
...
_PLUGIN_NAME: str = 'AI Citation Priority Scorer 007317'
_PLUGIN_SLUG: str = 'ai_citation_priority_scorer_007317'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI personal productivity and scheduling workflows for knowledge graph work claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['productivity', 'assistant', 'knowledge', 'graph', 'citations', 'claims', 'risk', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI personal productivity and scheduling workflows for knowledge graph work citation priority and factual-risk scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 007317'
        goal = 'Score which AI personal productivity and scheduling workflows for knowledge graph work claims most urgently need citations or uncertainty language.'
        domain = 'AI personal productivity and scheduling workflows for knowledge graph work citation priority and factual-risk scoring'
