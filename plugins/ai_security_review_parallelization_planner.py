...
Capability: AI Security Review Parallelization Planner 000320
...
_PLUGIN_NAME: str = 'AI Security Review Parallelization Planner 000320'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Parallelization Planner 000320'
