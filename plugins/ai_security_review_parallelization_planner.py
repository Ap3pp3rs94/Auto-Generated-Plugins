...
Plugin: AI Security Review Parallelization Planner
Slug: ai_security_review_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI Security Review Parallelization Planner'
_PLUGIN_SLUG: str = 'ai_security_review_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Parallelization Planner'
