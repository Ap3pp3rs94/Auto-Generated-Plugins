...
Plugin: AI Education Tutor Instruction Hierarchy Checker
...
_PLUGIN_NAME: str = 'AI Education Tutor Instruction Hierarchy Checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Instruction Hierarchy Checker'
