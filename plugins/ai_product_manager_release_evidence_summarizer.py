...
Plugin: AI Product Manager Release Evidence Summarizer
Slug: ai_product_manager_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Product Manager Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_product_manager_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Release Evidence Summarizer'
