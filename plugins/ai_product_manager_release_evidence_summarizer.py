...
Capability: AI Product Manager Release Evidence Summarizer 000354
...
_PLUGIN_NAME: str = 'AI Product Manager Release Evidence Summarizer 000354'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Release Evidence Summarizer 000354'
