...
Plugin: AI Instruction Conflict Detector 000013
...
_PLUGIN_NAME: str = 'AI Instruction Conflict Detector 000013'
_PLUGIN_SLUG: str = 'ai_instruction_conflict_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Conflict Detector 000013'
