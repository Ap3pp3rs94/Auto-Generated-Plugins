...
Plugin: AI Instruction Conflict Detector
...
_PLUGIN_NAME: str = 'AI Instruction Conflict Detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Conflict Detector'
        ...
        generation_note = 'instruction conflict semantic evidence fix'
