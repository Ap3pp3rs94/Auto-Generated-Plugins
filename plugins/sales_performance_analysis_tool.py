...
# File       : sales_performance_analysis_tool.py
# Description: Provides actionable insights on sales performance by identifying trends and areas for improvement.
# Goal       : Provides actionable insights on sales performance by identifying trends and areas for improvement.
# Category   : analysis
# Tags       : sales, performance, insights
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Performance Analyzer'
_PLUGIN_GOAL: str = 'Provides actionable insights on sales performance by identifying trends and areas for improvement.'
_PLUGIN_CATEGORY: str = 'analysis'
_PLUGIN_TAGS = ['sales', 'performance', 'insights']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_performance_analysis_tool'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
