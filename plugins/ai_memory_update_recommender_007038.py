...
Capability: AI Memory Update Recommender 007038
Slug: ai_memory_update_recommender_007038
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Update Recommender 007038'
        goal = 'Recommend durable memory updates from AI customer support and service workflows for knowledge graph work sessions without saving transient chatter.'
        domain = 'AI customer support and service workflows for knowledge graph work durable memory and preference extraction'
