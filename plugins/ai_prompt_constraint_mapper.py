...
_PLUGIN_MANIFEST = {'name': 'AI Prompt Constraint Mapper 000025', 'slug': 'ai_prompt_constraint_mapper', 'goal': 'Map prompt requirements into explicit constraints, missing inputs, and rewrite targets.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'constraints', 'requirements', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI prompt constraints and requirement mapping', 'owner_id': 'francis-factory', 'use_cases': ['Identify hidden or missing constraints in a prompt.', 'Convert vague prompt language into concrete requirements.', 'Recommend prompt rewrites that preserve constraints.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
