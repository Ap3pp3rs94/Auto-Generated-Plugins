...
Capability: AI Source Quality Ranker 008836
Slug: ai_source_quality_ranker_008836
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 008836'
        goal = 'Rank provided sources for AI personal productivity and scheduling workflows for AI tool use for detecting signals by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI personal productivity and scheduling workflows for AI tool use for detecting signals source quality and grounded answer preparation'
