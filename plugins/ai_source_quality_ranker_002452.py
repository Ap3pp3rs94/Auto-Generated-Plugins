...
Capability: AI Source Quality Ranker 002452
Slug: ai_source_quality_ranker_002452
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 002452'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_002452'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 002452'
