...
Plugin: AI Red Team Prompt Probe Builder
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Red Team Prompt Probe Builder'
        goal = 'Create adversarial prompt probes that test instruction hierarchy, safety, and data leakage boundaries.'
        domain = 'AI red-team prompt testing and safety probing'
        capability_type = 'data_insight'
        logic_profile_id = 'red_team_prompt_probe_builder_profile'
