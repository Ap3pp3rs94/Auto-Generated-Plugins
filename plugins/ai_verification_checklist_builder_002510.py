...
Capability: AI Verification Checklist Builder 002510
Slug: ai_verification_checklist_builder_002510
"""
...
_PLUGIN_NAME: str = 'AI Verification Checklist Builder 002510'
_PLUGIN_SLUG: str = 'ai_verification_checklist_builder_002510'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 002510'
