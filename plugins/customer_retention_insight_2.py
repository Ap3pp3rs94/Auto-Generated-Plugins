...
# File       : customer_retention_insight_2.py
# Description: Identify and prioritize customers at risk of churn, enabling proactive retention strategies.
# Goal       : Identify and prioritize customers at risk of churn, enabling proactive retention strategies.
...
_PLUGIN_GOAL: str = 'Identify and prioritize customers at risk of churn, enabling proactive retention strategies.'
_PLUGIN_CATEGORY: str = 'sales | marketing | support | analysis'
_PLUGIN_TAGS = ['customer', 'retention', 'churn']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'customer_retention_insight_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
