...
Capability: AI Citation Priority Scorer 001197
Slug: ai_citation_priority_scorer_001197
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 001197'
        goal = 'Score which AI operations monitoring and incident response for AI tool use claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for AI tool use citation priority and factual-risk scoring'
