...
Capability: AI Personal Assistant Verification Checklist Builder 000398
...
_PLUGIN_NAME: str = 'AI Personal Assistant Verification Checklist Builder 000398'
...
_PLUGIN_TAGS = ['productivity', 'assistant', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
_PLUGIN_MANIFEST = {'name': 'AI Personal Assistant Verification Checklist Builder 000398', 'slug': 'ai_personal_assistant_verification_checklist_builder', 'goal': 'Build verification checklists for AI personal productivity and scheduling workflows AI artifacts before release or handoff.', 'category': 'ai_evaluation', 'tags': ['productivity', 'assistant', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'system_automation', 'intended_domain': 'AI personal productivity and scheduling workflows verification planning and acceptance checks', 'owner_id': None, 'use_cases': ['Apply this capability to the distinct use case: Personal Assistant.', 'Turn acceptance criteria into concrete checks.', 'Separate automated checks from human review.', 'Record evidence needed before publish or handoff.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Verification Checklist Builder 000398'
