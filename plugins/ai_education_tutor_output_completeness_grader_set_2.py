...
Plugin: AI Education Tutor Output Completeness Grader Set 2
Slug: ai_education_tutor_output_completeness_grader_set_2
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Output Completeness Grader Set 2'
_PLUGIN_SLUG: str = 'ai_education_tutor_output_completeness_grader_set_2'
...
_PLUGIN_TAGS = ['education', 'learning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Output Completeness Grader Set 2'
