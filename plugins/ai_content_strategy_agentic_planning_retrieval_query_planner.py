...
Plugin: AI Content Strategy Agentic Planning Retrieval Query Planner 000764
Slug: ai_content_strategy_agentic_planning_retrieval_query_planner
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Agentic Planning Retrieval Query Planner 000764'
_PLUGIN_SLUG: str = 'ai_content_strategy_agentic_planning_retrieval_query_planner'
...
_PLUGIN_TAGS = ['content', 'strategy', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Agentic Planning Retrieval Query Planner 000764'
