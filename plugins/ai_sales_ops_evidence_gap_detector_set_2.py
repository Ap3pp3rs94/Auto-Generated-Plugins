...
Plugin: AI Sales Ops Evidence Gap Detector Set 2
Slug: ai_sales_ops_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI sales operations and account workflows.'
        domain = 'AI sales operations and account workflows evidence gaps and retrieval readiness'
