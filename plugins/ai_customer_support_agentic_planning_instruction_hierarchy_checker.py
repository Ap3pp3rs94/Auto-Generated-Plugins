...
Capability: AI Customer Support Agentic Planning Instruction Hierarchy Checker 000527
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
