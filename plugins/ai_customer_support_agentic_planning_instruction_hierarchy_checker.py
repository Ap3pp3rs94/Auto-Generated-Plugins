...
Plugin: AI Customer Support Agentic Planning Instruction Hierarchy Checker 000527
Slug: ai_customer_support_agentic_planning_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Agentic Planning Instruction Hierarchy Checker 000527'
_PLUGIN_SLUG: str = 'ai_customer_support_agentic_planning_instruction_hierarchy_checker'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI customer support and service workflows for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI customer support and service workflows for agentic planning instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Agentic Planning Instruction Hierarchy Checker 000527'
        goal = 'Check AI customer support and service workflows for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI customer support and service workflows for agentic planning instruction hierarchy and conflict safety'
