...
Plugin: AI Education Tutor Evidence Gap Detector
Slug: ai_education_tutor_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_education_tutor_evidence_gap_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Evidence Gap Detector'
