...
Capability: AI Education Tutor Evidence Gap Detector 000243
...
_PLUGIN_NAME: str = 'AI Education Tutor Evidence Gap Detector 000243'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Evidence Gap Detector 000243'
