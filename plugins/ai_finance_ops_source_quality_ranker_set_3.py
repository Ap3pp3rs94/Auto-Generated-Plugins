...
Plugin: AI Finance Ops Source Quality Ranker Set 3
Slug: ai_finance_ops_source_quality_ranker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Source Quality Ranker Set 3'
_PLUGIN_SLUG: str = 'ai_finance_ops_source_quality_ranker_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Source Quality Ranker Set 3'
