...
Capability: AI Release Evidence Summarizer 000570
Slug: ai_release_evidence_summarizer_000570
"""
...
_PLUGIN_NAME: str = 'AI Release Evidence Summarizer 000570'
_PLUGIN_SLUG: str = 'ai_release_evidence_summarizer_000570'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 000570'
