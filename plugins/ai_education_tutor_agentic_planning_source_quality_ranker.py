...
Capability: AI Education Tutor Agentic Planning Source Quality Ranker 000628
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
