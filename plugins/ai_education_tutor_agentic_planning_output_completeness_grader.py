...
Plugin: AI Education Tutor Agentic Planning Output Completeness Grader 000635
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
