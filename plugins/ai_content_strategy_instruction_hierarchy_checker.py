...
Capability: AI Content Strategy Instruction Hierarchy Checker 000383
...
_PLUGIN_NAME: str = 'AI Content Strategy Instruction Hierarchy Checker 000383'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Instruction Hierarchy Checker 000383'
