...
Plugin: AI Customer Support Evidence Gap Detector Set 2
Slug: ai_customer_support_evidence_gap_detector_set_2
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Evidence Gap Detector Set 2'
_PLUGIN_SLUG: str = 'ai_customer_support_evidence_gap_detector_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Evidence Gap Detector Set 2'
