...
# Title      : Deal Performance Dashboard
# File       : deal_performance_dashboard.py
# Description: Provides insights into deal performance by analyzing conversion rates, pipeline stages, and win/loss trends to inform sales strategy.
# Goal       : Provides insights into deal performance by analyzing conversion rates, pipeline stages, and win/loss trends to inform sales strategy.
...
_PLUGIN_NAME: str = 'Deal Performance Dashboard'
_PLUGIN_GOAL: str = 'Provides insights into deal performance by analyzing conversion rates, pipeline stages, and win/loss trends to inform sales strategy.'
_PLUGIN_CATEGORY: str = 'analysis | sales'
_PLUGIN_TAGS = ['insights', 'sales']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_dashboard'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
