...
# Title      : Sales Trend Visualizer
# File       : sales_trend_visualization.py
# Description: Automatically generate insights and visualizations for sales trends to identify patterns and make data-driven decisions.
# Goal       : Automatically generate insights and visualizations for sales trends to identify patterns and make data-driven decisions.
# Category   : sales | analysis
# Tags       : trend, visualize
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Trend Visualizer'
_PLUGIN_GOAL: str = 'Automatically generate insights and visualizations for sales trends to identify patterns and make data-driven decisions.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['trend', 'visualize']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_trend_visualization'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
