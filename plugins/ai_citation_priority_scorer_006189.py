...
Capability: AI Citation Priority Scorer 006189
Slug: ai_citation_priority_scorer_006189
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 006189'
        goal = 'Score which AI operations monitoring and incident response for capability operations claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for capability operations citation priority and factual-risk scoring'
