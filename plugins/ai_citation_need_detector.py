...
Plugin: AI Citation Need Detector
...
_PLUGIN_NAME: str = 'AI Citation Need Detector'
_PLUGIN_SLUG: str = 'ai_citation_need_detector'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Detect which AI-generated claims need citations, verification, or uncertainty language.'
_PLUGIN_TAGS = ['ai', 'citations', 'verification', 'grounding', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Need Detector'
