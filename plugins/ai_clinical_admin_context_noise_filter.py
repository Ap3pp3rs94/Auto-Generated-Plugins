...
Capability: AI Clinical Admin Context Noise Filter 000173
...
_PLUGIN_NAME: str = 'AI Clinical Admin Context Noise Filter 000173'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Context Noise Filter 000173'
