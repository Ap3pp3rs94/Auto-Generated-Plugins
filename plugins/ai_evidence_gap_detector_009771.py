...
Capability: AI Evidence Gap Detector 009771
Slug: ai_evidence_gap_detector_009771
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 009771'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response for safety controls.'
        domain = 'AI operations monitoring and incident response for safety controls evidence gaps and retrieval readiness'
