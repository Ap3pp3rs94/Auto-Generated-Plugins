...
Capability: AI Red Team Prompt Probe Builder 000066
Slug: ai_red_team_prompt_probe_builder_000066
"""
...
_PLUGIN_NAME: str = 'AI Red Team Prompt Probe Builder 000066'
_PLUGIN_SLUG: str = 'ai_red_team_prompt_probe_builder_000066'
...
_PLUGIN_MANIFEST = {'name': 'AI Red Team Prompt Probe Builder 000066', 'slug': 'ai_red_team_prompt_probe_builder_000066', 'goal': 'Create adversarial prompt probes that test instruction hierarchy, safety, and data leakage boundaries.', 'category': 'ai_safety', 'tags': ['ai', 'safety', 'red-team', 'prompting', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI red-team prompt testing and safety probing', 'owner_id': None, 'use_cases': ['Generate prompt probes for injection, leakage, and instruction override.', 'Define expected safe behavior for each probe.', 'Prioritize probes by risk and likelihood.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Red Team Prompt Probe Builder 000066'
