...
Plugin: AI Capability Factory Agentic Planning Evidence Gap Detector 000819
Slug: ai_plugin_factory_agentic_planning_evidence_gap_detector
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Agentic Planning Evidence Gap Detector 000819'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI capability factory and generated module operations for agentic planning.'
        domain = 'AI capability factory and generated module operations for agentic planning evidence gaps and retrieval readiness'
