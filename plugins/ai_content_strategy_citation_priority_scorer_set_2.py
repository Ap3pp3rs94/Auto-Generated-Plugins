...
Plugin: AI Content Strategy Citation Priority Scorer Set 2
Slug: ai_content_strategy_citation_priority_scorer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Citation Priority Scorer Set 2'
_PLUGIN_SLUG: str = 'ai_content_strategy_citation_priority_scorer_set_2'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI content strategy and editorial workflows claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['content', 'strategy', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI content strategy and editorial workflows citation priority and factual-risk scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Citation Priority Scorer Set 2'
        goal = 'Score which AI content strategy and editorial workflows claims most urgently need citations or uncertainty language.'
        domain = 'AI content strategy and editorial workflows citation priority and factual-risk scoring'
