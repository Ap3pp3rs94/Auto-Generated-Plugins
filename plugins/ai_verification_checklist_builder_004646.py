...
Capability: AI Verification Checklist Builder 004646
Slug: ai_verification_checklist_builder_004646
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 004646'
        goal = 'Build verification checklists for AI operations monitoring and incident response for documentation and knowledge capture AI artifacts before release or handoff.'
        domain = 'AI operations monitoring and incident response for documentation and knowledge capture verification planning and acceptance checks'
