...
Capability: AI Education Tutor Agentic Planning Trace Failure Router 000643
Slug: ai_education_tutor_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Agentic Planning Trace Failure Router 000643'
_PLUGIN_SLUG: str = 'ai_education_tutor_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Agentic Planning Trace Failure Router 000643'
