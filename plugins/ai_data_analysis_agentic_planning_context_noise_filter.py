...
Capability: AI Data Analysis Agentic Planning Context Noise Filter 000677
...
_PLUGIN_TAGS = ['data', 'analytics', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
