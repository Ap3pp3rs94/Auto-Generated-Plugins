...
Plugin: AI Security Review Capability Overlap Checker Set 2
Slug: ai_security_review_capability_overlap_checker_set_2
"""
...
_PLUGIN_NAME: str = 'AI Security Review Capability Overlap Checker Set 2'
_PLUGIN_SLUG: str = 'ai_security_review_capability_overlap_checker_set_2'
_PLUGIN_CATEGORY: str = 'ai_plugin_factory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check whether proposed AI security review and threat analysis capabilities overlap existing modules or deserve a new canonical slot.'
_PLUGIN_TAGS = ['security', 'safety', 'capabilities', 'duplicates', 'factory', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI security review and threat analysis capability uniqueness and roadmap hygiene'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Capability Overlap Checker Set 2'
        goal = 'Check whether proposed AI security review and threat analysis capabilities overlap existing modules or deserve a new canonical slot.'
        domain = 'AI security review and threat analysis capability uniqueness and roadmap hygiene'
