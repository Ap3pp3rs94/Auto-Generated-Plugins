...
# File       : deal_performance_visualizer.py
# Description: Provides visual insights into deal performance to inform sales strategies and optimize pipelines.
# Goal       : Provides visual insights into deal performance to inform sales strategies and optimize pipelines.
# Category   : sales | analysis
# Tags       : deal, performance, visual
# Version    : 0.1.0
...
_PLUGIN_GOAL: str = 'Provides visual insights into deal performance to inform sales strategies and optimize pipelines.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['deal', 'performance', 'visual']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_performance_visualizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
