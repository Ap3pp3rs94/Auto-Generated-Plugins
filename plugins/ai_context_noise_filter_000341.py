...
Capability: AI Context Noise Filter 000341
Slug: ai_context_noise_filter_000341
"""
...
_PLUGIN_NAME: str = 'AI Context Noise Filter 000341'
_PLUGIN_SLUG: str = 'ai_context_noise_filter_000341'
...
_PLUGIN_TAGS = ['product', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 000341'
