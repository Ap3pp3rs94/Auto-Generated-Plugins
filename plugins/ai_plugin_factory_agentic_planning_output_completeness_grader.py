...
Plugin: AI Capability Factory Agentic Planning Output Completeness Grader 000827
Slug: ai_plugin_factory_agentic_planning_output_completeness_grader
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Agentic Planning Output Completeness Grader 000827'
_PLUGIN_SLUG: str = 'ai_plugin_factory_agentic_planning_output_completeness_grader'
...
_PLUGIN_TAGS = ['capabilities', 'factory', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Agentic Planning Output Completeness Grader 000827'
