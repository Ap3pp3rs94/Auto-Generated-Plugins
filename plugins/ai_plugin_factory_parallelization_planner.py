...
Capability: AI Capability Factory Parallelization Planner 000440
Slug: ai_plugin_factory_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Parallelization Planner 000440'
_PLUGIN_SLUG: str = 'ai_plugin_factory_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Parallelization Planner 000440'
