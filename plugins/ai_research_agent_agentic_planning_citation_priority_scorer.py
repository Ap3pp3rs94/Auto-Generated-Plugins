...
Plugin: AI Research Agent Agentic Planning Citation Priority Scorer 000501
Slug: ai_research_agent_agentic_planning_citation_priority_scorer
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Agentic Planning Citation Priority Scorer 000501'
        goal = 'Score which AI research, retrieval, and synthesis work for agentic planning claims most urgently need citations or uncertainty language.'
        domain = 'AI research, retrieval, and synthesis work for agentic planning citation priority and factual-risk scoring'
