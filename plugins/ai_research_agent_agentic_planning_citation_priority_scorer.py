...
Capability: AI Research Agent Agentic Planning Citation Priority Scorer 000501
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'citations', 'claims', 'risk', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
