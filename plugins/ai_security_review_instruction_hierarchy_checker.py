...
Plugin: AI Security Review Instruction Hierarchy Checker
Slug: ai_security_review_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Security Review Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_security_review_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Instruction Hierarchy Checker'
