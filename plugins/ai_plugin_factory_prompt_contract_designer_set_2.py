...
Plugin: AI Capability Factory Prompt Contract Designer Set 2
Slug: ai_plugin_factory_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI capability factory and generated module operations with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI capability factory and generated module operations prompt contracts and structured instruction design'
