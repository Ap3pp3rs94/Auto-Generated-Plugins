...
Capability: AI Trace Failure Router 002443
Slug: ai_trace_failure_router_002443
"""
...
_PLUGIN_NAME: str = 'AI Trace Failure Router 002443'
_PLUGIN_SLUG: str = 'ai_trace_failure_router_002443'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Trace Failure Router 002443'
