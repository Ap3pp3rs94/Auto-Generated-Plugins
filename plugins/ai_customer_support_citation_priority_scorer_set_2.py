...
Plugin: AI Customer Support Citation Priority Scorer Set 2
Slug: ai_customer_support_citation_priority_scorer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Citation Priority Scorer Set 2'
_PLUGIN_SLUG: str = 'ai_customer_support_citation_priority_scorer_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Citation Priority Scorer Set 2'
