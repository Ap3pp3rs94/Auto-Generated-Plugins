...
Capability: AI Security Review Agentic Planning Verification Checklist Builder 000710
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
