...
Plugin: AI Legal Review Response Action Planner
Slug: ai_legal_review_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Response Action Planner'
_PLUGIN_SLUG: str = 'ai_legal_review_response_action_planner'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Response Action Planner'
        goal = 'Convert AI legal review and compliance workflows AI responses into concrete next actions with owners, checks, and risks.'
