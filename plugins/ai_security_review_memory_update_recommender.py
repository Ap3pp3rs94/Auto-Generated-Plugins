...
Capability: AI Security Review Memory Update Recommender 000318
Slug: ai_security_review_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Security Review Memory Update Recommender 000318'
_PLUGIN_SLUG: str = 'ai_security_review_memory_update_recommender'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Memory Update Recommender 000318'
