...
Capability: AI Sales Ops Agentic Planning Trace Failure Router 000547
Slug: ai_sales_ops_agentic_planning_trace_failure_router
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Agentic Planning Trace Failure Router 000547'
_PLUGIN_SLUG: str = 'ai_sales_ops_agentic_planning_trace_failure_router'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Agentic Planning Trace Failure Router 000547'
