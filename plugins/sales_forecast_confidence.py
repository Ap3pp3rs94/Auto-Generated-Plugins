...
# Title      : Sales Forecast Confidence Estimator
# File       : sales_forecast_confidence.py
# Description: Estimates the confidence level of a sales forecast to provide more accurate predictions
# Goal       : Estimates the confidence level of a sales forecast to provide more accurate predictions
# Category   : analysis | sales
# Tags       : predictive, machine learning
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Forecast Confidence Estimator'
_PLUGIN_GOAL: str = 'Estimates the confidence level of a sales forecast to provide more accurate predictions'
_PLUGIN_CATEGORY: str = 'analysis | sales'
_PLUGIN_TAGS = ['predictive', 'machine learning']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_forecast_confidence'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
