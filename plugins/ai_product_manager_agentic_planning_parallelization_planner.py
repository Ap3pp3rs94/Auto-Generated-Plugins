...
Capability: AI Product Manager Agentic Planning Parallelization Planner 000728
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
