...
Capability: AI Grounded Answer Planner 000031
Slug: ai_grounded_answer_planner_000031
"""
...
_PLUGIN_SLUG: str = 'ai_grounded_answer_planner_000031'
...
_PLUGIN_MANIFEST = {'name': 'AI Grounded Answer Planner 000031', 'slug': 'ai_grounded_answer_planner_000031', 'goal': 'Plan how an AI answer should combine retrieved evidence, caveats, and final response structure.', 'category': 'ai_retrieval', 'tags': ['ai', 'grounding', 'retrieval', 'answers', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI grounded answer planning and evidence use', 'owner_id': None, 'use_cases': ['Separate answer claims that are supported from claims that need more retrieval.', 'Recommend source-first response structure.', 'Create caveats for uncertain or missing evidence.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
