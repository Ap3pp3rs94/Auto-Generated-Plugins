...
Plugin: AI Security Review Agentic Planning Anomaly Watch Builder 000712
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
