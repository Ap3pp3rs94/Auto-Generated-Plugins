...
Plugin: AI Clinical Admin Tool Argument Checker
...
_PLUGIN_NAME: str = 'AI Clinical Admin Tool Argument Checker'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'tools', 'arguments', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Tool Argument Checker'
