...
Capability: AI Model Fit Triage 002470
Slug: ai_model_fit_triage_002470
"""
...
_PLUGIN_NAME: str = 'AI Model Fit Triage 002470'
_PLUGIN_SLUG: str = 'ai_model_fit_triage_002470'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Fit Triage 002470'
