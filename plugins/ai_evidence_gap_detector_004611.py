...
Capability: AI Evidence Gap Detector 004611
Slug: ai_evidence_gap_detector_004611
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 004611'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI personal productivity and scheduling workflows for documentation and knowledge capture.'
        domain = 'AI personal productivity and scheduling workflows for documentation and knowledge capture evidence gaps and retrieval readiness'
