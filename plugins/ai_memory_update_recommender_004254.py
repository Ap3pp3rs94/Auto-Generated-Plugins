...
Capability: AI Memory Update Recommender 004254
Slug: ai_memory_update_recommender_004254
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Update Recommender 004254'
        goal = 'Recommend durable memory updates from AI operations monitoring and incident response for data pipeline work sessions without saving transient chatter.'
        domain = 'AI operations monitoring and incident response for data pipeline work durable memory and preference extraction'
