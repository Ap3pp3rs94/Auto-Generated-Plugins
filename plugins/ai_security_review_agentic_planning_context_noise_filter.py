...
Capability: AI Security Review Agentic Planning Context Noise Filter 000701
...
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
