...
Capability: AI Citation Priority Scorer 008925
Slug: ai_citation_priority_scorer_008925
"""
...
_PLUGIN_NAME: str = 'AI Citation Priority Scorer 008925'
_PLUGIN_SLUG: str = 'ai_citation_priority_scorer_008925'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI coding agents and repository work for retrieval grounding for detecting signals claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['coding', 'agents', 'retrieval', 'grounding', 'detect', 'citations', 'claims', 'risk', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for retrieval grounding for detecting signals citation priority and factual-risk scoring'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Coding Agent Retrieval Grounding Detection.', 'Rank claims by citation need.', 'Flag high-stakes factual statements.', 'Recommend safer wording for unsupported claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Citation Priority Scorer 008925', 'slug': 'ai_citation_priority_scorer_008925', 'goal': 'Score which AI coding agents and repository work for retrieval grounding for detecting signals claims most urgently need citations or uncertainty language.', 'category': 'ai_evaluation', 'tags': ['coding', 'agents', 'retrieval', 'grounding', 'detect', 'citations', 'claims', 'risk', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI coding agents and repository work for retrieval grounding for detecting signals citation priority and factual-risk scoring', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Coding Agent Retrieval Grounding Detection.', 'Rank claims by citation need.', 'Flag high-stakes factual statements.', 'Recommend safer wording for unsupported claims.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 008925'
        goal = 'Score which AI coding agents and repository work for retrieval grounding for detecting signals claims most urgently need citations or uncertainty language.'
        domain = 'AI coding agents and repository work for retrieval grounding for detecting signals citation priority and factual-risk scoring'
