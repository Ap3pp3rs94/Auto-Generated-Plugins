...
Capability: AI Clinical Admin Agentic Planning Parallelization Planner 000560
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
