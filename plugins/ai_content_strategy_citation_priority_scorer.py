...
Plugin: AI Content Strategy Citation Priority Scorer
Slug: ai_content_strategy_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_content_strategy_citation_priority_scorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Citation Priority Scorer'
