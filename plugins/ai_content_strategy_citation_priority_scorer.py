...
Capability: AI Content Strategy Citation Priority Scorer 000381
...
_PLUGIN_NAME: str = 'AI Content Strategy Citation Priority Scorer 000381'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Citation Priority Scorer 000381'
