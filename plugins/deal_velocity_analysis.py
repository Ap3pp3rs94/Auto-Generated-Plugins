...
# Title      : Deal Velocity Analyzer
# File       : deal_velocity_analysis.py
# Description: Analyzes deal velocity to identify trends and opportunities for pipeline optimization.
# Goal       : Analyzes deal velocity to identify trends and opportunities for pipeline optimization.
# Category   : sales | analysis
# Tags       : pipeline, velocity, optimization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Velocity Analyzer'
_PLUGIN_GOAL: str = 'Analyzes deal velocity to identify trends and opportunities for pipeline optimization.'
_PLUGIN_CATEGORY: str = 'sales | analysis'
_PLUGIN_TAGS = ['pipeline', 'velocity', 'optimization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_velocity_analysis'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
