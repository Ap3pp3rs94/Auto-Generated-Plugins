...
Plugin: AI Product Manager Agentic Planning Output Completeness Grader 000731
...
_PLUGIN_TAGS = ['product', 'planning', 'agentic', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
