...
Plugin: AI Content Strategy Release Evidence Summarizer
...
_PLUGIN_NAME: str = 'AI Content Strategy Release Evidence Summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Release Evidence Summarizer'
