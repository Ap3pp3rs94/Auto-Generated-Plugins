...
Capability: AI Content Strategy Release Evidence Summarizer 000378
Slug: ai_content_strategy_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Release Evidence Summarizer 000378'
_PLUGIN_SLUG: str = 'ai_content_strategy_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Release Evidence Summarizer 000378'
