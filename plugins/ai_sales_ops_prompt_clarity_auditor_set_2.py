...
Plugin: AI Sales Ops Prompt Clarity Auditor Set 2
Slug: ai_sales_ops_prompt_clarity_auditor_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Prompt Clarity Auditor Set 2'
        goal = 'Audit prompts for AI sales operations and account workflows and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI sales operations and account workflows prompt clarity and ambiguity reduction'
