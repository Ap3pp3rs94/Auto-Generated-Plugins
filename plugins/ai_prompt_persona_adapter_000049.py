...
Capability: AI Prompt Persona Adapter 000049
Slug: ai_prompt_persona_adapter_000049
"""
...
_PLUGIN_NAME: str = 'AI Prompt Persona Adapter 000049'
_PLUGIN_SLUG: str = 'ai_prompt_persona_adapter_000049'
...
_PLUGIN_MANIFEST = {'name': 'AI Prompt Persona Adapter 000049', 'slug': 'ai_prompt_persona_adapter_000049', 'goal': 'Adapt prompts for a target audience, role, or expertise level without changing the core task.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'persona', 'audience', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI prompt persona adaptation and audience fit', 'owner_id': None, 'use_cases': ['Rewrite prompts for beginner, expert, executive, or operator audiences.', 'Preserve task constraints while changing tone and explanation depth.', 'Flag persona changes that would distort the original request.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Persona Adapter 000049'
        ...
        generation_note = 'numbered cadence base capability migration'
