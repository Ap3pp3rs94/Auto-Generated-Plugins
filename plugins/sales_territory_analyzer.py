...
# Title      : Sales Territory Analyzer
# File       : sales_territory_analyzer.py
# Description: Identify and prioritize top-performing sales territories for targeted efforts
# Goal       : Identify and prioritize top-performing sales territories for targeted efforts
# Category   : sales | ops
# Tags       : territory, prioritization
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Territory Analyzer'
_PLUGIN_GOAL: str = 'Identify and prioritize top-performing sales territories for targeted efforts'
_PLUGIN_CATEGORY: str = 'sales | ops'
_PLUGIN_TAGS = ['territory', 'prioritization']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_territory_analyzer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
