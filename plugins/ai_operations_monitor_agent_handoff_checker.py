...
Capability: AI Operations Monitor Agent Handoff Checker 000415
...
_PLUGIN_NAME: str = 'AI Operations Monitor Agent Handoff Checker 000415'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Agent Handoff Checker 000415'
