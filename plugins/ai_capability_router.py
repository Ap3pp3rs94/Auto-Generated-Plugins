...
_PLUGIN_NAME: str = 'AI Capability Router'
_PLUGIN_SLUG: str = 'ai_capability_router'
_PLUGIN_CATEGORY: str = 'ai_agents'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Route incoming AI tasks to the right capability type, model style, or agent role.'
_PLUGIN_TAGS = ['ai', 'routing', 'capabilities', 'agents', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Router'
