...
Plugin: AI Data Analysis Instruction Hierarchy Checker
Slug: ai_data_analysis_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_data_analysis_instruction_hierarchy_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Instruction Hierarchy Checker'
