...
Plugin: AI Research Agent Agentic Planning Retrieval Query Planner 000500
...
_PLUGIN_TAGS = ['research', 'retrieval', 'agentic', 'planning', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
