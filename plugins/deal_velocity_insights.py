...
# Title      : Deal Velocity Insights
# File       : deal_velocity_insights.py
# Description: Provides actionable insights on deal velocity to optimize sales pipelines and improve forecasting accuracy.
# Goal       : Provides actionable insights on deal velocity to optimize sales pipelines and improve forecasting accuracy.
# Category   : sales
# Tags       : velocity, insight, forecasting
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Deal Velocity Insights'
_PLUGIN_GOAL: str = 'Provides actionable insights on deal velocity to optimize sales pipelines and improve forecasting accuracy.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['velocity', 'insight', 'forecasting']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'deal_velocity_insights'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
