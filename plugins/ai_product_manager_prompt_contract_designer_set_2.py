...
Plugin: AI Product Manager Prompt Contract Designer Set 2
Slug: ai_product_manager_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI product planning and roadmap workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI product planning and roadmap workflows prompt contracts and structured instruction design'
