...
Plugin: AI Clinical Admin Citation Priority Scorer
Slug: ai_clinical_admin_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Clinical Admin Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_clinical_admin_citation_priority_scorer'
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Citation Priority Scorer'
