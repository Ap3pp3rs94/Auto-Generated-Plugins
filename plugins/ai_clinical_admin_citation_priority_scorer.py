...
Capability: AI Clinical Admin Citation Priority Scorer 000189
...
_PLUGIN_NAME: str = 'AI Clinical Admin Citation Priority Scorer 000189'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Citation Priority Scorer 000189'
