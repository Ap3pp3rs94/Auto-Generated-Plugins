...
Capability: AI Response Action Planner 002892
Slug: ai_response_action_planner_002892
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 002892'
_PLUGIN_SLUG: str = 'ai_response_action_planner_002892'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 002892'
        goal = 'Convert AI legal review and compliance workflows for workflow orchestration AI responses into concrete next actions with owners, checks, and risks.'
