...
Capability: AI Operations Monitor Response Action Planner 000420
...
_PLUGIN_NAME: str = 'AI Operations Monitor Response Action Planner 000420'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Response Action Planner 000420'
