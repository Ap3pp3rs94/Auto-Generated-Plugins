...
Capability: AI Evidence Gap Detector 002307
Slug: ai_evidence_gap_detector_002307
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 002307'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI personal productivity and scheduling workflows for evaluation feedback.'
        domain = 'AI personal productivity and scheduling workflows for evaluation feedback evidence gaps and retrieval readiness'
