...
Plugin: AI Legal Review Output Completeness Grader Set 3
Slug: ai_legal_review_output_completeness_grader_set_3
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Output Completeness Grader Set 3'
_PLUGIN_SLUG: str = 'ai_legal_review_output_completeness_grader_set_3'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Output Completeness Grader Set 3'
