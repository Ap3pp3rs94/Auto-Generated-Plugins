...
Plugin: AI Research Agent Agentic Planning Tool Safety Reviewer 000489
Slug: ai_research_agent_agentic_planning_tool_safety_reviewer
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Agentic Planning Tool Safety Reviewer 000489'
        goal = 'Review proposed tool use for AI research, retrieval, and synthesis work for agentic planning for side effects, permissions, and rollback needs.'
        domain = 'AI research, retrieval, and synthesis work for agentic planning AI tool safety and approval control'
