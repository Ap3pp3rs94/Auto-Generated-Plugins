...
Capability: AI Prompt Clarity Auditor 007298
Slug: ai_prompt_clarity_auditor_007298
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Clarity Auditor 007298'
        goal = 'Audit prompts for AI personal productivity and scheduling workflows for knowledge graph work and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI personal productivity and scheduling workflows for knowledge graph work prompt clarity and ambiguity reduction'
