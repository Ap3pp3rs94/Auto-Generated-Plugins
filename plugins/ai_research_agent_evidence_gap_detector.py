...
Plugin: AI Research Agent Evidence Gap Detector
Slug: ai_research_agent_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_research_agent_evidence_gap_detector'
...
_PLUGIN_TAGS = ['research', 'retrieval', 'evidence', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Evidence Gap Detector'
