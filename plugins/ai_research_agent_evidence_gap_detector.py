...
Capability: AI Research Agent Evidence Gap Detector 000099
...
_PLUGIN_NAME: str = 'AI Research Agent Evidence Gap Detector 000099'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Evidence Gap Detector 000099'
