...
Capability: AI DevOps Release Citation Priority Scorer 000285
...
_PLUGIN_NAME: str = 'AI DevOps Release Citation Priority Scorer 000285'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Citation Priority Scorer 000285'
