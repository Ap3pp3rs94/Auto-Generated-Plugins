...
Plugin: AI Capability Factory Verification Checklist Builder
Slug: ai_plugin_factory_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_plugin_factory_verification_checklist_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Verification Checklist Builder'
