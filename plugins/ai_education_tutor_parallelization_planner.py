...
Plugin: AI Education Tutor Parallelization Planner
Slug: ai_education_tutor_parallelization_planner
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Parallelization Planner'
_PLUGIN_SLUG: str = 'ai_education_tutor_parallelization_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Parallelization Planner'
