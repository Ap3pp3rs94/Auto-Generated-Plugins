...
Capability: AI Evidence Gap Detector 009291
Slug: ai_evidence_gap_detector_009291
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 009291'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback.'
        domain = 'AI cyber defense, alert triage, incident handling, and threat intelligence workflows for evaluation feedback evidence gaps and retrieval readiness'
