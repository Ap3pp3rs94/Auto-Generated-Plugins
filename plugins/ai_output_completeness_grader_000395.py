...
Capability: AI Output Completeness Grader 000395
Slug: ai_output_completeness_grader_000395
"""
...
_PLUGIN_NAME: str = 'AI Output Completeness Grader 000395'
_PLUGIN_SLUG: str = 'ai_output_completeness_grader_000395'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 000395'
