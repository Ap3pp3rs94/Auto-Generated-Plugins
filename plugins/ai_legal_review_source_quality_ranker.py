...
Plugin: AI Legal Review Source Quality Ranker
Slug: ai_legal_review_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_legal_review_source_quality_ranker'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'sources', 'trust', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Source Quality Ranker'
