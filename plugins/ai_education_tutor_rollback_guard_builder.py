...
Plugin: AI Education Tutor Rollback Guard Builder
Slug: ai_education_tutor_rollback_guard_builder
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Rollback Guard Builder'
_PLUGIN_SLUG: str = 'ai_education_tutor_rollback_guard_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Rollback Guard Builder'
