...
Capability: AI Research Agent Context Noise Filter 000101
...
_PLUGIN_NAME: str = 'AI Research Agent Context Noise Filter 000101'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Context Noise Filter 000101'
