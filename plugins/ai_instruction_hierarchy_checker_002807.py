...
Capability: AI Instruction Hierarchy Checker 002807
Slug: ai_instruction_hierarchy_checker_002807
"""
...
_PLUGIN_NAME: str = 'AI Instruction Hierarchy Checker 002807'
_PLUGIN_SLUG: str = 'ai_instruction_hierarchy_checker_002807'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 002807'
