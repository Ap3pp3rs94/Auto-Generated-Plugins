...
Plugin: AI Finance Ops Evidence Gap Detector Set 2
Slug: ai_finance_ops_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI finance operations and risk review.'
        domain = 'AI finance operations and risk review evidence gaps and retrieval readiness'
