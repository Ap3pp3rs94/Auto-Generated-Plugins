...
Plugin: AI Model Context Budget Estimator
...
_PLUGIN_NAME: str = 'AI Model Context Budget Estimator'
...
_PLUGIN_TAGS = ['ai', 'context', 'tokens', 'budgeting', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Model Context Budget Estimator'
        ...
        use_cases = ['Estimate whether a payload will fit a target context window.', 'Flag high-value context that should survive compression.', 'Recommend token-saving cuts without losing requirements.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
