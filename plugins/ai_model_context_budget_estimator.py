...
_PLUGIN_MANIFEST = {'name': 'AI Model Context Budget Estimator 000020', 'slug': 'ai_model_context_budget_estimator', 'goal': 'Estimate context budget pressure and recommend what to keep before a model call.', 'category': 'ai_memory', 'tags': ['ai', 'context', 'tokens', 'budgeting', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI context budgeting and model-call preparation', 'owner_id': 'francis-factory', 'use_cases': ['Estimate whether a payload will fit a target context window.', 'Flag high-value context that should survive compression.', 'Recommend token-saving cuts without losing requirements.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
