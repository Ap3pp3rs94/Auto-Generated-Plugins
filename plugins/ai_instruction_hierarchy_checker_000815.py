...
Capability: AI Instruction Hierarchy Checker 000815
Slug: ai_instruction_hierarchy_checker_000815
"""
...
_PLUGIN_NAME: str = 'AI Instruction Hierarchy Checker 000815'
_PLUGIN_SLUG: str = 'ai_instruction_hierarchy_checker_000815'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'agentic', 'planning', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 000815'
