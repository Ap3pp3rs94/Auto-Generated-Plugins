...
Plugin: AI Customer Support Retrieval Query Planner Set 3
Slug: ai_customer_support_retrieval_query_planner_set_3
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Retrieval Query Planner Set 3'
_PLUGIN_SLUG: str = 'ai_customer_support_retrieval_query_planner_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Retrieval Query Planner Set 3'
