...
Plugin: AI Customer Support Prompt Contract Designer Set 2
Slug: ai_customer_support_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI customer support and service workflows with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI customer support and service workflows prompt contracts and structured instruction design'
