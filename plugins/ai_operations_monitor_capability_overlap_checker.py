...
Plugin: AI Operations Monitor Capability Overlap Checker
Slug: ai_operations_monitor_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_operations_monitor_capability_overlap_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Capability Overlap Checker'
