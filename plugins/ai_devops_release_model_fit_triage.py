...
Plugin: AI DevOps Release Model Fit Triage
Slug: ai_devops_release_model_fit_triage
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Model Fit Triage'
_PLUGIN_SLUG: str = 'ai_devops_release_model_fit_triage'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Model Fit Triage'
