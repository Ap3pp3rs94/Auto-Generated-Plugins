...
Capability: AI Coding Agent Prompt Contract Designer 000073
...
_PLUGIN_NAME: str = 'AI Coding Agent Prompt Contract Designer 000073'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Prompt Contract Designer 000073'
