...
Plugin: AI Coding Agent Prompt Contract Designer
...
_PLUGIN_NAME: str = 'AI Coding Agent Prompt Contract Designer'
_PLUGIN_SLUG: str = 'ai_coding_agent_prompt_contract_designer'
...
_PLUGIN_TAGS = ['coding', 'agents', 'prompting', 'contracts', 'schemas', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Prompt Contract Designer'
