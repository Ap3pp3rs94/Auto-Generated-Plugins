...
Capability: AI Data Analysis Output Completeness Grader 000299
...
_PLUGIN_NAME: str = 'AI Data Analysis Output Completeness Grader 000299'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Output Completeness Grader 000299'
