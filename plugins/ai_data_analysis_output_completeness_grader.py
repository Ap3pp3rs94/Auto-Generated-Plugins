...
Plugin: AI Data Analysis Output Completeness Grader
Slug: ai_data_analysis_output_completeness_grader
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Output Completeness Grader'
_PLUGIN_SLUG: str = 'ai_data_analysis_output_completeness_grader'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Output Completeness Grader'
