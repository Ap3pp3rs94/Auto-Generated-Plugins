...
Capability: AI Personal Assistant Agent Handoff Checker 000391
...
_PLUGIN_NAME: str = 'AI Personal Assistant Agent Handoff Checker 000391'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Agent Handoff Checker 000391'
