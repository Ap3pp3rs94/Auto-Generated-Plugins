...
Capability: AI Verification Checklist Builder 001574
Slug: ai_verification_checklist_builder_001574
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Verification Checklist Builder 001574'
        goal = 'Build verification checklists for AI operations monitoring and incident response for retrieval grounding AI artifacts before release or handoff.'
        domain = 'AI operations monitoring and incident response for retrieval grounding verification planning and acceptance checks'
