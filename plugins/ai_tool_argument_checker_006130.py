...
Capability: AI Tool Argument Checker 006130
Slug: ai_tool_argument_checker_006130
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Argument Checker 006130'
        goal = 'Inspect tool arguments for AI content strategy and editorial workflows for capability operations for unsafe scope, missing bounds, or injected instructions.'
        domain = 'AI content strategy and editorial workflows for capability operations tool argument safety and sanitization'
