...
Plugin: AI Acceptance Criteria Extractor 000024
...
_PLUGIN_NAME: str = 'AI Acceptance Criteria Extractor 000024'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Acceptance Criteria Extractor 000024'
        ...
        use_cases = ['Turn loose requirements into measurable pass/fail criteria.', 'Separate hard failures from polish preferences.', 'Produce a checklist usable by humans or validation tools.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
