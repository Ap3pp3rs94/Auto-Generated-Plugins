...
_PLUGIN_MANIFEST = {'name': 'AI Acceptance Criteria Extractor 000024', 'slug': 'ai_acceptance_criteria_extractor', 'goal': 'Extract testable acceptance criteria from messy AI task descriptions.', 'category': 'ai_evaluation', 'tags': ['ai', 'criteria', 'evaluation', 'requirements', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI task acceptance criteria and done-definition design', 'owner_id': 'francis-factory', 'use_cases': ['Turn loose requirements into measurable pass/fail criteria.', 'Separate hard failures from polish preferences.', 'Produce a checklist usable by humans or validation tools.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
