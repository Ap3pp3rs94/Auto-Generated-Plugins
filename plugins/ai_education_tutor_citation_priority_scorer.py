...
Plugin: AI Education Tutor Citation Priority Scorer
Slug: ai_education_tutor_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_education_tutor_citation_priority_scorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Citation Priority Scorer'
