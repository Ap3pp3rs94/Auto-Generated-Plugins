...
Capability: AI Education Tutor Citation Priority Scorer 000261
...
_PLUGIN_NAME: str = 'AI Education Tutor Citation Priority Scorer 000261'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Citation Priority Scorer 000261'
