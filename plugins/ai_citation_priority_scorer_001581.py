...
Capability: AI Citation Priority Scorer 001581
Slug: ai_citation_priority_scorer_001581
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 001581'
        goal = 'Score which AI operations monitoring and incident response for retrieval grounding claims most urgently need citations or uncertainty language.'
        domain = 'AI operations monitoring and incident response for retrieval grounding citation priority and factual-risk scoring'
