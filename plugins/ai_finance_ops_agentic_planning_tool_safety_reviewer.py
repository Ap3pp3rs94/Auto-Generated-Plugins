...
Capability: AI Finance Ops Agentic Planning Tool Safety Reviewer 000609
Slug: ai_finance_ops_agentic_planning_tool_safety_reviewer
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Agentic Planning Tool Safety Reviewer 000609'
_PLUGIN_SLUG: str = 'ai_finance_ops_agentic_planning_tool_safety_reviewer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Agentic Planning Tool Safety Reviewer 000609'
