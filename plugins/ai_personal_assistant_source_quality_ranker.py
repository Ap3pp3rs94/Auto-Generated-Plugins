...
Plugin: AI Personal Assistant Source Quality Ranker
Slug: ai_personal_assistant_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_personal_assistant_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Source Quality Ranker'
