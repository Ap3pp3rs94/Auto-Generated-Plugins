...
Plugin: AI Capability Factory Prompt Clarity Auditor
Slug: ai_plugin_factory_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_plugin_factory_prompt_clarity_auditor'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Prompt Clarity Auditor'
