...
Plugin: AI Personal Assistant Capability Overlap Checker
Slug: ai_personal_assistant_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'AI Personal Assistant Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_personal_assistant_capability_overlap_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Personal Assistant Capability Overlap Checker'
