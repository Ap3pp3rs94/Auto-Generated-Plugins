...
Capability: AI Citation Priority Scorer 000141
Slug: ai_citation_priority_scorer_000141
"""
...
_PLUGIN_NAME: str = 'AI Citation Priority Scorer 000141'
_PLUGIN_SLUG: str = 'ai_citation_priority_scorer_000141'
...
_PLUGIN_TAGS = ['support', 'service', 'citations', 'claims', 'risk', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 000141'
