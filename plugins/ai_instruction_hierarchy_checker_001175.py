...
Capability: AI Instruction Hierarchy Checker 001175
Slug: ai_instruction_hierarchy_checker_001175
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 001175'
        goal = 'Check AI personal productivity and scheduling workflows for AI tool use instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI personal productivity and scheduling workflows for AI tool use instruction hierarchy and conflict safety'
