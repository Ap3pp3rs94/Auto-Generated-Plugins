...
Capability: AI Response Action Planner 003540
Slug: ai_response_action_planner_003540
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 003540'
_PLUGIN_SLUG: str = 'ai_response_action_planner_003540'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI coding agents and repository work for customer-facing interaction AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['coding', 'agents', 'customer', 'interaction', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for customer-facing interaction response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 003540'
        goal = 'Convert AI coding agents and repository work for customer-facing interaction AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI coding agents and repository work for customer-facing interaction response actionability and next-step planning'
