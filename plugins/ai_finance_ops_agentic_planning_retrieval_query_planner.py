...
Plugin: AI Finance Ops Agentic Planning Retrieval Query Planner 000620
...
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
