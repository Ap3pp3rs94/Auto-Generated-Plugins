...
Plugin: AI Customer Support Instruction Hierarchy Checker Set 3
Slug: ai_customer_support_instruction_hierarchy_checker_set_3
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Instruction Hierarchy Checker Set 3'
_PLUGIN_SLUG: str = 'ai_customer_support_instruction_hierarchy_checker_set_3'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI customer support and service workflows instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['support', 'service', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI customer support and service workflows instruction hierarchy and conflict safety'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Instruction Hierarchy Checker Set 3'
        goal = 'Check AI customer support and service workflows instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI customer support and service workflows instruction hierarchy and conflict safety'
