...
Capability: AI Instruction Hierarchy Checker 001199
Slug: ai_instruction_hierarchy_checker_001199
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 001199'
        goal = 'Check AI operations monitoring and incident response for AI tool use instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI operations monitoring and incident response for AI tool use instruction hierarchy and conflict safety'
