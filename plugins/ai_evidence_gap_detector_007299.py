...
Capability: AI Evidence Gap Detector 007299
Slug: ai_evidence_gap_detector_007299
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 007299'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI personal productivity and scheduling workflows for knowledge graph work.'
        domain = 'AI personal productivity and scheduling workflows for knowledge graph work evidence gaps and retrieval readiness'
