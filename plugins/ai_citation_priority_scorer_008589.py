...
Capability: AI Citation Priority Scorer 008589
Slug: ai_citation_priority_scorer_008589
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 008589'
        goal = 'Score which AI customer support and service workflows for AI tool use for detecting signals claims most urgently need citations or uncertainty language.'
        domain = 'AI customer support and service workflows for AI tool use for detecting signals citation priority and factual-risk scoring'
