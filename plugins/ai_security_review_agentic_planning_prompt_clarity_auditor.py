...
Capability: AI Security Review Agentic Planning Prompt Clarity Auditor 000698
Slug: ai_security_review_agentic_planning_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Security Review Agentic Planning Prompt Clarity Auditor 000698'
_PLUGIN_SLUG: str = 'ai_security_review_agentic_planning_prompt_clarity_auditor'
_PLUGIN_CATEGORY: str = 'ai_prompting'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Audit prompts for AI security review and threat analysis for agentic planning and identify ambiguity, weak wording, and missing execution detail.'
_PLUGIN_TAGS = ['security', 'safety', 'agentic', 'planning', 'prompting', 'clarity', 'audit', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'enrichment'
_PLUGIN_INTENDED_DOMAIN = 'AI security review and threat analysis for agentic planning prompt clarity and ambiguity reduction'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Security Review Agentic Planning.', 'Find vague wording in Security Review Agentic Planning prompts.', "Recommend sharper language without changing the user's intent.", 'Separate blocking ambiguity from polish improvements.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Security Review Agentic Planning Prompt Clarity Auditor 000698', 'slug': 'ai_security_review_agentic_planning_prompt_clarity_auditor', 'goal': 'Audit prompts for AI security review and threat analysis for agentic planning and identify ambiguity, weak wording, and missing execution detail.', 'category': 'ai_prompting', 'tags': ['security', 'safety', 'agentic', 'planning', 'prompting', 'clarity', 'audit', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI security review and threat analysis for agentic planning prompt clarity and ambiguity reduction', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Security Review Agentic Planning.', 'Find vague wording in Security Review Agentic Planning prompts.', "Recommend sharper language without changing the user's intent.", 'Separate blocking ambiguity from polish improvements.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Agentic Planning Prompt Clarity Auditor 000698'
        goal = 'Audit prompts for AI security review and threat analysis for agentic planning and identify ambiguity, weak wording, and missing execution detail.'
        domain = 'AI security review and threat analysis for agentic planning prompt clarity and ambiguity reduction'
        ...
        use_cases = ['Apply this capability to the distinct use case: Security Review Agentic Planning.', 'Find vague wording in Security Review Agentic Planning prompts.', "Recommend sharper language without changing the user's intent.", 'Separate blocking ambiguity from polish improvements.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.']
        payload_data = payload if isinstance(payload, dict) else {}
        payload_warnings = list(payload_data.get('_payload_warnings', [])) if isinstance(payload_data.get('_payload_warnings'), list) else []
        if not isinstance(payload, dict):
            payload_warnings.append('payload was not a dict; using empty payload')
