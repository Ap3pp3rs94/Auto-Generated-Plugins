...
Plugin: AI Sales Ops Agentic Planning Response Action Planner 000540
Slug: ai_sales_ops_agentic_planning_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Agentic Planning Response Action Planner 000540'
_PLUGIN_SLUG: str = 'ai_sales_ops_agentic_planning_response_action_planner'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI sales operations and account workflows for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['sales', 'business', 'agentic', 'planning', 'evaluation', 'actions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI sales operations and account workflows for agentic planning response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Agentic Planning Response Action Planner 000540'
        goal = 'Convert AI sales operations and account workflows for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI sales operations and account workflows for agentic planning response actionability and next-step planning'
