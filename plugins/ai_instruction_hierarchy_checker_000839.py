...
Plugin: AI Instruction Hierarchy Checker 000839
Slug: ai_instruction_hierarchy_checker_000839
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 000839'
        goal = 'Check AI capability factory and generated module operations for agentic planning instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI capability factory and generated module operations for agentic planning instruction hierarchy and conflict safety'
