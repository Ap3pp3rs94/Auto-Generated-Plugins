...
Plugin: AI Content Strategy Tool Argument Checker
...
_PLUGIN_NAME: str = 'AI Content Strategy Tool Argument Checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Tool Argument Checker'
