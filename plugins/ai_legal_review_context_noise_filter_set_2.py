...
Plugin: AI Legal Review Context Noise Filter Set 2
Slug: ai_legal_review_context_noise_filter_set_2
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Context Noise Filter Set 2'
_PLUGIN_SLUG: str = 'ai_legal_review_context_noise_filter_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Context Noise Filter Set 2'
