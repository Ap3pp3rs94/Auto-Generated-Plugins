...
Capability: AI Retrieval Query Planner 002348
Slug: ai_retrieval_query_planner_002348
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002348'
        goal = 'Plan focused retrieval queries for AI operations monitoring and incident response for evaluation feedback when evidence is missing or stale.'
        domain = 'AI operations monitoring and incident response for evaluation feedback retrieval query planning and grounding'
