...
# Title      : Initial Insight Generator
# File       : initial_insight_generator.py
# Description: Generate structured insights from user text.
# Goal       : Generate structured insights from user text.
# Category   : data
...
_PLUGIN_NAME: str = 'Initial Insight Generator'
_PLUGIN_GOAL: str = 'Generate structured insights from user text.'
_PLUGIN_CATEGORY: str = 'data'
_PLUGIN_TAGS = ['insights', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'initial_insight_generator'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any]) -> Any:
    ...
    # === LOGIC START ===
    result = {
        "summary": "Factory smoke test succeeded.",
        "primary_insights": [
            {"title": "Smoke Test", "description": "End-to-end plugin flow executed."}
        ],
        "recommended_actions": [
            "Record this as a passing integration test.",
            "Use as baseline for future Station B logic."
        ],
