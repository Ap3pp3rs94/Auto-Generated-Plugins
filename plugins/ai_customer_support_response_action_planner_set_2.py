...
Plugin: AI Customer Support Response Action Planner Set 2
Slug: ai_customer_support_response_action_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Response Action Planner Set 2'
_PLUGIN_SLUG: str = 'ai_customer_support_response_action_planner_set_2'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI customer support and service workflows AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['support', 'service', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI customer support and service workflows response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Response Action Planner Set 2'
        goal = 'Convert AI customer support and service workflows AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI customer support and service workflows response actionability and next-step planning'
