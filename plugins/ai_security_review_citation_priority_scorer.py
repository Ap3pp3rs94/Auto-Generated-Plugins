...
Plugin: AI Security Review Citation Priority Scorer
Slug: ai_security_review_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Security Review Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_security_review_citation_priority_scorer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Citation Priority Scorer'
