...
Capability: AI Security Review Citation Priority Scorer 000333
...
_PLUGIN_NAME: str = 'AI Security Review Citation Priority Scorer 000333'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Citation Priority Scorer 000333'
