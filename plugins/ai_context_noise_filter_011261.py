...
Capability: AI Context Noise Filter 011261
Slug: ai_context_noise_filter_011261
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 011261'
        goal = 'Filter noisy or redundant context before model calls for AI product planning and roadmap workflows for workflow orchestration.'
        domain = 'AI product planning and roadmap workflows for workflow orchestration context filtering and token-budget control'
