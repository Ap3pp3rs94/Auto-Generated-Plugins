...
Plugin: AI Risk Register Builder
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Risk Register Builder'
        goal = 'Build a compact risk register for AI-generated plans, tool calls, or automation steps.'
        domain = 'AI operational risk tracking and mitigation'
        capability_type = 'scoring'
        logic_profile_id = 'risk_register_builder_profile'
