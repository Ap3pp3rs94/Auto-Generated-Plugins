...
_PLUGIN_MANIFEST = {'name': 'AI Risk Register Builder 000026', 'slug': 'ai_risk_register_builder', 'goal': 'Build a compact risk register for AI-generated plans, tool calls, or automation steps.', 'category': 'ai_safety', 'tags': ['ai', 'risk', 'safety', 'controls', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI operational risk tracking and mitigation', 'owner_id': 'francis-factory', 'use_cases': ['List AI workflow risks with mitigation controls.', 'Flag destructive, factual, security, or release-sensitive actions.', 'Recommend approval and rollback controls before execution.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
