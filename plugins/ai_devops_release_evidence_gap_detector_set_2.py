...
Plugin: AI DevOps Release Evidence Gap Detector Set 2
Slug: ai_devops_release_evidence_gap_detector_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Evidence Gap Detector Set 2'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI DevOps release and infrastructure workflows.'
        domain = 'AI DevOps release and infrastructure workflows evidence gaps and retrieval readiness'
