...
Plugin: AI Security Review Capability Overlap Checker
Slug: ai_security_review_capability_overlap_checker
"""
...
_PLUGIN_NAME: str = 'AI Security Review Capability Overlap Checker'
_PLUGIN_SLUG: str = 'ai_security_review_capability_overlap_checker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Capability Overlap Checker'
