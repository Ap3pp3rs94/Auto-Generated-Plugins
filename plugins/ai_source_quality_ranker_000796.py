...
Capability: AI Source Quality Ranker 000796
Slug: ai_source_quality_ranker_000796
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 000796'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_000796'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 000796'
