...
Capability: AI Memory Update Recommender 005022
Slug: ai_memory_update_recommender_005022
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Memory Update Recommender 005022'
        goal = 'Recommend durable memory updates from AI operations monitoring and incident response for compliance review sessions without saving transient chatter.'
        domain = 'AI operations monitoring and incident response for compliance review durable memory and preference extraction'
