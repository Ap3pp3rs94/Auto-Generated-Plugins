...
Plugin: AI Customer Support Agentic Planning Retrieval Query Planner 000524
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
