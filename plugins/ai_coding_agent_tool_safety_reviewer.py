...
Capability: AI Coding Agent Tool Safety Reviewer 000081
...
_PLUGIN_NAME: str = 'AI Coding Agent Tool Safety Reviewer 000081'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Tool Safety Reviewer 000081'
