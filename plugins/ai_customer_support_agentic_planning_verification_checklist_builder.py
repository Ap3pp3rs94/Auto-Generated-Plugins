...
Capability: AI Customer Support Agentic Planning Verification Checklist Builder 000518
...
_PLUGIN_TAGS = ['support', 'service', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
