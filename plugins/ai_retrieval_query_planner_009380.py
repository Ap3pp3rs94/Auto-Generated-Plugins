...
Capability: AI Retrieval Query Planner 009380
Slug: ai_retrieval_query_planner_009380
"""
...
_PLUGIN_NAME: str = 'AI Retrieval Query Planner 009380'
_PLUGIN_SLUG: str = 'ai_retrieval_query_planner_009380'
_PLUGIN_CATEGORY: str = 'ai_retrieval'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Plan focused retrieval queries for AI personal administration, paperwork, appointments, and decision support workflows for evaluation feedback when evidence is missing or stale.'
_PLUGIN_TAGS = ['personal-admin', 'paperwork', 'planning', 'evaluation', 'feedback', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI personal administration, paperwork, appointments, and decision support workflows for evaluation feedback retrieval query planning and grounding'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 009380'
        goal = 'Plan focused retrieval queries for AI personal administration, paperwork, appointments, and decision support workflows for evaluation feedback when evidence is missing or stale.'
        domain = 'AI personal administration, paperwork, appointments, and decision support workflows for evaluation feedback retrieval query planning and grounding'
