...
Capability: AI Retrieval Query Planner 002060
Slug: ai_retrieval_query_planner_002060
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002060'
        goal = 'Plan focused retrieval queries for AI customer support and service workflows for evaluation feedback when evidence is missing or stale.'
        domain = 'AI customer support and service workflows for evaluation feedback retrieval query planning and grounding'
