...
Capability: AI Research Agent Tool Safety Reviewer 000105
...
_PLUGIN_NAME: str = 'AI Research Agent Tool Safety Reviewer 000105'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Tool Safety Reviewer 000105'
