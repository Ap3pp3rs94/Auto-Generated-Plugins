...
Plugin: AI Capability Factory Model Fit Triage Set 2
Slug: ai_plugin_factory_model_fit_triage_set_2
"""
...
_PLUGIN_NAME: str = 'AI Capability Factory Model Fit Triage Set 2'
_PLUGIN_SLUG: str = 'ai_plugin_factory_model_fit_triage_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Model Fit Triage Set 2'
