...
Plugin: AI Security Review Response Action Planner
Slug: ai_security_review_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Security Review Response Action Planner'
_PLUGIN_SLUG: str = 'ai_security_review_response_action_planner'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Response Action Planner'
