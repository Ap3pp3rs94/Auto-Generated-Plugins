...
Plugin: AI Education Tutor Agentic Planning Retrieval Query Planner 000644
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
