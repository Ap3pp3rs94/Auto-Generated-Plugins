...
Capability: AI Source Quality Ranker 005788
Slug: ai_source_quality_ranker_005788
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 005788'
        goal = 'Rank provided sources for AI operations monitoring and incident response for multimodal inputs by trust, relevance, freshness, and answer usefulness.'
        domain = 'AI operations monitoring and incident response for multimodal inputs source quality and grounded answer preparation'
