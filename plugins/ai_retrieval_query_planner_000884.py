...
Plugin: AI Retrieval Query Planner 000884
Slug: ai_retrieval_query_planner_000884
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 000884'
        goal = 'Plan focused retrieval queries for AI research, retrieval, and synthesis work for AI tool use when evidence is missing or stale.'
        domain = 'AI research, retrieval, and synthesis work for AI tool use retrieval query planning and grounding'
        ...
        use_cases = ['Apply this capability to the distinct use case: Research Agent Tool Use.', 'Generate exact and broad discovery queries.', 'Recommend filters, source types, and freshness needs.', 'Separate blocking retrieval from optional enrichment.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.']
