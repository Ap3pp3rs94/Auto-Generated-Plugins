...
Plugin: AI Clinical Admin Agentic Planning Retrieval Query Planner 000572
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'retrieval', 'queries', 'grounding', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
