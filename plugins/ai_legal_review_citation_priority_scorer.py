...
Capability: AI Legal Review Citation Priority Scorer 000213
...
_PLUGIN_NAME: str = 'AI Legal Review Citation Priority Scorer 000213'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Citation Priority Scorer 000213'
