...
Plugin: AI Legal Review Citation Priority Scorer
Slug: ai_legal_review_citation_priority_scorer
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Citation Priority Scorer'
_PLUGIN_SLUG: str = 'ai_legal_review_citation_priority_scorer'
...
_PLUGIN_TAGS = ['legal', 'compliance', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Citation Priority Scorer'
