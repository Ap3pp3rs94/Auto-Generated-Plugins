...
Plugin: AI Customer Support Output Completeness Grader
...
_PLUGIN_NAME: str = 'AI Customer Support Output Completeness Grader'
...
_PLUGIN_TAGS = ['support', 'service', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Output Completeness Grader'
