...
Plugin: AI Operations Monitor Agentic Planning Output Completeness Grader 000803
Slug: ai_operations_monitor_agentic_planning_output_completeness_grader
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Agentic Planning Output Completeness Grader 000803'
_PLUGIN_SLUG: str = 'ai_operations_monitor_agentic_planning_output_completeness_grader'
...
_PLUGIN_TAGS = ['operations', 'monitoring', 'agentic', 'planning', 'evaluation', 'completeness', 'quality', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Agentic Planning Output Completeness Grader 000803'
