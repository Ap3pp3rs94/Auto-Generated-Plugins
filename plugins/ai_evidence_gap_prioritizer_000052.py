...
Capability: AI Evidence Gap Prioritizer 000052
Slug: ai_evidence_gap_prioritizer_000052
"""
...
_PLUGIN_NAME: str = 'AI Evidence Gap Prioritizer 000052'
_PLUGIN_SLUG: str = 'ai_evidence_gap_prioritizer_000052'
...
_PLUGIN_MANIFEST = {'name': 'AI Evidence Gap Prioritizer 000052', 'slug': 'ai_evidence_gap_prioritizer_000052', 'goal': 'Prioritize missing evidence that must be retrieved before an AI answer can be trusted.', 'category': 'ai_retrieval', 'tags': ['ai', 'retrieval', 'evidence', 'grounding', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'research_synthesizer', 'intended_domain': 'AI evidence gaps and retrieval prioritization', 'owner_id': None, 'use_cases': ['Rank unsupported claims by risk and retrieval urgency.', 'Separate nice-to-have sources from blocking evidence gaps.', 'Recommend targeted retrieval questions for each gap.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Prioritizer 000052'
