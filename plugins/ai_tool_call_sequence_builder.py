...
Plugin: AI Tool Call Sequence Builder
...
_PLUGIN_NAME: str = 'AI Tool Call Sequence Builder'
...
_PLUGIN_TAGS = ['ai', 'tools', 'sequence', 'orchestration', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Call Sequence Builder'
