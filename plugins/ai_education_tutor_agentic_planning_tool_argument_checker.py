...
Capability: AI Education Tutor Agentic Planning Tool Argument Checker 000634
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'tools', 'arguments', 'safety', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
