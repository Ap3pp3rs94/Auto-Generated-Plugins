...
Capability: AI Autonomous Run Governor 000040
Slug: ai_autonomous_run_governor_000040
"""
...
_PLUGIN_SLUG: str = 'ai_autonomous_run_governor_000040'
...
_PLUGIN_MANIFEST = {'name': 'AI Autonomous Run Governor 000040', 'slug': 'ai_autonomous_run_governor_000040', 'goal': 'Decide whether an autonomous AI run should continue, pause, repair, or ask for human input.', 'category': 'ai_safety', 'tags': ['ai', 'autonomous', 'governance', 'safety', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI autonomous run governance and stop conditions', 'owner_id': None, 'use_cases': ['Detect when repeated failures should stop the run.', 'Recommend pause, repair, continue, or escalate decisions.', 'Preserve progress while preventing runaway automation.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
