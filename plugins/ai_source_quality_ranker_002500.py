...
Capability: AI Source Quality Ranker 002500
Slug: ai_source_quality_ranker_002500
"""
...
_PLUGIN_NAME: str = 'AI Source Quality Ranker 002500'
_PLUGIN_SLUG: str = 'ai_source_quality_ranker_002500'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Source Quality Ranker 002500'
