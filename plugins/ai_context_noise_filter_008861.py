...
Capability: AI Context Noise Filter 008861
Slug: ai_context_noise_filter_008861
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 008861'
        goal = 'Filter noisy or redundant context before model calls for AI operations monitoring and incident response for AI tool use for detecting signals.'
        domain = 'AI operations monitoring and incident response for AI tool use for detecting signals context filtering and token-budget control'
