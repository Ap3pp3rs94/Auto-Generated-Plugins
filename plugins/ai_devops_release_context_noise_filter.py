...
Capability: AI DevOps Release Context Noise Filter 000269
...
_PLUGIN_NAME: str = 'AI DevOps Release Context Noise Filter 000269'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Context Noise Filter 000269'
