...
Plugin: AI Customer Support Citation Priority Scorer Set 3
Slug: ai_customer_support_citation_priority_scorer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Citation Priority Scorer Set 3'
_PLUGIN_SLUG: str = 'ai_customer_support_citation_priority_scorer_set_3'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI customer support and service workflows claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['support', 'service', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI customer support and service workflows citation priority and factual-risk scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Citation Priority Scorer Set 3'
        goal = 'Score which AI customer support and service workflows claims most urgently need citations or uncertainty language.'
        domain = 'AI customer support and service workflows citation priority and factual-risk scoring'
