...
Plugin: AI Operations Monitor Verification Checklist Builder
Slug: ai_operations_monitor_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_operations_monitor_verification_checklist_builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Verification Checklist Builder'
