...
Capability: AI Capability Factory Context Noise Filter 000437
...
_PLUGIN_NAME: str = 'AI Capability Factory Context Noise Filter 000437'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Context Noise Filter 000437'
