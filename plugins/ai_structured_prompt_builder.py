...
Plugin: AI Structured Prompt Builder
...
_PLUGIN_NAME: str = 'AI Structured Prompt Builder'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Structured Prompt Builder'
        ...
        generation_note = 'structured prompt semantic risk fix'
        use_cases = ['Create a reusable prompt from loose notes.', 'Add explicit output schemas and validation checks.', 'Preserve user intent while reducing ambiguity.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI plugin behavior; identify what is unique about this capability.']
