...
Capability: AI Capability Factory Model Fit Triage 000454
...
_PLUGIN_NAME: str = 'AI Capability Factory Model Fit Triage 000454'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Model Fit Triage 000454'
