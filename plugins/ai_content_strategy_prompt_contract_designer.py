...
Capability: AI Content Strategy Prompt Contract Designer 000361
...
_PLUGIN_NAME: str = 'AI Content Strategy Prompt Contract Designer 000361'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Prompt Contract Designer 000361'
