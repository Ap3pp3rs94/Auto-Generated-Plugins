...
Capability: AI Finance Ops Assumption Risk Mapper 000229
...
_PLUGIN_NAME: str = 'AI Finance Ops Assumption Risk Mapper 000229'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Assumption Risk Mapper 000229'
