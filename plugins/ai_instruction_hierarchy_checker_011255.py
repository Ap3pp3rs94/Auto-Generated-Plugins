...
Capability: AI Instruction Hierarchy Checker 011255
Slug: ai_instruction_hierarchy_checker_011255
"""
...
_PLUGIN_NAME: str = 'AI Instruction Hierarchy Checker 011255'
_PLUGIN_SLUG: str = 'ai_instruction_hierarchy_checker_011255'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Check AI security review and threat analysis for workflow orchestration instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
_PLUGIN_TAGS = ['security', 'safety', 'workflow', 'orchestration', 'instructions', 'hierarchy', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI security review and threat analysis for workflow orchestration instruction hierarchy and conflict safety'
_PLUGIN_USE_CASES = ['Apply this capability to the distinct use case: Security Review Workflow Orchestration.', 'Find conflicts between instruction layers.', 'Flag unsafe or impossible requirements.', 'Recommend a clarified instruction set.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Instruction Hierarchy Checker 011255', 'slug': 'ai_instruction_hierarchy_checker_011255', 'goal': 'Check AI security review and threat analysis for workflow orchestration instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.', 'category': 'ai_safety', 'tags': ['security', 'safety', 'workflow', 'orchestration', 'instructions', 'hierarchy', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI security review and threat analysis for workflow orchestration instruction hierarchy and conflict safety', 'owner_id': 'francis-factory', 'use_cases': ['Apply this capability to the distinct use case: Security Review Workflow Orchestration.', 'Find conflicts between instruction layers.', 'Flag unsafe or impossible requirements.', 'Recommend a clarified instruction set.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Instruction Hierarchy Checker 011255'
        goal = 'Check AI security review and threat analysis for workflow orchestration instructions for hierarchy conflicts, unsafe overrides, and impossible constraints.'
        domain = 'AI security review and threat analysis for workflow orchestration instruction hierarchy and conflict safety'
