...
Plugin: AI Security Review Tool Safety Reviewer Set 2
Slug: ai_security_review_tool_safety_reviewer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Security Review Tool Safety Reviewer Set 2'
_PLUGIN_SLUG: str = 'ai_security_review_tool_safety_reviewer_set_2'
_PLUGIN_CATEGORY: str = 'ai_safety'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Review proposed tool use for AI security review and threat analysis for side effects, permissions, and rollback needs.'
_PLUGIN_TAGS = ['security', 'safety', 'tools', 'permissions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI security review and threat analysis AI tool safety and approval control'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Tool Safety Reviewer Set 2'
        goal = 'Review proposed tool use for AI security review and threat analysis for side effects, permissions, and rollback needs.'
        domain = 'AI security review and threat analysis AI tool safety and approval control'
