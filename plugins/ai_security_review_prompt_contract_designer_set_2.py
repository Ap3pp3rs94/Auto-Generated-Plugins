...
Plugin: AI Security Review Prompt Contract Designer Set 2
Slug: ai_security_review_prompt_contract_designer_set_2
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Security Review Prompt Contract Designer Set 2'
        goal = 'Design prompt contracts for AI security review and threat analysis with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI security review and threat analysis prompt contracts and structured instruction design'
