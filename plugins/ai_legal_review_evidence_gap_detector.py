...
Capability: AI Legal Review Evidence Gap Detector 000195
...
_PLUGIN_NAME: str = 'AI Legal Review Evidence Gap Detector 000195'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Evidence Gap Detector 000195'
