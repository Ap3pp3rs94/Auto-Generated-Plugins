...
Plugin: AI Coding Agent Agentic Planning Verification Checklist Builder
Slug: ai_coding_agent_agentic_planning_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Agentic Planning Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_coding_agent_agentic_planning_verification_checklist_builder'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Build verification checklists for AI coding agents and repository work for agentic planning AI artifacts before release or handoff.'
_PLUGIN_TAGS = ['coding', 'agents', 'agentic', 'planning', 'verification', 'tests', 'checklists', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'system_automation'
_PLUGIN_INTENDED_DOMAIN = 'AI coding agents and repository work for agentic planning verification planning and acceptance checks'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Agentic Planning Verification Checklist Builder'
        goal = 'Build verification checklists for AI coding agents and repository work for agentic planning AI artifacts before release or handoff.'
        domain = 'AI coding agents and repository work for agentic planning verification planning and acceptance checks'
