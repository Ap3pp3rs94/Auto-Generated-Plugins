...
Capability: AI Prompt Output Schema Designer 000050
Slug: ai_prompt_output_schema_designer_000050
"""
...
_PLUGIN_NAME: str = 'AI Prompt Output Schema Designer 000050'
_PLUGIN_SLUG: str = 'ai_prompt_output_schema_designer_000050'
...
_PLUGIN_MANIFEST = {'name': 'AI Prompt Output Schema Designer 000050', 'slug': 'ai_prompt_output_schema_designer_000050', 'goal': 'Design strict output schemas and response sections for prompts that need reliable downstream parsing.', 'category': 'ai_prompting', 'tags': ['ai', 'prompting', 'schema', 'outputs', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'enrichment', 'intended_domain': 'AI prompt output schemas and structured response design', 'owner_id': None, 'use_cases': ['Convert loose output expectations into explicit fields and sections.', 'Recommend required, optional, and diagnostic output keys.', 'Add validation notes that make model output easier to consume.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Output Schema Designer 000050'
