...
Capability: AI Rollback Guard Builder 000135
Slug: ai_rollback_guard_builder_000135
"""
...
_PLUGIN_NAME: str = 'AI Rollback Guard Builder 000135'
_PLUGIN_SLUG: str = 'ai_rollback_guard_builder_000135'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Rollback Guard Builder 000135'
