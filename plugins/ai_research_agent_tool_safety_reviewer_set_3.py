...
Plugin: AI Research Agent Tool Safety Reviewer Set 3
Slug: ai_research_agent_tool_safety_reviewer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Tool Safety Reviewer Set 3'
_PLUGIN_SLUG: str = 'ai_research_agent_tool_safety_reviewer_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Tool Safety Reviewer Set 3'
