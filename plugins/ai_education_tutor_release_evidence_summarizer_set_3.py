...
Plugin: AI Education Tutor Release Evidence Summarizer Set 3
Slug: ai_education_tutor_release_evidence_summarizer_set_3
"""
...
_PLUGIN_NAME: str = 'AI Education Tutor Release Evidence Summarizer Set 3'
_PLUGIN_SLUG: str = 'ai_education_tutor_release_evidence_summarizer_set_3'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Education Tutor Release Evidence Summarizer Set 3'
