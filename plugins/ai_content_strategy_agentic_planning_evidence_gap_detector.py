...
Plugin: AI Content Strategy Agentic Planning Evidence Gap Detector 000747
Slug: ai_content_strategy_agentic_planning_evidence_gap_detector
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Agentic Planning Evidence Gap Detector 000747'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI content strategy and editorial workflows for agentic planning.'
        domain = 'AI content strategy and editorial workflows for agentic planning evidence gaps and retrieval readiness'
