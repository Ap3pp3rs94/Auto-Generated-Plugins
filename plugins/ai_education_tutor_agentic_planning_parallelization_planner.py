...
Capability: AI Education Tutor Agentic Planning Parallelization Planner 000632
...
_PLUGIN_TAGS = ['education', 'learning', 'agentic', 'planning', 'agents', 'parallel', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
