...
Capability: AI Evidence Gap Detector 002331
Slug: ai_evidence_gap_detector_002331
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Evidence Gap Detector 002331'
        goal = 'Detect missing evidence that blocks trustworthy answers in AI operations monitoring and incident response for evaluation feedback.'
        domain = 'AI operations monitoring and incident response for evaluation feedback evidence gaps and retrieval readiness'
