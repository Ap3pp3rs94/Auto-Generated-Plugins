...
Capability: AI Legal Review Agentic Planning Context Noise Filter 000581
...
_PLUGIN_TAGS = ['legal', 'compliance', 'agentic', 'planning', 'context', 'tokens', 'noise', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
