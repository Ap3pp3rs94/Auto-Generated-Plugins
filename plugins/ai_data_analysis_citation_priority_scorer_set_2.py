...
Plugin: AI Data Analysis Citation Priority Scorer Set 2
Slug: ai_data_analysis_citation_priority_scorer_set_2
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Citation Priority Scorer Set 2'
_PLUGIN_SLUG: str = 'ai_data_analysis_citation_priority_scorer_set_2'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Score which AI data analysis and analytics workflows claims most urgently need citations or uncertainty language.'
_PLUGIN_TAGS = ['data', 'analytics', 'citations', 'claims', 'risk', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'scoring'
_PLUGIN_INTENDED_DOMAIN = 'AI data analysis and analytics workflows citation priority and factual-risk scoring'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Citation Priority Scorer Set 2'
        goal = 'Score which AI data analysis and analytics workflows claims most urgently need citations or uncertainty language.'
        domain = 'AI data analysis and analytics workflows citation priority and factual-risk scoring'
