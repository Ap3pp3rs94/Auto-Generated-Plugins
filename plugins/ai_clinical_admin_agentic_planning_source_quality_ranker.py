...
Capability: AI Clinical Admin Agentic Planning Source Quality Ranker 000556
...
_PLUGIN_TAGS = ['healthcare', 'clinical', 'agentic', 'planning', 'sources', 'trust', 'grounding', 'continuous_backlog', 'use_case_seeded', 'autonomous_factory', 'ai_progress']
