...
Plugin: AI Coding Agent Instruction Hierarchy Checker
Slug: ai_coding_agent_instruction_hierarchy_checker
"""
...
_PLUGIN_NAME: str = 'AI Coding Agent Instruction Hierarchy Checker'
_PLUGIN_SLUG: str = 'ai_coding_agent_instruction_hierarchy_checker'
...
_PLUGIN_TAGS = ['coding', 'agents', 'instructions', 'hierarchy', 'safety', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Instruction Hierarchy Checker'
