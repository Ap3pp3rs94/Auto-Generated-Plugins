...
Capability: AI Coding Agent Instruction Hierarchy Checker 000095
...
_PLUGIN_NAME: str = 'AI Coding Agent Instruction Hierarchy Checker 000095'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Instruction Hierarchy Checker 000095'
