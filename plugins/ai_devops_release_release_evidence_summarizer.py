...
Capability: AI DevOps Release Release Evidence Summarizer 000282
...
_PLUGIN_NAME: str = 'AI DevOps Release Release Evidence Summarizer 000282'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Release Evidence Summarizer 000282'
