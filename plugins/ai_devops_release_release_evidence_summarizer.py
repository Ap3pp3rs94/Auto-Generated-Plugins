...
Plugin: AI DevOps Release Release Evidence Summarizer
Slug: ai_devops_release_release_evidence_summarizer
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Release Evidence Summarizer'
_PLUGIN_SLUG: str = 'ai_devops_release_release_evidence_summarizer'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Release Evidence Summarizer'
