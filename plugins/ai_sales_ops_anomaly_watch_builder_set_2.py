...
Plugin: AI Sales Ops Anomaly Watch Builder Set 2
Slug: ai_sales_ops_anomaly_watch_builder_set_2
"""
...
_PLUGIN_NAME: str = 'AI Sales Ops Anomaly Watch Builder Set 2'
_PLUGIN_SLUG: str = 'ai_sales_ops_anomaly_watch_builder_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Sales Ops Anomaly Watch Builder Set 2'
