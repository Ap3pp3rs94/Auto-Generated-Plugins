...
Plugin: AI Data Analysis Source Quality Ranker
Slug: ai_data_analysis_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Data Analysis Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_data_analysis_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Data Analysis Source Quality Ranker'
