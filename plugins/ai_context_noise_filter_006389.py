...
Capability: AI Context Noise Filter 006389
Slug: ai_context_noise_filter_006389
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 006389'
        goal = 'Filter noisy or redundant context before model calls for AI education, tutoring, and learning workflows for task decomposition.'
        domain = 'AI education, tutoring, and learning workflows for task decomposition context filtering and token-budget control'
