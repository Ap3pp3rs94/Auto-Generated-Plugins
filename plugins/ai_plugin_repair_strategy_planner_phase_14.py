...
Plugin: AI Plugin Repair Strategy Planner Phase 14
Slug: ai_plugin_repair_strategy_planner_phase_14
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Plugin Repair Strategy Planner Phase 14'
        goal = 'Extend AI Plugin Repair Strategy Planner with phase 14 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
        domain = 'AI plugin repair planning and capability-specific improvement'
