...
Capability: AI Retrieval Query Planner 002084
Slug: ai_retrieval_query_planner_002084
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Retrieval Query Planner 002084'
        goal = 'Plan focused retrieval queries for AI sales operations and account workflows for evaluation feedback when evidence is missing or stale.'
        domain = 'AI sales operations and account workflows for evaluation feedback retrieval query planning and grounding'
