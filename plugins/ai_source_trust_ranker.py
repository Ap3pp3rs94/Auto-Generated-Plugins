...
_PLUGIN_MANIFEST = {'name': 'AI Source Trust Ranker 000053', 'slug': 'ai_source_trust_ranker', 'goal': 'Rank provided sources by likely trust, relevance, freshness, and answer usefulness.', 'category': 'ai_retrieval', 'tags': ['ai', 'sources', 'trust', 'retrieval', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI source evaluation and grounded answer preparation', 'owner_id': 'francis-factory', 'use_cases': ['Score candidate sources before synthesis.', 'Flag stale, weak, or unsupported source notes.', 'Recommend which sources should anchor the final answer.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
