...
Plugin: AI Prompt Refinement Engine Phase 6
Slug: ai_prompt_refinement_engine_phase_6
"""
...
_PLUGIN_NAME: str = 'AI Prompt Refinement Engine Phase 6'
_PLUGIN_SLUG: str = 'ai_prompt_refinement_engine_phase_6'
_PLUGIN_CATEGORY: str = 'ai_prompting'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Extend AI Prompt Refinement Engine with phase 6 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
_PLUGIN_TAGS = ['ai', 'prompting', 'instructions', 'quality', 'autonomous_factory', 'ai_progress', 'phase_6']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Prompt Refinement Engine Phase 6'
        goal = 'Extend AI Prompt Refinement Engine with phase 6 behavior: preserve the original AI capability, add stronger edge-case handling, expose clearer user-facing progress signals, and produce more actionable next steps.'
