...
Capability: AI Content Strategy Source Quality Ranker 000364
Slug: ai_content_strategy_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Source Quality Ranker 000364'
_PLUGIN_SLUG: str = 'ai_content_strategy_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Source Quality Ranker 000364'
