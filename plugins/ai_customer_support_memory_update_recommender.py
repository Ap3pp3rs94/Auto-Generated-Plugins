...
Plugin: AI Customer Support Memory Update Recommender
Slug: ai_customer_support_memory_update_recommender
"""
...
_PLUGIN_NAME: str = 'AI Customer Support Memory Update Recommender'
_PLUGIN_SLUG: str = 'ai_customer_support_memory_update_recommender'
_PLUGIN_CATEGORY: str = 'ai_memory'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Recommend durable memory updates from AI customer support and service workflows sessions without saving transient chatter.'
_PLUGIN_TAGS = ['support', 'service', 'memory', 'facts', 'preferences', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'research_synthesizer'
_PLUGIN_INTENDED_DOMAIN = 'AI customer support and service workflows durable memory and preference extraction'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Memory Update Recommender'
        goal = 'Recommend durable memory updates from AI customer support and service workflows sessions without saving transient chatter.'
        domain = 'AI customer support and service workflows durable memory and preference extraction'
