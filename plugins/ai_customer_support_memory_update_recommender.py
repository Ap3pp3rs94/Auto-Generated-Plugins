...
Capability: AI Customer Support Memory Update Recommender 000126
...
_PLUGIN_NAME: str = 'AI Customer Support Memory Update Recommender 000126'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Customer Support Memory Update Recommender 000126'
