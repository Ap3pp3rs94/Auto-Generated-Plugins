...
Capability: AI Operations Monitor Prompt Clarity Auditor 000410
...
_PLUGIN_NAME: str = 'AI Operations Monitor Prompt Clarity Auditor 000410'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Prompt Clarity Auditor 000410'
