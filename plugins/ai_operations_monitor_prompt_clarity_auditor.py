...
Plugin: AI Operations Monitor Prompt Clarity Auditor
Slug: ai_operations_monitor_prompt_clarity_auditor
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Prompt Clarity Auditor'
_PLUGIN_SLUG: str = 'ai_operations_monitor_prompt_clarity_auditor'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Prompt Clarity Auditor'
