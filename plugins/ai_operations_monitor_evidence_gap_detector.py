...
Plugin: AI Operations Monitor Evidence Gap Detector
Slug: ai_operations_monitor_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_operations_monitor_evidence_gap_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Evidence Gap Detector'
