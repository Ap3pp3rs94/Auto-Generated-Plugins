...
Capability: AI Release Evidence Summarizer 011178
Slug: ai_release_evidence_summarizer_011178
"""
...
_PLUGIN_NAME: str = 'AI Release Evidence Summarizer 011178'
_PLUGIN_SLUG: str = 'ai_release_evidence_summarizer_011178'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Release Evidence Summarizer 011178'
