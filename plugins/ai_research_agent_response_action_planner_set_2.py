...
Plugin: AI Research Agent Response Action Planner Set 2
Slug: ai_research_agent_response_action_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Research Agent Response Action Planner Set 2'
_PLUGIN_SLUG: str = 'ai_research_agent_response_action_planner_set_2'
...
_PLUGIN_TAGS = ['research', 'retrieval', 'evaluation', 'actions', 'planning', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Research Agent Response Action Planner Set 2'
        goal = 'Convert AI research, retrieval, and synthesis work AI responses into concrete next actions with owners, checks, and risks.'
