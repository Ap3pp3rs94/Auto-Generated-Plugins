...
Plugin: AI Content Strategy Agentic Planning Response Action Planner 000756
Slug: ai_content_strategy_agentic_planning_response_action_planner
"""
...
_PLUGIN_NAME: str = 'AI Content Strategy Agentic Planning Response Action Planner 000756'
_PLUGIN_SLUG: str = 'ai_content_strategy_agentic_planning_response_action_planner'
_PLUGIN_CATEGORY: str = 'ai_evaluation'
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_GOAL: str = 'Convert AI content strategy and editorial workflows for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
_PLUGIN_TAGS = ['content', 'strategy', 'agentic', 'planning', 'evaluation', 'actions', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
_PLUGIN_OWNER_ID = 'francis-factory'
_PLUGIN_CAPABILITY_TYPE = 'data_insight'
_PLUGIN_INTENDED_DOMAIN = 'AI content strategy and editorial workflows for agentic planning response actionability and next-step planning'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Agentic Planning Response Action Planner 000756'
        goal = 'Convert AI content strategy and editorial workflows for agentic planning AI responses into concrete next actions with owners, checks, and risks.'
        domain = 'AI content strategy and editorial workflows for agentic planning response actionability and next-step planning'
