...
Plugin: AI Legal Review Response Action Planner Set 2
Slug: ai_legal_review_response_action_planner_set_2
"""
...
_PLUGIN_NAME: str = 'AI Legal Review Response Action Planner Set 2'
_PLUGIN_SLUG: str = 'ai_legal_review_response_action_planner_set_2'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Legal Review Response Action Planner Set 2'
        goal = 'Convert AI legal review and compliance workflows AI responses into concrete next actions with owners, checks, and risks.'
