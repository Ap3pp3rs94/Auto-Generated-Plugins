...
Capability: AI Capability Factory Assumption Risk Mapper 000445
...
_PLUGIN_NAME: str = 'AI Capability Factory Assumption Risk Mapper 000445'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Capability Factory Assumption Risk Mapper 000445'
