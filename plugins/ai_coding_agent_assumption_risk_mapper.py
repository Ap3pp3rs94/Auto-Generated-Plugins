...
Capability: AI Coding Agent Assumption Risk Mapper 000085
...
_PLUGIN_NAME: str = 'AI Coding Agent Assumption Risk Mapper 000085'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Coding Agent Assumption Risk Mapper 000085'
