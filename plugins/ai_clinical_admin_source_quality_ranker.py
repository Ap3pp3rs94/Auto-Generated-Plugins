...
Capability: AI Clinical Admin Source Quality Ranker 000172
...
_PLUGIN_NAME: str = 'AI Clinical Admin Source Quality Ranker 000172'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Clinical Admin Source Quality Ranker 000172'
