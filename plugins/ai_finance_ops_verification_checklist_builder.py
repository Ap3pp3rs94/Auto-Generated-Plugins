...
Plugin: AI Finance Ops Verification Checklist Builder
Slug: ai_finance_ops_verification_checklist_builder
"""
...
_PLUGIN_NAME: str = 'AI Finance Ops Verification Checklist Builder'
_PLUGIN_SLUG: str = 'ai_finance_ops_verification_checklist_builder'
...
_PLUGIN_TAGS = ['finance', 'risk', 'verification', 'tests', 'checklists', 'continuous_backlog', 'autonomous_factory', 'ai_progress', 'phase_1']
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Finance Ops Verification Checklist Builder'
