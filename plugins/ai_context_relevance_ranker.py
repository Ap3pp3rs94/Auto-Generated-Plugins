...
Plugin: AI Context Relevance Ranker
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Relevance Ranker'
        goal = 'Rank context snippets by relevance, freshness, and necessity for the next model call.'
        domain = 'AI context relevance ranking and context packing'
        capability_type = 'data_insight'
        logic_profile_id = 'context_relevance_ranker_profile'
