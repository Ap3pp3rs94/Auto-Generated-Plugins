...
Capability: AI Output Completeness Grader 002435
Slug: ai_output_completeness_grader_002435
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 002435'
        goal = 'Grade AI customer support and service workflows for safety controls AI outputs for completeness against task requirements and acceptance criteria.'
        domain = 'AI customer support and service workflows for safety controls output completeness and acceptance scoring'
