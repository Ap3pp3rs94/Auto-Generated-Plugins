...
Capability: AI Operator Status Brief Builder 000033
Slug: ai_operator_status_brief_builder_000033
"""
...
_PLUGIN_NAME: str = 'AI Operator Status Brief Builder 000033'
_PLUGIN_SLUG: str = 'ai_operator_status_brief_builder_000033'
...
_PLUGIN_USE_CASES = ['Summarize what changed, what passed, and what is blocked.', 'Expose current run health without noisy logs.', 'Recommend the next operator action.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.']
_PLUGIN_RESULT_SCHEMA_VERSION: str = "1.0.0"
_PLUGIN_MANIFEST = {'name': 'AI Operator Status Brief Builder 000033', 'slug': 'ai_operator_status_brief_builder_000033', 'goal': 'Turn autonomous AI run state into a concise operator-facing status brief.', 'category': 'ai_agents', 'tags': ['ai', 'status', 'operators', 'progress', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI operator visibility and run status reporting', 'owner_id': None, 'use_cases': ['Summarize what changed, what passed, and what is blocked.', 'Expose current run health without noisy logs.', 'Recommend the next operator action.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operator Status Brief Builder 000033'
