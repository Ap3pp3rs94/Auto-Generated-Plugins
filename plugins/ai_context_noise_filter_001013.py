...
Capability: AI Context Noise Filter 001013
Slug: ai_context_noise_filter_001013
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Context Noise Filter 001013'
        goal = 'Filter noisy or redundant context before model calls for AI education, tutoring, and learning workflows for AI tool use.'
        domain = 'AI education, tutoring, and learning workflows for AI tool use context filtering and token-budget control'
