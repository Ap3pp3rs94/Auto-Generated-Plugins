...
Capability: AI Citation Priority Scorer 006141
Slug: ai_citation_priority_scorer_006141
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Citation Priority Scorer 006141'
        goal = 'Score which AI content strategy and editorial workflows for capability operations claims most urgently need citations or uncertainty language.'
        domain = 'AI content strategy and editorial workflows for capability operations citation priority and factual-risk scoring'
