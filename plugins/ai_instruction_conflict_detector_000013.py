...
Capability: AI Instruction Conflict Detector 000013
Slug: ai_instruction_conflict_detector_000013
"""
...
_PLUGIN_SLUG: str = 'ai_instruction_conflict_detector_000013'
...
_PLUGIN_MANIFEST = {'name': 'AI Instruction Conflict Detector 000013', 'slug': 'ai_instruction_conflict_detector_000013', 'goal': 'Detect conflicting, unsafe, or impossible instructions before an AI workflow starts.', 'category': 'ai_safety', 'tags': ['ai', 'safety', 'instructions', 'constraints', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'scoring', 'intended_domain': 'AI instruction safety and constraint analysis', 'owner_id': None, 'use_cases': ['Find contradictions between system, developer, and user instructions.', 'Flag requests that cannot be satisfied under current constraints.', 'Suggest a clarified instruction set for safe execution.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
