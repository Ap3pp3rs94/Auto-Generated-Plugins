...
# Title      : Sales Team Performance Analyzer
# File       : sales_team_performance.py
# Description: Analyzes sales team performance and identifies areas for improvement to boost sales efficiency.
# Goal       : Analyzes sales team performance and identifies areas for improvement to boost sales efficiency.
# Category   : sales
# Tags       : team, performance, analysis
# Version    : 0.1.0
...
_PLUGIN_NAME: str = 'Sales Team Performance Analyzer'
_PLUGIN_GOAL: str = 'Analyzes sales team performance and identifies areas for improvement to boost sales efficiency.'
_PLUGIN_CATEGORY: str = 'sales'
_PLUGIN_TAGS = ['team', 'performance', 'analysis']
_PLUGIN_VERSION: str = '0.1.0'
_PLUGIN_SLUG: str = 'sales_team_performance'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Any:
    ...
    _llm_body_b64 = ""
    try:
