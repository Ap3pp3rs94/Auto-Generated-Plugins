...
Capability: AI Tool Safety Reviewer 002673
Slug: ai_tool_safety_reviewer_002673
"""
...
_PLUGIN_NAME: str = 'AI Tool Safety Reviewer 002673'
_PLUGIN_SLUG: str = 'ai_tool_safety_reviewer_002673'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 002673'
