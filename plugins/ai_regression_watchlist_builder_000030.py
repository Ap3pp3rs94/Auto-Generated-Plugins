...
Capability: AI Regression Watchlist Builder 000030
Slug: ai_regression_watchlist_builder_000030
"""
...
_PLUGIN_SLUG: str = 'ai_regression_watchlist_builder_000030'
...
_PLUGIN_MANIFEST = {'name': 'AI Regression Watchlist Builder 000030', 'slug': 'ai_regression_watchlist_builder_000030', 'goal': 'Create regression watchlists for prompts, plans, and AI-generated artifacts.', 'category': 'ai_evaluation', 'tags': ['ai', 'regression', 'tests', 'watchlist', 'autonomous_factory', 'ai_progress'], 'version': '0.1.0', 'capability_type': 'data_insight', 'intended_domain': 'AI regression detection and workflow quality control', 'owner_id': None, 'use_cases': ['List behaviors that must not regress after a prompt or workflow change.', 'Create normal, edge, and failure watch items.', 'Recommend checks that future AI runs should repeat.', 'Show a compact progress state for this AI capability during baseline capability.', 'Return user-facing guidance that is useful, concise, and safe to act on.', 'Avoid duplicating existing AI capability behavior; identify what is unique about this capability.'], 'schema_version': '1.0.0'}
