...
Capability: AI DevOps Release Evidence Gap Detector 000267
...
_PLUGIN_NAME: str = 'AI DevOps Release Evidence Gap Detector 000267'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Evidence Gap Detector 000267'
