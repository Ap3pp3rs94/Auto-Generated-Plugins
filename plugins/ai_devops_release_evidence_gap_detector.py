...
Plugin: AI DevOps Release Evidence Gap Detector
Slug: ai_devops_release_evidence_gap_detector
"""
...
_PLUGIN_NAME: str = 'AI DevOps Release Evidence Gap Detector'
_PLUGIN_SLUG: str = 'ai_devops_release_evidence_gap_detector'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI DevOps Release Evidence Gap Detector'
