...
Plugin: AI Finance Ops Agentic Planning Anomaly Watch Builder 000616
...
_PLUGIN_TAGS = ['finance', 'risk', 'agentic', 'planning', 'monitoring', 'anomalies', 'autonomous', 'continuous_backlog', 'autonomous_factory', 'ai_progress']
