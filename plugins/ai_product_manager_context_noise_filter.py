...
Capability: AI Product Manager Context Noise Filter 000341
...
_PLUGIN_NAME: str = 'AI Product Manager Context Noise Filter 000341'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Product Manager Context Noise Filter 000341'
