...
Plugin: AI Operations Monitor Source Quality Ranker
Slug: ai_operations_monitor_source_quality_ranker
"""
...
_PLUGIN_NAME: str = 'AI Operations Monitor Source Quality Ranker'
_PLUGIN_SLUG: str = 'ai_operations_monitor_source_quality_ranker'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Operations Monitor Source Quality Ranker'
