...
Capability: AI Tool Safety Reviewer 008097
Slug: ai_tool_safety_reviewer_008097
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Tool Safety Reviewer 008097'
        goal = 'Review proposed tool use for AI operations monitoring and incident response for detecting signals for side effects, permissions, and rollback needs.'
        domain = 'AI operations monitoring and incident response for detecting signals AI tool safety and approval control'
