...
Capability: AI Output Completeness Grader 000155
Slug: ai_output_completeness_grader_000155
"""
...
_PLUGIN_NAME: str = 'AI Output Completeness Grader 000155'
_PLUGIN_SLUG: str = 'ai_output_completeness_grader_000155'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Output Completeness Grader 000155'
