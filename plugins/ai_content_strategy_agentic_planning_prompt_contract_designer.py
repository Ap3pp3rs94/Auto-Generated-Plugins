...
Plugin: AI Content Strategy Agentic Planning Prompt Contract Designer 000745
Slug: ai_content_strategy_agentic_planning_prompt_contract_designer
"""
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Content Strategy Agentic Planning Prompt Contract Designer 000745'
        goal = 'Design prompt contracts for AI content strategy and editorial workflows for agentic planning with explicit inputs, outputs, constraints, and checks.'
        domain = 'AI content strategy and editorial workflows for agentic planning prompt contracts and structured instruction design'
