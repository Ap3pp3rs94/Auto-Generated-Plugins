...
Capability: AI Response Action Planner 000252
Slug: ai_response_action_planner_000252
"""
...
_PLUGIN_NAME: str = 'AI Response Action Planner 000252'
_PLUGIN_SLUG: str = 'ai_response_action_planner_000252'
...
def _run_core_logic(context: SkillContext, payload: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        plugin_name = 'AI Response Action Planner 000252'
        goal = 'Convert AI education, tutoring, and learning workflows AI responses into concrete next actions with owners, checks, and risks.'
